# MONITORING_ANALYSIS / MONITORING_EXPORT

## Purpose and completion condition

분석 결과 내보내기 업무를 전문적으로 완료하고 검증 가능한 산출물을 생성한다.

## ADMIN screen contract: 모니터링·분석 - 분석 결과 내보내기

- Route: `/admin/system/process-workspace?process=MONITORING_ANALYSIS&step=MONITORING_EXPORT`
- Responsible actor: `COMPANY_MANAGER`
- Business purpose: 분석 결과 내보내기 업무를 전문적으로 완료한다.
