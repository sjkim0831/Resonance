# PAYMENT_SETTLEMENT / PAYMENT_SETTLEMENT_02_WORK

## Purpose and completion condition

자료 입력·업무 수행 업무를 전문적으로 완료하고 검증 가능한 산출물을 생성한다.

## ADMIN screen contract: 수수료·결제·정산 - 자료 입력·업무 수행

- Route: `/admin/system/process-workspace?process=PAYMENT_SETTLEMENT&step=PAYMENT_SETTLEMENT_02_WORK`
