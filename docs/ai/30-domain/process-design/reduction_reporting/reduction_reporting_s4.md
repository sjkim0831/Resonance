...
- KPI: [
  {
    ...
    "unit": "PERCENT",
    "label": "감축 성과 보고 - 승인·확정·통지·후속업무 연결 완료율"
  },
  {
    "code": "SLA_REMAINING",
    "unit": "MINUTE",
...
- Fields: [
  {
    ...
    "dataType": "STRING",
    "editable": false,
    "pageCode": "REDUCTION_REPORTING_REDUCTION_REPORTING_S4_ADMIN",
    "required": true,
    "fieldCode": "tenantId",
    "fieldName": "테넌트",
    "fieldGroup": "공통",
...
- Commands and navigation: [
  {
    "code": "REDUCTION_REPORTING_COMPLETE",
    "label": "감축 성과 보고 - 승인·확정·통지·후속업무 연결 실행",
    "transactional": true,
...
- API: [
  ...
  },
  {
    ...
    "method": "POST",
    "purpose": "감축 성과 보고 - 승인·확정·통지·후속업무 연결 상태 명령 실행"
  },
  {
    "code": "LOAD_DRAFT",
...
- Fields: [
  {
    ...
    "dataType": "STRING",
    "editable": false,
    "pageCode": "REDUCTION_REPORTING_REDUCTION_REPORTING_S4_USER",
    "required": true,
    "fieldCode": "tenantId",
    "fieldName": "테넌트",
    "fieldGroup": "공통",
