# LCA_EXECUTION / LCA_EXECUTION_02_WORK

## Purpose and completion condition

자료 입력·업무 수행 업무를 전문적으로 완료하고 검증 가능한 산출물을 생성한다.

## ADMIN screen contract: 제품 LCA 수행 - 자료 입력·업무 수행

- Route: `/admin/system/process-workspace?process=LCA_EXECUTION&step=LCA_EXECUTION_02_WORK`
- Responsible actor: `LCA_PRACTITIONER`
- Business purpose: 자료 입력·업무 수행 업무를 전문적으로 완료한다.
