# LCA_EXECUTION / LCA_EXECUTION_04_APPROVE

## Purpose and completion condition

승인·확정 업무를 전문적으로 완료하고 검증 가능한 산출물을 생성한다.

## ADMIN screen contract: 제품 LCA 수행 - 승인·확정

- Route: `/admin/system/process-workspace?process=LCA_EXECUTION&step=LCA_EXECUTION_04_APPROVE`
