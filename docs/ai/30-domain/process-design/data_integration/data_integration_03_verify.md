# DATA_INTEGRATION / DATA_INTEGRATION_03_VERIFY

## Purpose and completion condition

검증·보완 업무를 전문적으로 완료하고 검증 가능한 산출물을 생성한다.

## ADMIN screen contract: 외부 데이터 연계 - 검증·보완

- Route: `/admin/system/process-workspace?process=DATA_INTEGRATION&step=DATA_INTEGRATION_03_VERIFY`
- Responsible actor: `SYSTEM_INTEGRATOR`
- Business purpose: 검증·보완 업무를 전문적으로 완료한다.
