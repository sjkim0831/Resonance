# CONTENT_OPERATION / CONTENT_OPERATION_03_VERIFY

## Purpose and completion condition

검증·보완 업무를 전문적으로 완료하고 검증 가능한 산출물을 생성한다.

## ADMIN screen contract: 콘텐츠·교육·지원 운영 - 검증·보완

- Route: `/admin/system/process-workspace?process=CONTENT_OPERATION&step=CONTENT_OPERATION_03_VERIFY`
