# MEMBER_LIFECYCLE / MEMBER_LIFECYCLE_03_VERIFY

## Purpose and completion condition

검증·보완 업무를 전문적으로 완료하고 검증 가능한 산출물을 생성한다.

## ADMIN screen contract: 회원·기업 생애주기 - 검증·보완

- Route: `/admin/system/process-workspace?process=MEMBER_LIFECYCLE&step=MEMBER_LIFECYCLE_03_VERIFY`
