# PLATFORM_OPERATION / PLATFORM_AUDIT

## Purpose and completion condition

운영·감사·복구 확인 업무를 전문적으로 완료하고 검증 가능한 산출물을 생성한다.

## ADMIN screen contract: 플랫폼 운영 - 운영·감사·복구 확인

- Route: `/admin/system/process-workspace?process=PLATFORM_OPERATION&step=PLATFORM_AUDIT`
- Responsible actor: `AUDITOR`
- Business purpose: 운영·감사·복구 확인 업무를 전문적으로 완료한다.
