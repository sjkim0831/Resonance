# Existing frontend adoption: job 288

- Process: `EMISSION_PROJECT`
- Step: `EMISSION_PROJECT_CALCULATE`
- Route: `/admin/emission/calculation-rule`
- Route ID: `emission-calculation-rule`
- Implemented source: `projects/carbonet-frontend/source/src/features/emission-definition-studio/EmissionDefinitionStudioMigrationPage.tsx`
