# Existing frontend adoption: job 287

- Process: `EMISSION_PROJECT`
- Step: `EMISSION_PROJECT_CALCULATE`
- Route: `/emission/simulate`
- Route ID: `emission-simulate`
- Implemented source: `projects/carbonet-frontend/source/src/features/emission-simulate/EmissionSimulateMigrationPage.tsx`
