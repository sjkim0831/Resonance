# Existing frontend adoption: job 280

- Process: `EMISSION_PROJECT`
- Step: `EMISSION_PROJECT_COLLECT`
- Route: `/admin/emission/survey-admin-data`
- Route ID: `emission-survey-admin-data`
- Implemented source: `projects/carbonet-frontend/source/src/features/emission-survey-admin-data/EmissionSurveyAdminDataMigrationPage.tsx`
