# Existing frontend adoption: job 271

- Process: `EMISSION_PROJECT`
- Step: `EMISSION_PROJECT_SETUP`
- Route: `/emission/project/create`
- Route ID: `emission-project-create`
- Implemented source: `projects/carbonet-frontend/source/src/features/emission-project-list/EmissionProjectCreatePage.tsx`
