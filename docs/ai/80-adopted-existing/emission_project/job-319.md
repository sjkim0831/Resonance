# Existing frontend adoption: job 319

- Process: `EMISSION_PROJECT`
- Step: `EMISSION_PROJECT_REPORT`
- Route: `/emission/report_submit`
- Route ID: `emission-report-submit`
- Implemented source: `projects/carbonet-frontend/source/src/features/emission-project-list/EmissionProjectReportPage.tsx`
