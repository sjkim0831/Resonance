# Existing frontend adoption: job 320

- Process: `EMISSION_PROJECT`
- Step: `EMISSION_PROJECT_REPORT`
- Route: `/admin/emission/survey-report`
- Route ID: `emission-survey-report`
- Implemented source: `projects/carbonet-frontend/source/src/features/emission-survey-report/EmissionSurveyReportMigrationPage.tsx`
