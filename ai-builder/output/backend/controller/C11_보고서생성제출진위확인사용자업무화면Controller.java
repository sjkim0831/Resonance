...
public class C11_보고서생성제출진위확인사용자업무화면Controller {

    private final C11_보고서생성제출진위확인사용자업무화면Service service;
