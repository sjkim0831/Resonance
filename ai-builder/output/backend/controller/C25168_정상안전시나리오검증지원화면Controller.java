...
public class C25168_정상안전시나리오검증지원화면Controller {

    private final C25168_정상안전시나리오검증지원화면Service service;
    ...
    public ResponseEntity<?> admin_api_system_actor_process() {
        log.info("Contract #{}: {}", 25168, "actor-process");
