...
public class C3727_포집수송저장데이터통합관리자업무화면Controller {

    private final C3727_포집수송저장데이터통합관리자업무화면Service service;
    ...
    public ResponseEntity<?> process_executions_screen_contract() {
        ...
        // Entry: 다음 프로세스 시작 조건을 충족한다: 시설 경계, 측정 지점, 기준선과 모니터링 계획이 승인되어 있다. 현재 상태는 STEP_1_COMPLETE
