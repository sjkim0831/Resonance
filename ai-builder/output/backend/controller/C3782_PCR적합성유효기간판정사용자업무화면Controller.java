...
public class C3782_PCR적합성유효기간판정사용자업무화면Controller {

    private final C3782_PCR적합성유효기간판정사용자업무화면Service service;
    ...
    public ResponseEntity<?> process_executions_screen_contract() {
        ...
        // Entry: 다음 프로세스 시작 조건을 충족한다: 제품 분류, 시장, 적용 기간과 후보 PCR이 확인된다. 현재 상태는 STEP_1_COMPLETED이며 서
