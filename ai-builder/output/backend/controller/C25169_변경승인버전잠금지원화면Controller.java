...
public class C25169_변경승인버전잠금지원화면Controller {

    private final C25169_변경승인버전잠금지원화면Service service;
    ...
    public ResponseEntity<?> admin_api_system_actor_process() {
        log.info("Contract #{}: {}", 25169, "actor-process");
