...
public class C25170_적용캐시무효화운영확인지원화면Controller {

    private final C25170_적용캐시무효화운영확인지원화면Service service;
    ...
    public ResponseEntity<?> admin_api_system_actor_process() {
        log.info("Contract #{}: {}", 25170, "actor-process");
