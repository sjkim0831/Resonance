...
public class C25167_기준워크플로설계지원화면Controller {

    private final C25167_기준워크플로설계지원화면Service service;
    ...
    public ResponseEntity<?> admin_api_system_actor_process() {
        log.info("Contract #{}: {}", 25167, "actor-process");
