...
public class C2784_기업심사승인관리자업무화면Controller {

    private final C2784_기업심사승인관리자업무화면Service service;
    ...
    public ResponseEntity<?> process_executions_screen_contract() {
        ...
        // Entry: 다음 프로세스 시작 조건을 충족한다: 회원가입 신청과 기업 증빙이 제출되어 있다. 현재 상태는 APPLIED이며 서버가 테넌트·프로젝트·액터 권
