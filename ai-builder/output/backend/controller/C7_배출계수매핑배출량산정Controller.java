...
public class C7_배출계수매핑배출량산정Controller {

    private final C7_배출계수매핑배출량산정Service service;
    ...
    public ResponseEntity<?> emission_projects_id_calculation(@PathVariable Long id) {
        log.info("Contract #{}: {}", 7, "calculation");
