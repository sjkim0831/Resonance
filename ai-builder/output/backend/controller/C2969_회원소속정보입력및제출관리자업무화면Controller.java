...
public class C2969_회원소속정보입력및제출관리자업무화면Controller {

    private final C2969_회원소속정보입력및제출관리자업무화면Service service;
    ...
    public ResponseEntity<?> process_executions_screen_contract() {
        ...
        // Entry: 다음 프로세스 시작 조건을 충족한다: 비로그인 사용자가 홈 또는 로그인 화면에서 회원가입을 선택한다. 현재 상태는 IDENTITY_VERIFIE
