...
public class C25165_변경요청근거등록지원화면Controller {

    private final C25165_변경요청근거등록지원화면Service service;
    ...
    public ResponseEntity<?> admin_api_system_actor_process() {
        log.info("Contract #{}: {}", 25165, "actor-process");
