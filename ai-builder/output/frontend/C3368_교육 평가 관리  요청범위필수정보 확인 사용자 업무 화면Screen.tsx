/**
 * Contract: #3368 | Route: /generated/education-assessment/education-assessment-s1
 * Process: EDUCATION_ASSESSMENT | Actor: EDUCATION_MANAGER
 * Screen: 교육 평가 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.054408
 */
...
export const C3368_교육 평가 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 평가 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_ASSESSMENT | Actor: EDUCATION_MANAGER | Contract: #3368
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3368_교육 평가 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
