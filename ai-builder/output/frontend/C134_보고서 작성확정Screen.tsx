/**
 * Contract: #134 | Route: /admin/emission/survey-report
 * Process: REPORT_CERTIFICATION | Actor: SITE_DATA_OWNER
 * Screen: 보고서 작성·확정
 * Generated: 2026-07-25T06:45:29.040073
 */
...
export const C134_보고서 작성확정Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 작성·확정" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_CERTIFICATION | Actor: SITE_DATA_OWNER | Contract: #134
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C134_보고서 작성확정Screen;
