/**
 * Contract: #3774 | Route: /generated/measurement-data-quality/measurement-data-quality-s2
 * Process: MEASUREMENT_DATA_QUALITY | Actor: SITE_DATA_OWNER
 * Screen: 교정·가동상태 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064458
 */
...
export const C3774_교정가동상태 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교정·가동상태 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEASUREMENT_DATA_QUALITY | Actor: SITE_DATA_OWNER | Contract: #3774
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3774_교정가동상태 검증 사용자 업무 화면Screen;
