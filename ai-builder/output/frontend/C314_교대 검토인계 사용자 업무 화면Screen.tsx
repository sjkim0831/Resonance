/**
 * Contract: #314 | Route: /ccus/facility/facility-operation-monitoring?step=fom_handover
 * Process: FACILITY_OPERATION_MONITORING | Actor: HSE_MANAGER
 * Screen: 교대 검토·인계 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040873
 */
...
export const C314_교대 검토인계 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교대 검토·인계 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_OPERATION_MONITORING | Actor: HSE_MANAGER | Contract: #314
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C314_교대 검토인계 사용자 업무 화면Screen;
