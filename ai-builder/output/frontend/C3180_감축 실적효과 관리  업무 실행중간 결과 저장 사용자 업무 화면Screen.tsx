/**
 * Contract: #3180 | Route: /generated/reduction-performance/reduction-performance-s2
 * Process: REDUCTION_PERFORMANCE | Actor: REDUCTION_MANAGER
 * Screen: 감축 실적·효과 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049704
 */
...
export const C3180_감축 실적효과 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 실적·효과 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PERFORMANCE | Actor: REDUCTION_MANAGER | Contract: #3180
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3180_감축 실적효과 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
