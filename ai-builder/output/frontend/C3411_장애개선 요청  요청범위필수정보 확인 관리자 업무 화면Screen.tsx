/**
 * Contract: #3411 | Route: /admin/generated/incident-improvement-request/incident-improvement-request-s1
 * Process: INCIDENT_IMPROVEMENT_REQUEST | Actor: SUPPORT_AGENT
 * Screen: 장애·개선 요청 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.055545
 */
...
// INCIDENT_IMPROVEMENT_REQUEST_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3411_장애개선 요청  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: INCIDENT_IMPROVEMENT_REQUEST_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="장애·개선 요청 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: INCIDENT_IMPROVEMENT_REQUEST | Actor: SUPPORT_AGENT | Contract: #3411
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3411_장애개선 요청  요청범위필수정보 확인 관리자 업무 화면Screen;
