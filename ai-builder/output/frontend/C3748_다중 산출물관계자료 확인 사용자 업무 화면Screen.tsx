/**
 * Contract: #3748 | Route: /generated/lca-allocation-sensitivity/lca-allocation-sensitivity-s1
 * Process: LCA_ALLOCATION_SENSITIVITY | Actor: LCA_PRACTITIONER
 * Screen: 다중 산출물·관계자료 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063838
 */
...
export const C3748_다중 산출물관계자료 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="다중 산출물·관계자료 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LCA_ALLOCATION_SENSITIVITY | Actor: LCA_PRACTITIONER | Contract: #3748
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3748_다중 산출물관계자료 확인 사용자 업무 화면Screen;
