/**
 * Contract: #3442 | Route: /generated/report-submission/report-submission-s1
 * Process: REPORT_SUBMISSION | Actor: COMPANY_MANAGER
 * Screen: 보고서 제출·접수 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.056301
 */
...
export const C3442_보고서 제출접수  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 제출·접수 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_SUBMISSION | Actor: COMPANY_MANAGER | Contract: #3442
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3442_보고서 제출접수  요청범위필수정보 확인 사용자 업무 화면Screen;
