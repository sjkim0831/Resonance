/**
 * Contract: #3186 | Route: /generated/reduction-scenario/reduction-scenario-s1
 * Process: REDUCTION_SCENARIO | Actor: DATA_ANALYST
 * Screen: 감축 시나리오 비교 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049840
 */
...
export const C3186_감축 시나리오 비교  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 시나리오 비교 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_SCENARIO | Actor: DATA_ANALYST | Contract: #3186
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3186_감축 시나리오 비교  요청범위필수정보 확인 사용자 업무 화면Screen;
