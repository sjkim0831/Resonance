/**
 * Contract: #3037 | Route: /admin/member/withdrawn
 * Process: ACCOUNT_WITHDRAWAL | Actor: PRIVACY_OFFICER
 * Screen: 회원 탈퇴·보유정보 처리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.046554
 */
...
// ACCOUNT_WITHDRAWAL_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3037_회원 탈퇴보유정보 처리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: ACCOUNT_WITHDRAWAL_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="회원 탈퇴·보유정보 처리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ACCOUNT_WITHDRAWAL | Actor: PRIVACY_OFFICER | Contract: #3037
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3037_회원 탈퇴보유정보 처리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
