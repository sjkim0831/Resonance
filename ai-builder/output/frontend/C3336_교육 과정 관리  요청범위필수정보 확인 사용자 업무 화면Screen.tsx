/**
 * Contract: #3336 | Route: /generated/course-management/course-management-s1
 * Process: COURSE_MANAGEMENT | Actor: EDUCATION_MANAGER
 * Screen: 교육 과정 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053270
 */
...
export const C3336_교육 과정 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 과정 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COURSE_MANAGEMENT | Actor: EDUCATION_MANAGER | Contract: #3336
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3336_교육 과정 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
