/**
 * Contract: #3777 | Route: /admin/generated/measurement-data-quality/measurement-data-quality-s3
 * Process: MEASUREMENT_DATA_QUALITY | Actor: VERIFIER
 * Screen: 결측·이상치 판정·대체 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.064520
 */
...
// MEASUREMENT_DATA_QUALITY_EXECUTE_3: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3777_결측이상치 판정대체 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: MEASUREMENT_DATA_QUALITY_EXECUTE_3
  ...
  return (
    <Card>
      <CardHeader title="결측·이상치 판정·대체 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEASUREMENT_DATA_QUALITY | Actor: VERIFIER | Contract: #3777
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3777_결측이상치 판정대체 관리자 업무 화면Screen;
