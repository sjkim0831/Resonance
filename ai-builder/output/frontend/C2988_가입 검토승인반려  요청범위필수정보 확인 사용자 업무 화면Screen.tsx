/**
 * Contract: #2988 | Route: /join/companyJoinStatusSearch
 * Process: MEMBER_APPROVAL | Actor: MEMBER_ADMIN
 * Screen: 가입 검토·승인·반려 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.045485
 */
...
// MEMBER_APPROVAL_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2988_가입 검토승인반려  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="가입 검토·승인·반려 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_APPROVAL | Actor: MEMBER_ADMIN | Contract: #2988
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2988_가입 검토승인반려  요청범위필수정보 확인 사용자 업무 화면Screen;
