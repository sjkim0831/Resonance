/**
 * Contract: #3013 | Route: /admin/member/reset_password
 * Process: PASSWORD_RECOVERY | Actor: MEMBER_USER
 * Screen: 비밀번호 재설정 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.046045
 */
...
// PASSWORD_RECOVERY_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3013_비밀번호 재설정  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: PASSWORD_RECOVERY_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="비밀번호 재설정 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PASSWORD_RECOVERY | Actor: MEMBER_USER | Contract: #3013
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3013_비밀번호 재설정  업무 실행중간 결과 저장 관리자 업무 화면Screen;
