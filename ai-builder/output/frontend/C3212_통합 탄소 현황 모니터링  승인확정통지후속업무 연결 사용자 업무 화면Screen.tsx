/**
 * Contract: #3212 | Route: /generated/integrated-monitoring/integrated-monitoring-s4
 * Process: INTEGRATED_MONITORING | Actor: APPROVER
 * Screen: 통합 탄소 현황 모니터링 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.050395
 */
...
export const C3212_통합 탄소 현황 모니터링  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="통합 탄소 현황 모니터링 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: INTEGRATED_MONITORING | Actor: APPROVER | Contract: #3212
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3212_통합 탄소 현황 모니터링  승인확정통지후속업무 연결 사용자 업무 화면Screen;
