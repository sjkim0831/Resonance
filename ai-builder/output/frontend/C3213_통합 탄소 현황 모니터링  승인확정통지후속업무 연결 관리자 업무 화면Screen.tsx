/**
 * Contract: #3213 | Route: /admin/generated/integrated-monitoring/integrated-monitoring-s4
 * Process: INTEGRATED_MONITORING | Actor: APPROVER
 * Screen: 통합 탄소 현황 모니터링 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.050414
 */
...
// INTEGRATED_MONITORING_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3213_통합 탄소 현황 모니터링  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: INTEGRATED_MONITORING_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="통합 탄소 현황 모니터링 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: INTEGRATED_MONITORING | Actor: APPROVER | Contract: #3213
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3213_통합 탄소 현황 모니터링  승인확정통지후속업무 연결 관리자 업무 화면Screen;
