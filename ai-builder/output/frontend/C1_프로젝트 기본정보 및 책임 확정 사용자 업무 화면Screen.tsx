...
export const C1_프로젝트 기본정보 및 책임 확정 사용자 업무 화면Screen = () => {
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_PROJECT | Actor: COMPANY_MANAGER | Contract: #1
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C1_프로젝트 기본정보 및 책임 확정 사용자 업무 화면Screen;
