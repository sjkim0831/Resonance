/**
 * Contract: #328 | Route: /ccus/facility/co2-injection-storage-operation?step=ciso_plan
 * Process: CO2_INJECTION_STORAGE_OPERATION | Actor: STORAGE_SITE_MANAGER
 * Screen: 주입계획·허용한계 설정 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.041327
 */
...
export const C328_주입계획허용한계 설정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="주입계획·허용한계 설정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_INJECTION_STORAGE_OPERATION | Actor: STORAGE_SITE_MANAGER | Contract: #328
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C328_주입계획허용한계 설정 사용자 업무 화면Screen;
