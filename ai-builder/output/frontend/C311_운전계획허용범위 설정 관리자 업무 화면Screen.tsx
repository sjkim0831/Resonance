/**
 * Contract: #311 | Route: /admin/ccus/facility/facility-operation-monitoring?step=fom_plan
 * Process: FACILITY_OPERATION_MONITORING | Actor: FACILITY_OPERATOR
 * Screen: 운전계획·허용범위 설정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.040776
 */
...
export const C311_운전계획허용범위 설정 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: fom_plan
      const r = await fetch('/api/ccus/facility/facility-operation-monitoring/fom_plan');
  ...
  return (
    <Card>
      <CardHeader title="운전계획·허용범위 설정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_OPERATION_MONITORING | Actor: FACILITY_OPERATOR | Contract: #311
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C311_운전계획허용범위 설정 관리자 업무 화면Screen;
