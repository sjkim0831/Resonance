...
export const C2964_약관개인정보GWP 고지 동의 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="약관·개인정보·GWP 고지 동의 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT | Contract: #2964
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2964_약관개인정보GWP 고지 동의 사용자 업무 화면Screen;
