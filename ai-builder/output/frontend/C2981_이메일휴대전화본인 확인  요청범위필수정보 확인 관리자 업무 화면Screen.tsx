/**
 * Contract: #2981 | Route: /admin/member/list
 * Process: IDENTITY_VERIFICATION | Actor: PUBLIC_APPLICANT
 * Screen: 이메일·휴대전화·본인 확인 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045323
 */
...
// IDENTITY_VERIFICATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2981_이메일휴대전화본인 확인  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: IDENTITY_VERIFICATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="이메일·휴대전화·본인 확인 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: IDENTITY_VERIFICATION | Actor: PUBLIC_APPLICANT | Contract: #2981
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2981_이메일휴대전화본인 확인  요청범위필수정보 확인 관리자 업무 화면Screen;
