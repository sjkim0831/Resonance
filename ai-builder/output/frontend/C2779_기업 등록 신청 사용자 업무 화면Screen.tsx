/**
 * Contract: #2779 | Route: /join/companyRegister
 * Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER
 * Screen: 기업 등록 신청 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.044324
 */
...
export const C2779_기업 등록 신청 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="기업 등록 신청 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER | Contract: #2779
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2779_기업 등록 신청 사용자 업무 화면Screen;
