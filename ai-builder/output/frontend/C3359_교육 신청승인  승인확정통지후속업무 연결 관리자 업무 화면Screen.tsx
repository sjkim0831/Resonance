/**
 * Contract: #3359 | Route: /admin/generated/education-application/education-application-s4
 * Process: EDUCATION_APPLICATION | Actor: APPROVER
 * Screen: 교육 신청·승인 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.053932
 */
...
// EDUCATION_APPLICATION_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3359_교육 신청승인  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EDUCATION_APPLICATION_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="교육 신청·승인 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_APPLICATION | Actor: APPROVER | Contract: #3359
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3359_교육 신청승인  승인확정통지후속업무 연결 관리자 업무 화면Screen;
