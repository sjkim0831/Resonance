/**
 * Contract: #535 | Route: /admin/system/process-workspace?process=MONITORING_ANALYSIS&step=MONITORING_EXPORT
 * Process: MONITORING_ANALYSIS | Actor: COMPANY_MANAGER
 * Screen: 모니터링·분석 - 분석 결과 내보내기
 * Generated: 2026-07-25T06:45:29.042935
 */
...
export const C535_모니터링분석  분석 결과 내보내기Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="모니터링·분석 - 분석 결과 내보내기" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MONITORING_ANALYSIS | Actor: COMPANY_MANAGER | Contract: #535
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C535_모니터링분석  분석 결과 내보내기Screen;
