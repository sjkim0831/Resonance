/**
 * Contract: #238 | Route: /emission/validate
 * Process: CUSTOMER_WORK_COORDINATION | Actor: APPROVER
 * Screen: 검토·승인
 * Generated: 2026-07-25T06:45:29.040206
 */
...
export const C238_검토승인Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="검토·승인" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CUSTOMER_WORK_COORDINATION | Actor: APPROVER | Contract: #238
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C238_검토승인Screen;
