/**
 * Contract: #3311 | Route: /admin/generated/refund-management/refund-management-s4
 * Process: REFUND_MANAGEMENT | Actor: APPROVER
 * Screen: 환불 요청·처리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.052705
 */
...
// REFUND_MANAGEMENT_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3311_환불 요청처리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REFUND_MANAGEMENT_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="환불 요청·처리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REFUND_MANAGEMENT | Actor: APPROVER | Contract: #3311
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3311_환불 요청처리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
