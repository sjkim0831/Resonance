/**
 * Contract: #3353 | Route: /admin/generated/education-application/education-application-s1
 * Process: EDUCATION_APPLICATION | Actor: MEMBER_USER
 * Screen: 교육 신청·승인 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.053735
 */
...
// EDUCATION_APPLICATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3353_교육 신청승인  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EDUCATION_APPLICATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="교육 신청·승인 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_APPLICATION | Actor: MEMBER_USER | Contract: #3353
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3353_교육 신청승인  요청범위필수정보 확인 관리자 업무 화면Screen;
