 ...
 * Process: EMISSION_PROJECT_PORTFOLIO | Actor: COMPANY_MANAGER
 * Screen: 배출량 프로젝트 운영
 * Generated: 2026-07-25T06:45:29.044240
 */
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_PROJECT_PORTFOLIO | Actor: COMPANY_MANAGER | Contract: #738
            </Typography>
            <Divider sx={ my: 2 } />
