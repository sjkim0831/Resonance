/**
 * Contract: #3272 | Route: /generated/supply-demand-matching/supply-demand-matching-s1
 * Process: SUPPLY_DEMAND_MATCHING | Actor: TRADE_OPERATOR
 * Screen: 공급·수요 매칭 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051836
 */
...
export const C3272_공급수요 매칭  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="공급·수요 매칭 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: SUPPLY_DEMAND_MATCHING | Actor: TRADE_OPERATOR | Contract: #3272
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3272_공급수요 매칭  요청범위필수정보 확인 사용자 업무 화면Screen;
