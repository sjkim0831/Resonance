/**
 * Contract: #3371 | Route: /admin/generated/education-assessment/education-assessment-s2
 * Process: EDUCATION_ASSESSMENT | Actor: EDUCATION_MANAGER
 * Screen: 교육 평가 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.054496
 */
...
// EDUCATION_ASSESSMENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3371_교육 평가 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EDUCATION_ASSESSMENT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="교육 평가 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_ASSESSMENT | Actor: EDUCATION_MANAGER | Contract: #3371
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3371_교육 평가 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
