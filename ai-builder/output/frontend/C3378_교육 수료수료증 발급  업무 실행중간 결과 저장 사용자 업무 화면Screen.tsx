/**
 * Contract: #3378 | Route: /generated/training-certificate/training-certificate-s2
 * Process: TRAINING_CERTIFICATE | Actor: CERTIFICATE_OFFICER
 * Screen: 교육 수료·수료증 발급 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.054681
 */
...
export const C3378_교육 수료수료증 발급  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 수료·수료증 발급 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TRAINING_CERTIFICATE | Actor: CERTIFICATE_OFFICER | Contract: #3378
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3378_교육 수료수료증 발급  업무 실행중간 결과 저장 사용자 업무 화면Screen;
