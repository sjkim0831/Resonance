/**
 * Contract: #3716 | Route: /generated/appeal-dispute-audit/appeal-dispute-audit-s4
 * Process: APPEAL_DISPUTE_AUDIT | Actor: APPROVER
 * Screen: 결정 통지·시정·종결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063055
 */
...
export const C3716_결정 통지시정종결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="결정 통지·시정·종결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: APPEAL_DISPUTE_AUDIT | Actor: APPROVER | Contract: #3716
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3716_결정 통지시정종결 사용자 업무 화면Screen;
