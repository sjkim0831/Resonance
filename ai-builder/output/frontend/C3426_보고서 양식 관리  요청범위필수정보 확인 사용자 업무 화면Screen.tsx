/**
 * Contract: #3426 | Route: /generated/report-template-management/report-template-management-s1
 * Process: REPORT_TEMPLATE_MANAGEMENT | Actor: CERTIFICATE_OFFICER
 * Screen: 보고서 양식 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.055913
 */
...
export const C3426_보고서 양식 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 양식 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_TEMPLATE_MANAGEMENT | Actor: CERTIFICATE_OFFICER | Contract: #3426
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3426_보고서 양식 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
