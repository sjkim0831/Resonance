/**
 * Contract: #3206 | Route: /generated/integrated-monitoring/integrated-monitoring-s1
 * Process: INTEGRATED_MONITORING | Actor: DATA_ANALYST
 * Screen: 통합 탄소 현황 모니터링 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.050265
 */
...
export const C3206_통합 탄소 현황 모니터링  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="통합 탄소 현황 모니터링 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: INTEGRATED_MONITORING | Actor: DATA_ANALYST | Contract: #3206
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3206_통합 탄소 현황 모니터링  요청범위필수정보 확인 사용자 업무 화면Screen;
