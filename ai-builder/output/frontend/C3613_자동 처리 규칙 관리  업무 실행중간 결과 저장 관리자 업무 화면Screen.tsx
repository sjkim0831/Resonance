/**
 * Contract: #3613 | Route: /admin/generated/automation-rule-management/automation-rule-management-s2
 * Process: AUTOMATION_RULE_MANAGEMENT | Actor: PLATFORM_OPERATOR
 * Screen: 자동 처리 규칙 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.060262
 */
...
// AUTOMATION_RULE_MANAGEMENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3613_자동 처리 규칙 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: AUTOMATION_RULE_MANAGEMENT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="자동 처리 규칙 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: AUTOMATION_RULE_MANAGEMENT | Actor: PLATFORM_OPERATOR | Contract: #3613
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3613_자동 처리 규칙 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
