/**
 * Contract: #3675 | Route: /admin/generated/batch-schedule-operation/batch-schedule-operation-s1
 * Process: BATCH_SCHEDULE_OPERATION | Actor: PLATFORM_OPERATOR
 * Screen: 배치·스케줄 운영 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.061787
 */
...
// BATCH_SCHEDULE_OPERATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3675_배치스케줄 운영  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: BATCH_SCHEDULE_OPERATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="배치·스케줄 운영 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: BATCH_SCHEDULE_OPERATION | Actor: PLATFORM_OPERATOR | Contract: #3675
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3675_배치스케줄 운영  요청범위필수정보 확인 관리자 업무 화면Screen;
