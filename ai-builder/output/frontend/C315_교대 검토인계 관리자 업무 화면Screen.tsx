/**
 * Contract: #315 | Route: /admin/ccus/facility/facility-operation-monitoring?step=fom_handover
 * Process: FACILITY_OPERATION_MONITORING | Actor: HSE_MANAGER
 * Screen: 교대 검토·인계 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.040894
 */
...
export const C315_교대 검토인계 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: fom_handover
      const r = await fetch('/api/ccus/facility/facility-operation-monitoring/fom_handover');
  ...
  return (
    <Card>
      <CardHeader title="교대 검토·인계 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_OPERATION_MONITORING | Actor: HSE_MANAGER | Contract: #315
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C315_교대 검토인계 관리자 업무 화면Screen;
