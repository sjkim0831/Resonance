/**
 * Contract: #3345 | Route: /admin/generated/education-schedule/education-schedule-s1
 * Process: EDUCATION_SCHEDULE | Actor: EDUCATION_MANAGER
 * Screen: 교육 일정·강사 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.053475
 */
...
// EDUCATION_SCHEDULE_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3345_교육 일정강사 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EDUCATION_SCHEDULE_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="교육 일정·강사 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_SCHEDULE | Actor: EDUCATION_MANAGER | Contract: #3345
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3345_교육 일정강사 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
