/**
 * Contract: #3344 | Route: /generated/education-schedule/education-schedule-s1
 * Process: EDUCATION_SCHEDULE | Actor: EDUCATION_MANAGER
 * Screen: 교육 일정·강사 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053446
 */
...
export const C3344_교육 일정강사 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 일정·강사 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_SCHEDULE | Actor: EDUCATION_MANAGER | Contract: #3344
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3344_교육 일정강사 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
