/**
 * Contract: #3714 | Route: /generated/appeal-dispute-audit/appeal-dispute-audit-s3
 * Process: APPEAL_DISPUTE_AUDIT | Actor: VERIFIER
 * Screen: 쟁점 검토·소명·재현 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.062821
 */
...
export const C3714_쟁점 검토소명재현 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="쟁점 검토·소명·재현 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: APPEAL_DISPUTE_AUDIT | Actor: VERIFIER | Contract: #3714
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3714_쟁점 검토소명재현 사용자 업무 화면Screen;
