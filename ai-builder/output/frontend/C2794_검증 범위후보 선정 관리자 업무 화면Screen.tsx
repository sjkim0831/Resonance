/**
 * Contract: #2794 | Route: /admin/generated/external-verification-engagement/external-verification-engagement-s1
 * Process: EXTERNAL_VERIFICATION_ENGAGEMENT | Actor: COMPANY_MANAGER
 * Screen: 검증 범위·후보 선정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044639
 */
...
// EXTERNAL_VERIFICATION_ENGAGEMENT_EXECUTE_1: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2794_검증 범위후보 선정 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EXTERNAL_VERIFICATION_ENGAGEMENT_EXECUTE_1
  ...
  return (
    <Card>
      <CardHeader title="검증 범위·후보 선정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_VERIFICATION_ENGAGEMENT | Actor: COMPANY_MANAGER | Contract: #2794
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2794_검증 범위후보 선정 관리자 업무 화면Screen;
