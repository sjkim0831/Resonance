/**
 * Contract: #2814 | Route: /admin/emission/survey-report
 * Process: CERTIFICATE_ISSUANCE | Actor: COMPANY_MANAGER
 * Screen: 보고서 확정·발급 준비 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044682
 */
...
export const C2814_보고서 확정발급 준비 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 확정·발급 준비 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CERTIFICATE_ISSUANCE | Actor: COMPANY_MANAGER | Contract: #2814
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2814_보고서 확정발급 준비 관리자 업무 화면Screen;
