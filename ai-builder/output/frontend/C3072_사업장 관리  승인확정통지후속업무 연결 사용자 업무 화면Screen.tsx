/**
 * Contract: #3072 | Route: /mypage/company
 * Process: BUSINESS_SITE_ADMINISTRATION | Actor: APPROVER
 * Screen: 사업장 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.047347
 */
...
export const C3072_사업장 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="사업장 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: BUSINESS_SITE_ADMINISTRATION | Actor: APPROVER | Contract: #3072
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3072_사업장 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen;
