/**
 * Contract: #3160 | Route: /generated/reduction-roadmap/reduction-roadmap-s1
 * Process: REDUCTION_ROADMAP | Actor: REDUCTION_MANAGER
 * Screen: 감축 로드맵 수립 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049274
 */
...
export const C3160_감축 로드맵 수립  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 로드맵 수립 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_ROADMAP | Actor: REDUCTION_MANAGER | Contract: #3160
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3160_감축 로드맵 수립  요청범위필수정보 확인 사용자 업무 화면Screen;
