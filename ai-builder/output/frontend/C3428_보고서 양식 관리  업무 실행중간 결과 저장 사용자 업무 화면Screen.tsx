/**
 * Contract: #3428 | Route: /generated/report-template-management/report-template-management-s2
 * Process: REPORT_TEMPLATE_MANAGEMENT | Actor: CERTIFICATE_OFFICER
 * Screen: 보고서 양식 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.055973
 */
...
export const C3428_보고서 양식 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 양식 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_TEMPLATE_MANAGEMENT | Actor: CERTIFICATE_OFFICER | Contract: #3428
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3428_보고서 양식 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
