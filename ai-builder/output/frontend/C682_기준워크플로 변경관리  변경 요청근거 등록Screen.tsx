/**
 * Contract: #682 | Route: /admin/system/process-workspace
 * Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR
 * Screen: 기준·워크플로 변경관리 - 변경 요청·근거 등록
 * Generated: 2026-07-25T06:45:29.043625
 */
...
export const C682_기준워크플로 변경관리  변경 요청근거 등록Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="기준·워크플로 변경관리 - 변경 요청·근거 등록" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR | Contract: #682
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C682_기준워크플로 변경관리  변경 요청근거 등록Screen;
