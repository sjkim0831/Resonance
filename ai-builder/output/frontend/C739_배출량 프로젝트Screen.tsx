 ...
 * Screen: 배출량 프로젝트
 * Generated: 2026-07-25T06:45:29.044262
 */
...
export const C739_배출량 프로젝트Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="배출량 프로젝트" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_PROJECT_PORTFOLIO | Actor: COMPANY_MANAGER | Contract: #739
            </Typography>
            <Divider sx={ my: 2 } />
