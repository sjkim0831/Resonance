/**
 * Contract: #324 | Route: /ccus/facility/preventive-maintenance?step=pm_execute
 * Process: PREVENTIVE_MAINTENANCE | Actor: MAINTENANCE_ENGINEER
 * Screen: 작업허가·정비 수행 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.041245
 */
...
export const C324_작업허가정비 수행 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="작업허가·정비 수행 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PREVENTIVE_MAINTENANCE | Actor: MAINTENANCE_ENGINEER | Contract: #324
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C324_작업허가정비 수행 사용자 업무 화면Screen;
