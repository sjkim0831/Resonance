/**
 * Contract: #3082 | Route: /generated/comparative-assertion-review/comparative-assertion-review-s1
 * Process: COMPARATIVE_ASSERTION_REVIEW | Actor: LCA_PRACTITIONER
 * Screen: 비교 목적·동등 조건 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.047525
 */
...
export const C3082_비교 목적동등 조건 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="비교 목적·동등 조건 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPARATIVE_ASSERTION_REVIEW | Actor: LCA_PRACTITIONER | Contract: #3082
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3082_비교 목적동등 조건 확인 사용자 업무 화면Screen;
