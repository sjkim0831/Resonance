/**
 * Contract: #3215 | Route: /admin/generated/data-quality-monitoring/data-quality-monitoring-s1
 * Process: DATA_QUALITY_MONITORING | Actor: VERIFIER
 * Screen: 데이터 품질 모니터링 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.050458
 */
...
// DATA_QUALITY_MONITORING_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3215_데이터 품질 모니터링  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DATA_QUALITY_MONITORING_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="데이터 품질 모니터링 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_QUALITY_MONITORING | Actor: VERIFIER | Contract: #3215
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3215_데이터 품질 모니터링  요청범위필수정보 확인 관리자 업무 화면Screen;
