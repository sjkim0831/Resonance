/**
 * Contract: #3257 | Route: /admin/generated/co2-supply-registration/co2-supply-registration-s2
 * Process: CO2_SUPPLY_REGISTRATION | Actor: TRADE_OPERATOR
 * Screen: CO2 공급 정보 등록 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.051469
 */
...
// CO2_SUPPLY_REGISTRATION_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3257_CO2 공급 정보 등록  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CO2_SUPPLY_REGISTRATION_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="CO2 공급 정보 등록 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_SUPPLY_REGISTRATION | Actor: TRADE_OPERATOR | Contract: #3257
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3257_CO2 공급 정보 등록  업무 실행중간 결과 저장 관리자 업무 화면Screen;
