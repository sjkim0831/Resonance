/**
 * Contract: #326 | Route: /ccus/facility/preventive-maintenance?step=pm_return_service
 * Process: PREVENTIVE_MAINTENANCE | Actor: FACILITY_OPERATOR
 * Screen: 기능시험·재가동 승인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.041287
 */
...
export const C326_기능시험재가동 승인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="기능시험·재가동 승인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PREVENTIVE_MAINTENANCE | Actor: FACILITY_OPERATOR | Contract: #326
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C326_기능시험재가동 승인 사용자 업무 화면Screen;
