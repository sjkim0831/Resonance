/**
 * Contract: #3565 | Route: /admin/generated/quality-scoring-policy/quality-scoring-policy-s2
 * Process: QUALITY_SCORING_POLICY | Actor: VERIFIER
 * Screen: 품질 점수 기준 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.059102
 */
...
// QUALITY_SCORING_POLICY_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3565_품질 점수 기준 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: QUALITY_SCORING_POLICY_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="품질 점수 기준 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: QUALITY_SCORING_POLICY | Actor: VERIFIER | Contract: #3565
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3565_품질 점수 기준 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
