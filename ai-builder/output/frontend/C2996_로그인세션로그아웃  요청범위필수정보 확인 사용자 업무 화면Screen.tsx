/**
 * Contract: #2996 | Route: /signin/loginView
 * Process: LOGIN_AUTHENTICATION | Actor: MEMBER_USER
 * Screen: 로그인·세션·로그아웃 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.045666
 */
...
export const C2996_로그인세션로그아웃  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="로그인·세션·로그아웃 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LOGIN_AUTHENTICATION | Actor: MEMBER_USER | Contract: #2996
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2996_로그인세션로그아웃  요청범위필수정보 확인 사용자 업무 화면Screen;
