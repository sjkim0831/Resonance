/**
 * Contract: #3605 | Route: /admin/generated/deadline-notification-policy/deadline-notification-policy-s2
 * Process: DEADLINE_NOTIFICATION_POLICY | Actor: PLATFORM_OPERATOR
 * Screen: 마감·알림 정책 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.060072
 */
...
// DEADLINE_NOTIFICATION_POLICY_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3605_마감알림 정책 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DEADLINE_NOTIFICATION_POLICY_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="마감·알림 정책 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DEADLINE_NOTIFICATION_POLICY | Actor: PLATFORM_OPERATOR | Contract: #3605
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3605_마감알림 정책 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
