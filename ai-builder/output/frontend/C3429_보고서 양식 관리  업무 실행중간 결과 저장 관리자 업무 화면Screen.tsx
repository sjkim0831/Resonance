/**
 * Contract: #3429 | Route: /admin/generated/report-template-management/report-template-management-s2
 * Process: REPORT_TEMPLATE_MANAGEMENT | Actor: CERTIFICATE_OFFICER
 * Screen: 보고서 양식 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.056006
 */
...
// REPORT_TEMPLATE_MANAGEMENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3429_보고서 양식 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REPORT_TEMPLATE_MANAGEMENT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="보고서 양식 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_TEMPLATE_MANAGEMENT | Actor: CERTIFICATE_OFFICER | Contract: #3429
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3429_보고서 양식 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
