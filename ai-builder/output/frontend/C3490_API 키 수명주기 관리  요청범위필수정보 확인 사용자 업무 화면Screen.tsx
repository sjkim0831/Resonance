/**
 * Contract: #3490 | Route: /generated/api-key-lifecycle/api-key-lifecycle-s1
 * Process: API_KEY_LIFECYCLE | Actor: SYSTEM_INTEGRATOR
 * Screen: API 키 수명주기 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.057373
 */
...
export const C3490_API 키 수명주기 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="API 키 수명주기 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: API_KEY_LIFECYCLE | Actor: SYSTEM_INTEGRATOR | Contract: #3490
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3490_API 키 수명주기 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
