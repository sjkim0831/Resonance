/**
 * Contract: #306 | Route: /ccus/facility/facility-asset-registry?step=far_assign
 * Process: FACILITY_ASSET_REGISTRY | Actor: MAINTENANCE_ENGINEER
 * Screen: 책임·허가·정비기준 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040669
 */
...
export const C306_책임허가정비기준 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="책임·허가·정비기준 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_ASSET_REGISTRY | Actor: MAINTENANCE_ENGINEER | Contract: #306
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C306_책임허가정비기준 연결 사용자 업무 화면Screen;
