/**
 * Contract: #2968 | Route: /join/step4
 * Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT
 * Screen: 회원·소속 정보 입력 및 제출 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.045008
 */
...
export const C2968_회원소속 정보 입력 및 제출 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="회원·소속 정보 입력 및 제출 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT | Contract: #2968
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2968_회원소속 정보 입력 및 제출 사용자 업무 화면Screen;
