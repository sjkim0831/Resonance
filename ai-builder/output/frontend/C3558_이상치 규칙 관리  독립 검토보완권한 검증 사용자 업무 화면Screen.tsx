/**
 * Contract: #3558 | Route: /generated/outlier-rule-management/outlier-rule-management-s3
 * Process: OUTLIER_RULE_MANAGEMENT | Actor: VERIFIER
 * Screen: 이상치 규칙 관리 - 독립 검토·보완·권한 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.058952
 */
...
export const C3558_이상치 규칙 관리  독립 검토보완권한 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="이상치 규칙 관리 - 독립 검토·보완·권한 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: OUTLIER_RULE_MANAGEMENT | Actor: VERIFIER | Contract: #3558
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3558_이상치 규칙 관리  독립 검토보완권한 검증 사용자 업무 화면Screen;
