/**
 * Contract: #3188 | Route: /generated/reduction-scenario/reduction-scenario-s2
 * Process: REDUCTION_SCENARIO | Actor: DATA_ANALYST
 * Screen: 감축 시나리오 비교 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049881
 */
...
export const C3188_감축 시나리오 비교  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 시나리오 비교 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_SCENARIO | Actor: DATA_ANALYST | Contract: #3188
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3188_감축 시나리오 비교  업무 실행중간 결과 저장 사용자 업무 화면Screen;
