/**
 * Contract: #3419 | Route: /admin/generated/newsletter-operation/newsletter-operation-s1
 * Process: NEWSLETTER_OPERATION | Actor: CONTENT_MANAGER
 * Screen: 뉴스레터 구독·발송 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.055764
 */
...
// NEWSLETTER_OPERATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3419_뉴스레터 구독발송  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: NEWSLETTER_OPERATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="뉴스레터 구독·발송 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: NEWSLETTER_OPERATION | Actor: CONTENT_MANAGER | Contract: #3419
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3419_뉴스레터 구독발송  요청범위필수정보 확인 관리자 업무 화면Screen;
