/**
 * Contract: #3337 | Route: /admin/generated/course-management/course-management-s1
 * Process: COURSE_MANAGEMENT | Actor: EDUCATION_MANAGER
 * Screen: 교육 과정 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.053292
 */
...
// COURSE_MANAGEMENT_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3337_교육 과정 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: COURSE_MANAGEMENT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="교육 과정 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COURSE_MANAGEMENT | Actor: EDUCATION_MANAGER | Contract: #3337
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3337_교육 과정 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
