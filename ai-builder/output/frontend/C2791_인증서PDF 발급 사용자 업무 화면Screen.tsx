 ...
 * Generated: 2026-07-25T06:45:29.044584
 */
...
export const C2791_인증서PDF 발급 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="인증서·PDF 발급 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CERTIFICATE_ISSUANCE | Actor: APPROVER | Contract: #2791
            </Typography>
            <Divider sx={ my: 2 } />
