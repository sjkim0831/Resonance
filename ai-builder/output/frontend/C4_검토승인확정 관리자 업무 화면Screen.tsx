/**
 * Contract: #4 | Route: /admin/emission/approval-workflow
 * Process: EMISSION_PROJECT | Actor: APPROVER
 * Screen: 검토·승인·확정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.039110
 */
...
export const C4_검토승인확정 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // POST: decision
      const r = await fetch('/home/api/emission-projects/{id}/submissions/{submissionId}/approval/decision',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(formData)});
  ...
  return (
    <Card>
      <CardHeader title="검토·승인·확정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_PROJECT | Actor: APPROVER | Contract: #4
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C4_검토승인확정 관리자 업무 화면Screen;
