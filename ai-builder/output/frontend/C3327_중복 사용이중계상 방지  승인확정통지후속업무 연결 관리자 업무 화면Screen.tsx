/**
 * Contract: #3327 | Route: /admin/generated/double-use-prevention/double-use-prevention-s4
 * Process: DOUBLE_USE_PREVENTION | Actor: APPROVER
 * Screen: 중복 사용·이중계상 방지 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.053064
 */
...
// DOUBLE_USE_PREVENTION_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3327_중복 사용이중계상 방지  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DOUBLE_USE_PREVENTION_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="중복 사용·이중계상 방지 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DOUBLE_USE_PREVENTION | Actor: APPROVER | Contract: #3327
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3327_중복 사용이중계상 방지  승인확정통지후속업무 연결 관리자 업무 화면Screen;
