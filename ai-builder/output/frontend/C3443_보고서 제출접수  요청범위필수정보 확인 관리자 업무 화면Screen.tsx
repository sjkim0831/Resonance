/**
 * Contract: #3443 | Route: /admin/generated/report-submission/report-submission-s1
 * Process: REPORT_SUBMISSION | Actor: COMPANY_MANAGER
 * Screen: 보고서 제출·접수 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.056320
 */
...
// REPORT_SUBMISSION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3443_보고서 제출접수  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REPORT_SUBMISSION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="보고서 제출·접수 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_SUBMISSION | Actor: COMPANY_MANAGER | Contract: #3443
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3443_보고서 제출접수  요청범위필수정보 확인 관리자 업무 화면Screen;
