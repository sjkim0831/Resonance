/**
 * Contract: #3335 | Route: /admin/generated/carbon-credit-management/carbon-credit-management-s4
 * Process: CARBON_CREDIT_MANAGEMENT | Actor: APPROVER
 * Screen: 탄소크레딧 발급·보유·소각 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.053248
 */
...
// CARBON_CREDIT_MANAGEMENT_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3335_탄소크레딧 발급보유소각  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CARBON_CREDIT_MANAGEMENT_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="탄소크레딧 발급·보유·소각 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CARBON_CREDIT_MANAGEMENT | Actor: APPROVER | Contract: #3335
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3335_탄소크레딧 발급보유소각  승인확정통지후속업무 연결 관리자 업무 화면Screen;
