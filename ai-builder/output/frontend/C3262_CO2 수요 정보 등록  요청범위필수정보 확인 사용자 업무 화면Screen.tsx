/**
 * Contract: #3262 | Route: /generated/co2-demand-registration/co2-demand-registration-s1
 * Process: CO2_DEMAND_REGISTRATION | Actor: TRADE_OPERATOR
 * Screen: CO2 수요 정보 등록 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051584
 */
...
export const C3262_CO2 수요 정보 등록  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="CO2 수요 정보 등록 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_DEMAND_REGISTRATION | Actor: TRADE_OPERATOR | Contract: #3262
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3262_CO2 수요 정보 등록  요청범위필수정보 확인 사용자 업무 화면Screen;
