/**
 * Contract: #3067 | Route: /admin/emission/site-management
 * Process: BUSINESS_SITE_ADMINISTRATION | Actor: COMPANY_ADMIN
 * Screen: 사업장 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.047225
 */
...
// BUSINESS_SITE_ADMINISTRATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3067_사업장 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: BUSINESS_SITE_ADMINISTRATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="사업장 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: BUSINESS_SITE_ADMINISTRATION | Actor: COMPANY_ADMIN | Contract: #3067
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3067_사업장 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
