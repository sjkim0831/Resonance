/**
 * Contract: #3781 | Route: /admin/generated/pcr-epd-verification/pcr-epd-verification-s1
 * Process: PCR_EPD_VERIFICATION | Actor: LCA_PRACTITIONER
 * Screen: 제품 분류·PCR 탐색 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.064644
 */
...
// PCR_EPD_VERIFICATION_EXECUTE_1: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3781_제품 분류PCR 탐색 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: PCR_EPD_VERIFICATION_EXECUTE_1
  ...
  return (
    <Card>
      <CardHeader title="제품 분류·PCR 탐색 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PCR_EPD_VERIFICATION | Actor: LCA_PRACTITIONER | Contract: #3781
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3781_제품 분류PCR 탐색 관리자 업무 화면Screen;
