/**
 * Contract: #3754 | Route: /generated/lca-allocation-sensitivity/lca-allocation-sensitivity-s4
 * Process: LCA_ALLOCATION_SENSITIVITY | Actor: APPROVER
 * Screen: 규칙 정당성·결론 승인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063981
 */
...
// LCA_ALLOCATION_SENSITIVITY_EXECUTE_4: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3754_규칙 정당성결론 승인 사용자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: LCA_ALLOCATION_SENSITIVITY_EXECUTE_4
  ...
  return (
    <Card>
      <CardHeader title="규칙 정당성·결론 승인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LCA_ALLOCATION_SENSITIVITY | Actor: APPROVER | Contract: #3754
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3754_규칙 정당성결론 승인 사용자 업무 화면Screen;
