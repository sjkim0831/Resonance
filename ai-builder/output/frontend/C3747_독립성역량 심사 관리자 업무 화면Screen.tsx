/**
 * Contract: #3747 | Route: /admin/generated/external-verification-engagement/external-verification-engagement-s2
 * Process: EXTERNAL_VERIFICATION_ENGAGEMENT | Actor: COMPANY_MANAGER
 * Screen: 독립성·역량 심사 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.063818
 */
...
// EXTERNAL_VERIFICATION_ENGAGEMENT_EXECUTE_2: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3747_독립성역량 심사 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EXTERNAL_VERIFICATION_ENGAGEMENT_EXECUTE_2
  ...
  return (
    <Card>
      <CardHeader title="독립성·역량 심사 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_VERIFICATION_ENGAGEMENT | Actor: COMPANY_MANAGER | Contract: #3747
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3747_독립성역량 심사 관리자 업무 화면Screen;
