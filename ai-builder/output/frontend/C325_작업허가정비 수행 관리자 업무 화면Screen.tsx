/**
 * Contract: #325 | Route: /admin/ccus/facility/preventive-maintenance?step=pm_execute
 * Process: PREVENTIVE_MAINTENANCE | Actor: MAINTENANCE_ENGINEER
 * Screen: 작업허가·정비 수행 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.041265
 */
...
export const C325_작업허가정비 수행 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: pm_execute
      const r = await fetch('/api/ccus/facility/preventive-maintenance/pm_execute');
  ...
  return (
    <Card>
      <CardHeader title="작업허가·정비 수행 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PREVENTIVE_MAINTENANCE | Actor: MAINTENANCE_ENGINEER | Contract: #325
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C325_작업허가정비 수행 관리자 업무 화면Screen;
