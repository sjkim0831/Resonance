/**
 * Contract: #3230 | Route: /generated/analysis-export/analysis-export-s4
 * Process: ANALYSIS_EXPORT | Actor: APPROVER
 * Screen: 분석 데이터 내보내기 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.050874
 */
...
export const C3230_분석 데이터 내보내기  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="분석 데이터 내보내기 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ANALYSIS_EXPORT | Actor: APPROVER | Contract: #3230
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3230_분석 데이터 내보내기  승인확정통지후속업무 연결 사용자 업무 화면Screen;
