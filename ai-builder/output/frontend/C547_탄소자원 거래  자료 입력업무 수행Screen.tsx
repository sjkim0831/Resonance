/**
 * Contract: #547 | Route: /admin/system/process-workspace?process=TRADE_EXECUTION&step=TRADE_EXECUTION_02_WORK
 * Process: TRADE_EXECUTION | Actor: SITE_DATA_OWNER
 * Screen: 탄소·자원 거래 - 자료 입력·업무 수행
 * Generated: 2026-07-25T06:45:29.043200
 */
...
export const C547_탄소자원 거래  자료 입력업무 수행Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="탄소·자원 거래 - 자료 입력·업무 수행" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TRADE_EXECUTION | Actor: SITE_DATA_OWNER | Contract: #547
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C547_탄소자원 거래  자료 입력업무 수행Screen;
