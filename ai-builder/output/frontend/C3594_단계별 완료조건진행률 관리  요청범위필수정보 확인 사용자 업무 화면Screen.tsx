/**
 * Contract: #3594 | Route: /generated/process-completion-policy/process-completion-policy-s1
 * Process: PROCESS_COMPLETION_POLICY | Actor: PLATFORM_OPERATOR
 * Screen: 단계별 완료조건·진행률 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.059809
 */
...
export const C3594_단계별 완료조건진행률 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="단계별 완료조건·진행률 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROCESS_COMPLETION_POLICY | Actor: PLATFORM_OPERATOR | Contract: #3594
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3594_단계별 완료조건진행률 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
