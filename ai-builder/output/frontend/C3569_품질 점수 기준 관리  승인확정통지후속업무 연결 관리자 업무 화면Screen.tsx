/**
 * Contract: #3569 | Route: /admin/generated/quality-scoring-policy/quality-scoring-policy-s4
 * Process: QUALITY_SCORING_POLICY | Actor: APPROVER
 * Screen: 품질 점수 기준 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.059215
 */
...
// QUALITY_SCORING_POLICY_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3569_품질 점수 기준 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: QUALITY_SCORING_POLICY_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="품질 점수 기준 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: QUALITY_SCORING_POLICY | Actor: APPROVER | Contract: #3569
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3569_품질 점수 기준 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
