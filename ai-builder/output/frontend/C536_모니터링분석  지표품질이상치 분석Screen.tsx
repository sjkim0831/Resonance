/**
 * Contract: #536 | Route: /admin/system/process-workspace?process=MONITORING_ANALYSIS&step=MONITORING_REVIEW
 * Process: MONITORING_ANALYSIS | Actor: VERIFIER
 * Screen: 모니터링·분석 - 지표·품질·이상치 분석
 * Generated: 2026-07-25T06:45:29.042959
 */
...
export const C536_모니터링분석  지표품질이상치 분석Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="모니터링·분석 - 지표·품질·이상치 분석" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MONITORING_ANALYSIS | Actor: VERIFIER | Contract: #536
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C536_모니터링분석  지표품질이상치 분석Screen;
