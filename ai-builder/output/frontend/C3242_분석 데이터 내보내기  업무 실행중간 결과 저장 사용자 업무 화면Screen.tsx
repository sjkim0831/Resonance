/**
 * Contract: #3242 | Route: /generated/analysis-export/analysis-export-s2
 * Process: ANALYSIS_EXPORT | Actor: DATA_ANALYST
 * Screen: 분석 데이터 내보내기 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051144
 */
...
export const C3242_분석 데이터 내보내기  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="분석 데이터 내보내기 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ANALYSIS_EXPORT | Actor: DATA_ANALYST | Contract: #3242
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3242_분석 데이터 내보내기  업무 실행중간 결과 저장 사용자 업무 화면Screen;
