/**
 * Contract: #3351 | Route: /admin/generated/education-schedule/education-schedule-s4
 * Process: EDUCATION_SCHEDULE | Actor: APPROVER
 * Screen: 교육 일정·강사 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.053673
 */
...
// EDUCATION_SCHEDULE_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3351_교육 일정강사 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EDUCATION_SCHEDULE_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="교육 일정·강사 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_SCHEDULE | Actor: APPROVER | Contract: #3351
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3351_교육 일정강사 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
