/**
 * Contract: #3573 | Route: /admin/generated/approval-line-management/approval-line-management-s2
 * Process: APPROVAL_LINE_MANAGEMENT | Actor: AUTHORITY_ADMIN
 * Screen: 승인선 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.059293
 */
...
// APPROVAL_LINE_MANAGEMENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3573_승인선 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: APPROVAL_LINE_MANAGEMENT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="승인선 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: APPROVAL_LINE_MANAGEMENT | Actor: AUTHORITY_ADMIN | Contract: #3573
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3573_승인선 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
