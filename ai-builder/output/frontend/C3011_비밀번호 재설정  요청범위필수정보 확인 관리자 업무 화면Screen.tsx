/**
 * Contract: #3011 | Route: /admin/member/reset_password
 * Process: PASSWORD_RECOVERY | Actor: MEMBER_USER
 * Screen: 비밀번호 재설정 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045995
 */
...
// PASSWORD_RECOVERY_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3011_비밀번호 재설정  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="비밀번호 재설정 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PASSWORD_RECOVERY | Actor: MEMBER_USER | Contract: #3011
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3011_비밀번호 재설정  요청범위필수정보 확인 관리자 업무 화면Screen;
