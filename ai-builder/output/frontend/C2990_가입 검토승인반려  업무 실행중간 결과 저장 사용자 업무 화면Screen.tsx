/**
 * Contract: #2990 | Route: /join/companyJoinStatusDetail
 * Process: MEMBER_APPROVAL | Actor: MEMBER_ADMIN
 * Screen: 가입 검토·승인·반려 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.045529
 */
...
// MEMBER_APPROVAL_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2990_가입 검토승인반려  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="가입 검토·승인·반려 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_APPROVAL | Actor: MEMBER_ADMIN | Contract: #2990
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2990_가입 검토승인반려  업무 실행중간 결과 저장 사용자 업무 화면Screen;
