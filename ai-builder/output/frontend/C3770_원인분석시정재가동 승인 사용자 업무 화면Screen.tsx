/**
 * Contract: #3770 | Route: /generated/leakage-incident-response/leakage-incident-response-s4
 * Process: LEAKAGE_INCIDENT_RESPONSE | Actor: COMPANY_MANAGER
 * Screen: 원인분석·시정·재가동 승인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064376
 */
...
export const C3770_원인분석시정재가동 승인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="원인분석·시정·재가동 승인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LEAKAGE_INCIDENT_RESPONSE | Actor: COMPANY_MANAGER | Contract: #3770
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3770_원인분석시정재가동 승인 사용자 업무 화면Screen;
