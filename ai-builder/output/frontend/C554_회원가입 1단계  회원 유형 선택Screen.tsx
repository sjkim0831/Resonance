/**
 * Contract: #554 | Route: /join/step1
 * Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT
 * Screen: 회원가입 1단계 - 회원 유형 선택
 * Generated: 2026-07-25T06:45:29.043307
 */
...
export const C554_회원가입 1단계  회원 유형 선택Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="회원가입 1단계 - 회원 유형 선택" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT | Contract: #554
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C554_회원가입 1단계  회원 유형 선택Screen;
