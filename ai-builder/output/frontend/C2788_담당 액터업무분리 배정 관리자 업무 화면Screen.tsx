/**
 * Contract: #2788 | Route: /admin/system/actor-process
 * Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER
 * Screen: 담당 액터·업무분리 배정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044542
 */
...
// ASSIGN_ACTORS: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2788_담당 액터업무분리 배정 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="담당 액터·업무분리 배정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER | Contract: #2788
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2788_담당 액터업무분리 배정 관리자 업무 화면Screen;
