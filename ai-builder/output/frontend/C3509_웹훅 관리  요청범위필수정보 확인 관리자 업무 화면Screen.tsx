/**
 * Contract: #3509 | Route: /admin/generated/webhook-management/webhook-management-s1
 * Process: WEBHOOK_MANAGEMENT | Actor: SYSTEM_INTEGRATOR
 * Screen: 웹훅 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.057850
 */
...
export const C3509_웹훅 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: WEBHOOK_MANAGEMENT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="웹훅 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: WEBHOOK_MANAGEMENT | Actor: SYSTEM_INTEGRATOR | Contract: #3509
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3509_웹훅 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
