/**
 * Contract: #3586 | Route: /generated/task-template-management/task-template-management-s1
 * Process: TASK_TEMPLATE_MANAGEMENT | Actor: PLATFORM_OPERATOR
 * Screen: Task 템플릿 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.059621
 */
...
export const C3586_Task 템플릿 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="Task 템플릿 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TASK_TEMPLATE_MANAGEMENT | Actor: PLATFORM_OPERATOR | Contract: #3586
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3586_Task 템플릿 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
