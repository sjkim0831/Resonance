/**
 * Contract: #3499 | Route: /admin/generated/data-schema-contract/data-schema-contract-s1
 * Process: DATA_SCHEMA_CONTRACT | Actor: SYSTEM_INTEGRATOR
 * Screen: 데이터 스키마·계약 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.057581
 */
...
// DATA_SCHEMA_CONTRACT_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3499_데이터 스키마계약 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DATA_SCHEMA_CONTRACT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="데이터 스키마·계약 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_SCHEMA_CONTRACT | Actor: SYSTEM_INTEGRATOR | Contract: #3499
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3499_데이터 스키마계약 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
