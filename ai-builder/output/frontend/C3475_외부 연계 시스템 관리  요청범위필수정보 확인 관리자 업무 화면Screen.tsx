/**
 * Contract: #3475 | Route: /admin/generated/external-system-registry/external-system-registry-s1
 * Process: EXTERNAL_SYSTEM_REGISTRY | Actor: SYSTEM_INTEGRATOR
 * Screen: 외부 연계 시스템 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.057070
 */
...
// EXTERNAL_SYSTEM_REGISTRY_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3475_외부 연계 시스템 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EXTERNAL_SYSTEM_REGISTRY_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="외부 연계 시스템 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SYSTEM_REGISTRY | Actor: SYSTEM_INTEGRATOR | Contract: #3475
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3475_외부 연계 시스템 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
