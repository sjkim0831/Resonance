...
export const C3029_내 정보알림보안 설정  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="내 정보·알림·보안 설정 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROFILE_MANAGEMENT | Actor: MEMBER_USER | Contract: #3029
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3029_내 정보알림보안 설정  업무 실행중간 결과 저장 관리자 업무 화면Screen;
