/**
 * Contract: #3127 | Route: /admin/generated/user-authority-assignment/user-authority-assignment-s2
 * Process: USER_AUTHORITY_ASSIGNMENT | Actor: AUTHORITY_ADMIN
 * Screen: 사용자별 권한 배정 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.048510
 */
...
// USER_AUTHORITY_ASSIGNMENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3127_사용자별 권한 배정  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: USER_AUTHORITY_ASSIGNMENT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="사용자별 권한 배정 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: USER_AUTHORITY_ASSIGNMENT | Actor: AUTHORITY_ADMIN | Contract: #3127
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3127_사용자별 권한 배정  업무 실행중간 결과 저장 관리자 업무 화면Screen;
