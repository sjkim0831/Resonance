/**
 * Contract: #3271 | Route: /admin/generated/co2-demand-registration/co2-demand-registration-s4
 * Process: CO2_DEMAND_REGISTRATION | Actor: APPROVER
 * Screen: CO2 수요 정보 등록 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.051799
 */
...
// CO2_DEMAND_REGISTRATION_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3271_CO2 수요 정보 등록  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CO2_DEMAND_REGISTRATION_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="CO2 수요 정보 등록 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_DEMAND_REGISTRATION | Actor: APPROVER | Contract: #3271
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3271_CO2 수요 정보 등록  승인확정통지후속업무 연결 관리자 업무 화면Screen;
