/**
 * Contract: #467 | Route: /admin/work/certificate-fee-tax-refund?step=cftr_bill
 * Process: CERTIFICATE_FEE_TAX_REFUND | Actor: SETTLEMENT_OPERATOR
 * Screen: 수수료·가상계좌·청구 생성 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.042102
 */
...
export const C467_수수료가상계좌청구 생성 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: cftr_bill
      const r = await fetch('/api/work/certificate-fee-tax-refund/cftr_bill');
  ...
  return (
    <Card>
      <CardHeader title="수수료·가상계좌·청구 생성 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CERTIFICATE_FEE_TAX_REFUND | Actor: SETTLEMENT_OPERATOR | Contract: #467
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C467_수수료가상계좌청구 생성 관리자 업무 화면Screen;
