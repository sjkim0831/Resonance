/**
 * Contract: #327 | Route: /admin/ccus/facility/preventive-maintenance?step=pm_return_service
 * Process: PREVENTIVE_MAINTENANCE | Actor: FACILITY_OPERATOR
 * Screen: 기능시험·재가동 승인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.041307
 */
...
export const C327_기능시험재가동 승인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    setLoading(true);
    try {
      // GET: pm_return_service
      const r = await fetch('/api/ccus/facility/preventive-maintenance/pm_return_service');
  ...
  return (
    <Card>
      <CardHeader title="기능시험·재가동 승인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PREVENTIVE_MAINTENANCE | Actor: FACILITY_OPERATOR | Contract: #327
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C327_기능시험재가동 승인 관리자 업무 화면Screen;
