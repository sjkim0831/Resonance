/**
 * Contract: #334 | Route: /ccus/facility/facility-emergency-response?step=fer_declare
 * Process: FACILITY_EMERGENCY_RESPONSE | Actor: FACILITY_OPERATOR
 * Screen: 사고 탐지·비상 선언 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.041827
 */
...
export const C334_사고 탐지비상 선언 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="사고 탐지·비상 선언 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_EMERGENCY_RESPONSE | Actor: FACILITY_OPERATOR | Contract: #334
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C334_사고 탐지비상 선언 사용자 업무 화면Screen;
