...
export const C2787_담당 액터업무분리 배정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="담당 액터·업무분리 배정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER | Contract: #2787
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2787_담당 액터업무분리 배정 사용자 업무 화면Screen;
