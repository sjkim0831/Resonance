/**
 * Contract: #240 | Route: /admin/emission/project-operations
 * Process: CUSTOMER_WORK_COORDINATION | Actor: COMPANY_MANAGER
 * Screen: 배출량 프로젝트 운영
 * Generated: 2026-07-25T06:45:29.040248
 */
...
export const C240_배출량 프로젝트 운영Screen = () => {
  ...
  const loadData = useCallback(async () => {
    setLoading(true);
    try {
      // GET: emission-projects
      const r = await fetch('/home/api/emission-projects');
  ...
  return (
    <Card>
      <CardHeader title="배출량 프로젝트 운영" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CUSTOMER_WORK_COORDINATION | Actor: COMPANY_MANAGER | Contract: #240
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C240_배출량 프로젝트 운영Screen;
