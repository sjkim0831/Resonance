/**
 * Contract: #3130 | Route: /generated/user-authority-assignment/user-authority-assignment-s4
 * Process: USER_AUTHORITY_ASSIGNMENT | Actor: APPROVER
 * Screen: 사용자별 권한 배정 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.048589
 */
...
export const C3130_사용자별 권한 배정  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="사용자별 권한 배정 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: USER_AUTHORITY_ASSIGNMENT | Actor: APPROVER | Contract: #3130
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3130_사용자별 권한 배정  승인확정통지후속업무 연결 사용자 업무 화면Screen;
