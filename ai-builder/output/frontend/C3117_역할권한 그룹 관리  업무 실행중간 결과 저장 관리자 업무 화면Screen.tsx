/**
 * Contract: #3117 | Route: /admin/generated/role-authority-management/role-authority-management-s2
 * Process: ROLE_AUTHORITY_MANAGEMENT | Actor: AUTHORITY_ADMIN
 * Screen: 역할·권한 그룹 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.048287
 */
...
// ROLE_AUTHORITY_MANAGEMENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3117_역할권한 그룹 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: ROLE_AUTHORITY_MANAGEMENT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="역할·권한 그룹 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ROLE_AUTHORITY_MANAGEMENT | Actor: AUTHORITY_ADMIN | Contract: #3117
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3117_역할권한 그룹 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
