/**
 * Contract: #3700 | Route: /generated/external-service-status/external-service-status-s2
 * Process: EXTERNAL_SERVICE_STATUS | Actor: SYSTEM_INTEGRATOR
 * Screen: 외부 서비스 상태 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.062486
 */
...
export const C3700_외부 서비스 상태 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="외부 서비스 상태 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SERVICE_STATUS | Actor: SYSTEM_INTEGRATOR | Contract: #3700
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3700_외부 서비스 상태 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
