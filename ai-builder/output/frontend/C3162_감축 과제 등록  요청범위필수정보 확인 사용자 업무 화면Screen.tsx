/**
 * Contract: #3162 | Route: /generated/reduction-project-registration/reduction-project-registration-s1
 * Process: REDUCTION_PROJECT_REGISTRATION | Actor: REDUCTION_MANAGER
 * Screen: 감축 과제 등록 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049317
 */
...
export const C3162_감축 과제 등록  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 과제 등록 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PROJECT_REGISTRATION | Actor: REDUCTION_MANAGER | Contract: #3162
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3162_감축 과제 등록  요청범위필수정보 확인 사용자 업무 화면Screen;
