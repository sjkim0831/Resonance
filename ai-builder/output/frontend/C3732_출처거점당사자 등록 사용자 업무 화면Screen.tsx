/**
 * Contract: #3732 | Route: /generated/chain-of-custody/chain-of-custody-s1
 * Process: CHAIN_OF_CUSTODY | Actor: SYSTEM_INTEGRATOR
 * Screen: 출처·거점·당사자 등록 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063451
 */
...
// CHAIN_OF_CUSTODY_EXECUTE_1: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3732_출처거점당사자 등록 사용자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CHAIN_OF_CUSTODY_EXECUTE_1
  ...
  return (
    <Card>
      <CardHeader title="출처·거점·당사자 등록 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CHAIN_OF_CUSTODY | Actor: SYSTEM_INTEGRATOR | Contract: #3732
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3732_출처거점당사자 등록 사용자 업무 화면Screen;
