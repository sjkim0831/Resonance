/**
 * Contract: #2783 | Route: /join/companyJoinStatusDetail
 * Process: COMPANY_ONBOARDING | Actor: APPROVER
 * Screen: 기업 심사·승인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.044411
 */
...
export const C2783_기업 심사승인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="기업 심사·승인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: APPROVER | Contract: #2783
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2783_기업 심사승인 사용자 업무 화면Screen;
