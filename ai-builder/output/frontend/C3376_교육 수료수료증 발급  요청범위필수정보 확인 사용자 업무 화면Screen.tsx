/**
 * Contract: #3376 | Route: /generated/training-certificate/training-certificate-s1
 * Process: TRAINING_CERTIFICATE | Actor: CERTIFICATE_OFFICER
 * Screen: 교육 수료·수료증 발급 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.054626
 */
...
export const C3376_교육 수료수료증 발급  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 수료·수료증 발급 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TRAINING_CERTIFICATE | Actor: CERTIFICATE_OFFICER | Contract: #3376
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3376_교육 수료수료증 발급  요청범위필수정보 확인 사용자 업무 화면Screen;
