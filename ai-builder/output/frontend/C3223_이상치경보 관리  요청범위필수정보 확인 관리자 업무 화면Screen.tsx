/**
 * Contract: #3223 | Route: /admin/generated/anomaly-alert-management/anomaly-alert-management-s1
 * Process: ANOMALY_ALERT_MANAGEMENT | Actor: DATA_ANALYST
 * Screen: 이상치·경보 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.050713
 */
...
// ANOMALY_ALERT_MANAGEMENT_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3223_이상치경보 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: ANOMALY_ALERT_MANAGEMENT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="이상치·경보 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ANOMALY_ALERT_MANAGEMENT | Actor: DATA_ANALYST | Contract: #3223
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3223_이상치경보 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
