/**
 * Contract: #3783 | Route: /admin/generated/pcr-epd-verification/pcr-epd-verification-s2
 * Process: PCR_EPD_VERIFICATION | Actor: LCA_PRACTITIONER
 * Screen: PCR 적합성·유효기간 판정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.064693
 */
...
// PCR_EPD_VERIFICATION_EXECUTE_2: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3783_PCR 적합성유효기간 판정 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: PCR_EPD_VERIFICATION_EXECUTE_2
  ...
  return (
    <Card>
      <CardHeader title="PCR 적합성·유효기간 판정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PCR_EPD_VERIFICATION | Actor: LCA_PRACTITIONER | Contract: #3783
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3783_PCR 적합성유효기간 판정 관리자 업무 화면Screen;
