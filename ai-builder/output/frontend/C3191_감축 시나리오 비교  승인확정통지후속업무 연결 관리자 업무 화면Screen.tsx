/**
 * Contract: #3191 | Route: /admin/generated/reduction-scenario/reduction-scenario-s4
 * Process: REDUCTION_SCENARIO | Actor: APPROVER
 * Screen: 감축 시나리오 비교 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049943
 */
...
// REDUCTION_SCENARIO_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3191_감축 시나리오 비교  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REDUCTION_SCENARIO_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="감축 시나리오 비교 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_SCENARIO | Actor: APPROVER | Contract: #3191
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3191_감축 시나리오 비교  승인확정통지후속업무 연결 관리자 업무 화면Screen;
