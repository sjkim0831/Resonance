 ...
 * Generated: 2026-07-25T06:45:29.043439
 */
...
export const C674_외부 데이터 연계  연계 계획계약 확정Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="외부 데이터 연계 - 연계 계획·계약 확정" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_INTEGRATION | Actor: SYSTEM_INTEGRATOR | Contract: #674
            </Typography>
            <Divider sx={ my: 2 } />
