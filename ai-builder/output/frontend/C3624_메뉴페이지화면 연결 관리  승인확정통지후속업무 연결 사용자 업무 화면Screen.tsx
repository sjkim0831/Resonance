/**
 * Contract: #3624 | Route: /generated/menu-screen-governance/menu-screen-governance-s4
 * Process: MENU_SCREEN_GOVERNANCE | Actor: APPROVER
 * Screen: 메뉴·페이지·화면 연결 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.060563
 */
...
export const C3624_메뉴페이지화면 연결 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="메뉴·페이지·화면 연결 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MENU_SCREEN_GOVERNANCE | Actor: APPROVER | Contract: #3624
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3624_메뉴페이지화면 연결 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen;
