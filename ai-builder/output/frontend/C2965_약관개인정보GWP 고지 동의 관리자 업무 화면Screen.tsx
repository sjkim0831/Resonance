/**
 * Contract: #2965 | Route: /admin/generated/member-registration/member-registration-s2
 * Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT
 * Screen: 약관·개인정보·GWP 고지 동의 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044926
 */
...
export const C2965_약관개인정보GWP 고지 동의 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="약관·개인정보·GWP 고지 동의 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT | Contract: #2965
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2965_약관개인정보GWP 고지 동의 관리자 업무 화면Screen;
