/**
 * Contract: #3283 | Route: /admin/generated/trade-proposal/trade-proposal-s4
 * Process: TRADE_PROPOSAL | Actor: APPROVER
 * Screen: 거래 제안·협상 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.052060
 */
...
// TRADE_PROPOSAL_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3283_거래 제안협상  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="거래 제안·협상 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TRADE_PROPOSAL | Actor: APPROVER | Contract: #3283
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3283_거래 제안협상  승인확정통지후속업무 연결 관리자 업무 화면Screen;
