/**
 * Contract: #304 | Route: /ccus/facility/facility-asset-registry?step=far_register
 * Process: FACILITY_ASSET_REGISTRY | Actor: FACILITY_OPERATOR
 * Screen: 설비·태그·위치 등록 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040627
 */
...
export const C304_설비태그위치 등록 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="설비·태그·위치 등록 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_ASSET_REGISTRY | Actor: FACILITY_OPERATOR | Contract: #304
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C304_설비태그위치 등록 사용자 업무 화면Screen;
