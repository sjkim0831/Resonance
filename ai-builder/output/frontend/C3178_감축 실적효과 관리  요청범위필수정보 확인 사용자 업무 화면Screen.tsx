/**
 * Contract: #3178 | Route: /generated/reduction-performance/reduction-performance-s1
 * Process: REDUCTION_PERFORMANCE | Actor: REDUCTION_MANAGER
 * Screen: 감축 실적·효과 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049661
 */
...
export const C3178_감축 실적효과 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 실적·효과 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PERFORMANCE | Actor: REDUCTION_MANAGER | Contract: #3178
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3178_감축 실적효과 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
