/**
 * Contract: #3177 | Route: /admin/generated/reduction-project-approval/reduction-project-approval-s4
 * Process: REDUCTION_PROJECT_APPROVAL | Actor: AUDITOR
 * Screen: 감축 과제 검토·승인 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049641
 */
...
// REDUCTION_PROJECT_APPROVAL_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3177_감축 과제 검토승인  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REDUCTION_PROJECT_APPROVAL_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="감축 과제 검토·승인 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PROJECT_APPROVAL | Actor: AUDITOR | Contract: #3177
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3177_감축 과제 검토승인  승인확정통지후속업무 연결 관리자 업무 화면Screen;
