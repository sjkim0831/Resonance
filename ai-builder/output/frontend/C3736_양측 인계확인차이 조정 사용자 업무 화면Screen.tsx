/**
 * Contract: #3736 | Route: /generated/chain-of-custody/chain-of-custody-s3
 * Process: CHAIN_OF_CUSTODY | Actor: VERIFIER
 * Screen: 양측 인계확인·차이 조정 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063548
 */
...
export const C3736_양측 인계확인차이 조정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="양측 인계확인·차이 조정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CHAIN_OF_CUSTODY | Actor: VERIFIER | Contract: #3736
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3736_양측 인계확인차이 조정 사용자 업무 화면Screen;
