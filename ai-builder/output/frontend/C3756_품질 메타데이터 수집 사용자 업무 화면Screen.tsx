/**
 * Contract: #3756 | Route: /generated/lca-data-quality-uncertainty/lca-data-quality-uncertainty-s1
 * Process: LCA_DATA_QUALITY_UNCERTAINTY | Actor: LCA_PRACTITIONER
 * Screen: 품질 메타데이터 수집 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064035
 */
...
export const C3756_품질 메타데이터 수집 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="품질 메타데이터 수집 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LCA_DATA_QUALITY_UNCERTAINTY | Actor: LCA_PRACTITIONER | Contract: #3756
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3756_품질 메타데이터 수집 사용자 업무 화면Screen;
