/**
 * Contract: #3307 | Route: /admin/generated/refund-management/refund-management-s2
 * Process: REFUND_MANAGEMENT | Actor: SETTLEMENT_OPERATOR
 * Screen: 환불 요청·처리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.052620
 */
...
// REFUND_MANAGEMENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3307_환불 요청처리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REFUND_MANAGEMENT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="환불 요청·처리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REFUND_MANAGEMENT | Actor: SETTLEMENT_OPERATOR | Contract: #3307
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3307_환불 요청처리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
