/**
 * Contract: #2987 | Route: /admin/member/approve
 * Process: IDENTITY_VERIFICATION | Actor: APPROVER
 * Screen: 이메일·휴대전화·본인 확인 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045460
 */
...
// IDENTITY_VERIFICATION_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2987_이메일휴대전화본인 확인  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: IDENTITY_VERIFICATION_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="이메일·휴대전화·본인 확인 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: IDENTITY_VERIFICATION | Actor: APPROVER | Contract: #2987
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2987_이메일휴대전화본인 확인  승인확정통지후속업무 연결 관리자 업무 화면Screen;
