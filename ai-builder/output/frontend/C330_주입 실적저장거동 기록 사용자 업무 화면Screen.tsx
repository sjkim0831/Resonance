/**
 * Contract: #330 | Route: /ccus/facility/co2-injection-storage-operation?step=ciso_operate
 * Process: CO2_INJECTION_STORAGE_OPERATION | Actor: STORAGE_SITE_MANAGER
 * Screen: 주입 실적·저장거동 기록 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.041732
 */
...
export const C330_주입 실적저장거동 기록 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="주입 실적·저장거동 기록 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_INJECTION_STORAGE_OPERATION | Actor: STORAGE_SITE_MANAGER | Contract: #330
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C330_주입 실적저장거동 기록 사용자 업무 화면Screen;
