...
export const C3012_비밀번호 재설정  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="비밀번호 재설정 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PASSWORD_RECOVERY | Actor: MEMBER_USER | Contract: #3012
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3012_비밀번호 재설정  업무 실행중간 결과 저장 사용자 업무 화면Screen;
