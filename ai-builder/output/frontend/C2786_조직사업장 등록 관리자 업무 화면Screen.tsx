/**
 * Contract: #2786 | Route: /admin/emission/site-management
 * Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER
 * Screen: 조직·사업장 등록 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044482
 */
...
export const C2786_조직사업장 등록 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="조직·사업장 등록 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER | Contract: #2786
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2786_조직사업장 등록 관리자 업무 화면Screen;
