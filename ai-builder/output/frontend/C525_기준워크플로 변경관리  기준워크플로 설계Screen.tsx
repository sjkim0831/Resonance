/**
 * Contract: #525 | Route: /admin/system/process-workspace?process=GOVERNANCE_CHANGE&step=GOV_DESIGN
 * Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR
 * Screen: 기준·워크플로 변경관리 - 기준·워크플로 설계
 * Generated: 2026-07-25T06:45:29.042715
 */
...
export const C525_기준워크플로 변경관리  기준워크플로 설계Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="기준·워크플로 변경관리 - 기준·워크플로 설계" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR | Contract: #525
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C525_기준워크플로 변경관리  기준워크플로 설계Screen;
