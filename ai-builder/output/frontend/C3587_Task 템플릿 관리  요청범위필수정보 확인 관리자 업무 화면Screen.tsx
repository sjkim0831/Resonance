/**
 * Contract: #3587 | Route: /admin/generated/task-template-management/task-template-management-s1
 * Process: TASK_TEMPLATE_MANAGEMENT | Actor: PLATFORM_OPERATOR
 * Screen: Task 템플릿 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.059645
 */
...
// TASK_TEMPLATE_MANAGEMENT_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3587_Task 템플릿 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: TASK_TEMPLATE_MANAGEMENT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="Task 템플릿 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TASK_TEMPLATE_MANAGEMENT | Actor: PLATFORM_OPERATOR | Contract: #3587
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3587_Task 템플릿 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
