/**
 * Contract: #309 | Route: /admin/ccus/facility/facility-asset-registry?step=far_approve
 * Process: FACILITY_ASSET_REGISTRY | Actor: HSE_MANAGER
 * Screen: 설비 기준정보 승인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.040735
 */
...
export const C309_설비 기준정보 승인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: far_approve
      const r = await fetch('/api/ccus/facility/facility-asset-registry/far_approve');
  ...
  return (
    <Card>
      <CardHeader title="설비 기준정보 승인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_ASSET_REGISTRY | Actor: HSE_MANAGER | Contract: #309
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C309_설비 기준정보 승인 관리자 업무 화면Screen;
