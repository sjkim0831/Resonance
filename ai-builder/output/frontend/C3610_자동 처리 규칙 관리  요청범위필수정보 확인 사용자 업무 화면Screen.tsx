/**
 * Contract: #3610 | Route: /generated/automation-rule-management/automation-rule-management-s1
 * Process: AUTOMATION_RULE_MANAGEMENT | Actor: PLATFORM_OPERATOR
 * Screen: 자동 처리 규칙 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.060191
 */
...
export const C3610_자동 처리 규칙 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="자동 처리 규칙 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: AUTOMATION_RULE_MANAGEMENT | Actor: PLATFORM_OPERATOR | Contract: #3610
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3610_자동 처리 규칙 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
