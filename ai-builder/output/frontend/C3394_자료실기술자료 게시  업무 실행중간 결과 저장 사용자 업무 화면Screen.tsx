/**
 * Contract: #3394 | Route: /generated/resource-publication/resource-publication-s2
 * Process: RESOURCE_PUBLICATION | Actor: CONTENT_MANAGER
 * Screen: 자료실·기술자료 게시 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.055126
 */
...
export const C3394_자료실기술자료 게시  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="자료실·기술자료 게시 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: RESOURCE_PUBLICATION | Actor: CONTENT_MANAGER | Contract: #3394
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3394_자료실기술자료 게시  업무 실행중간 결과 저장 사용자 업무 화면Screen;
