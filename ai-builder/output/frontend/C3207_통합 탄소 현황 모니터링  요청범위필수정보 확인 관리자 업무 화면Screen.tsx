/**
 * Contract: #3207 | Route: /admin/generated/integrated-monitoring/integrated-monitoring-s1
 * Process: INTEGRATED_MONITORING | Actor: DATA_ANALYST
 * Screen: 통합 탄소 현황 모니터링 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.050288
 */
...
// INTEGRATED_MONITORING_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3207_통합 탄소 현황 모니터링  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: INTEGRATED_MONITORING_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="통합 탄소 현황 모니터링 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: INTEGRATED_MONITORING | Actor: DATA_ANALYST | Contract: #3207
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3207_통합 탄소 현황 모니터링  요청범위필수정보 확인 관리자 업무 화면Screen;
