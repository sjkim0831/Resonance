/**
 * Contract: #3020 | Route: /signin/findPassword
 * Process: ACCOUNT_LOCK_RECOVERY | Actor: MEMBER_USER
 * Screen: 서버 신원검증·복구 증명 발급 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.046195
 */
...
export const C3020_서버 신원검증복구 증명 발급 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="서버 신원검증·복구 증명 발급 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ACCOUNT_LOCK_RECOVERY | Actor: MEMBER_USER | Contract: #3020
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3020_서버 신원검증복구 증명 발급 사용자 업무 화면Screen;
