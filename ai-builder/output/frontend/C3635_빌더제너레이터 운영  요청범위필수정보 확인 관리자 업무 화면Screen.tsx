/**
 * Contract: #3635 | Route: /admin/generated/builder-generator-operation/builder-generator-operation-s1
 * Process: BUILDER_GENERATOR_OPERATION | Actor: PLATFORM_OPERATOR
 * Screen: 빌더·제너레이터 운영 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.060814
 */
...
// BUILDER_GENERATOR_OPERATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3635_빌더제너레이터 운영  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: BUILDER_GENERATOR_OPERATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="빌더·제너레이터 운영 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: BUILDER_GENERATOR_OPERATION | Actor: PLATFORM_OPERATOR | Contract: #3635
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3635_빌더제너레이터 운영  요청범위필수정보 확인 관리자 업무 화면Screen;
