...
export const C680_기준워크플로 변경관리  메뉴화면APIDB 영향 분석Screen = () => {
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR | Contract: #680
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C680_기준워크플로 변경관리  메뉴화면APIDB 영향 분석Screen;
