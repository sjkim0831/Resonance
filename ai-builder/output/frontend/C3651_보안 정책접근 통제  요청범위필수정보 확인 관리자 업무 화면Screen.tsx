/**
 * Contract: #3651 | Route: /admin/generated/security-policy-operation/security-policy-operation-s1
 * Process: SECURITY_POLICY_OPERATION | Actor: PRIVACY_OFFICER
 * Screen: 보안 정책·접근 통제 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.061210
 */
...
// SECURITY_POLICY_OPERATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3651_보안 정책접근 통제  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: SECURITY_POLICY_OPERATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="보안 정책·접근 통제 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: SECURITY_POLICY_OPERATION | Actor: PRIVACY_OFFICER | Contract: #3651
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3651_보안 정책접근 통제  요청범위필수정보 확인 관리자 업무 화면Screen;
