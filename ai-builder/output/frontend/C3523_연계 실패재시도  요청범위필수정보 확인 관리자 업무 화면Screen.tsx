/**
 * Contract: #3523 | Route: /admin/generated/integration-failure-retry/integration-failure-retry-s1
 * Process: INTEGRATION_FAILURE_RETRY | Actor: SYSTEM_INTEGRATOR
 * Screen: 연계 실패·재시도 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.058154
 */
...
// INTEGRATION_FAILURE_RETRY_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3523_연계 실패재시도  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: INTEGRATION_FAILURE_RETRY_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="연계 실패·재시도 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: INTEGRATION_FAILURE_RETRY | Actor: SYSTEM_INTEGRATOR | Contract: #3523
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3523_연계 실패재시도  요청범위필수정보 확인 관리자 업무 화면Screen;
