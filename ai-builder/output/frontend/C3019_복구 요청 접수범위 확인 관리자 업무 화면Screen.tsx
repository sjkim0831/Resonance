/**
 * Contract: #3019 | Route: /admin/member/activate
 * Process: ACCOUNT_LOCK_RECOVERY | Actor: MEMBER_USER
 * Screen: 복구 요청 접수·범위 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.046176
 */
...
export const C3019_복구 요청 접수범위 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const r = await fetch('/api/public/account-recovery/requests',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(formData)});
  ...
  return (
    <Card>
      <CardHeader title="복구 요청 접수·범위 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ACCOUNT_LOCK_RECOVERY | Actor: MEMBER_USER | Contract: #3019
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3019_복구 요청 접수범위 확인 관리자 업무 화면Screen;
