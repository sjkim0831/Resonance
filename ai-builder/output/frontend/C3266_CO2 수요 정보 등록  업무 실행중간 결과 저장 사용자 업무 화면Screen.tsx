/**
 * Contract: #3266 | Route: /generated/co2-demand-registration/co2-demand-registration-s2
 * Process: CO2_DEMAND_REGISTRATION | Actor: TRADE_OPERATOR
 * Screen: CO2 수요 정보 등록 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051680
 */
...
export const C3266_CO2 수요 정보 등록  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="CO2 수요 정보 등록 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_DEMAND_REGISTRATION | Actor: TRADE_OPERATOR | Contract: #3266
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3266_CO2 수요 정보 등록  업무 실행중간 결과 저장 사용자 업무 화면Screen;
