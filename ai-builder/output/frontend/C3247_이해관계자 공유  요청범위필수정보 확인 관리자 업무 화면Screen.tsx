/**
 * Contract: #3247 | Route: /admin/generated/stakeholder-sharing/stakeholder-sharing-s1
 * Process: STAKEHOLDER_SHARING | Actor: APPROVER
 * Screen: 이해관계자 공유 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.051260
 */
...
// STAKEHOLDER_SHARING_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3247_이해관계자 공유  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: STAKEHOLDER_SHARING_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="이해관계자 공유 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: STAKEHOLDER_SHARING | Actor: APPROVER | Contract: #3247
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3247_이해관계자 공유  요청범위필수정보 확인 관리자 업무 화면Screen;
