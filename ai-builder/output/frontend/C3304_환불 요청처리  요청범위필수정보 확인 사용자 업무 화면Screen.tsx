/**
 * Contract: #3304 | Route: /generated/refund-management/refund-management-s1
 * Process: REFUND_MANAGEMENT | Actor: SETTLEMENT_OPERATOR
 * Screen: 환불 요청·처리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.052537
 */
...
export const C3304_환불 요청처리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="환불 요청·처리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REFUND_MANAGEMENT | Actor: SETTLEMENT_OPERATOR | Contract: #3304
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3304_환불 요청처리  요청범위필수정보 확인 사용자 업무 화면Screen;
