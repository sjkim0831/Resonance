/**
 * Contract: #136 | Route: /admin/emission/report-certificates
 * Process: REPORT_CERTIFICATION | Actor: APPROVER
 * Screen: 인증서 발급·다운로드·감사
 * Generated: 2026-07-25T06:45:29.040117
 */
...
export const C136_인증서 발급다운로드감사Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const r = await fetch('/home/api/report-access-history');
  ...
  return (
    <Card>
      <CardHeader title="인증서 발급·다운로드·감사" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_CERTIFICATION | Actor: APPROVER | Contract: #136
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C136_인증서 발급다운로드감사Screen;
