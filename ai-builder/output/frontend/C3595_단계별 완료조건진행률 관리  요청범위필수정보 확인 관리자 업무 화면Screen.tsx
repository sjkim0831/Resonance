/**
 * Contract: #3595 | Route: /admin/generated/process-completion-policy/process-completion-policy-s1
 * Process: PROCESS_COMPLETION_POLICY | Actor: PLATFORM_OPERATOR
 * Screen: 단계별 완료조건·진행률 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.059833
 */
...
// PROCESS_COMPLETION_POLICY_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3595_단계별 완료조건진행률 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: PROCESS_COMPLETION_POLICY_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="단계별 완료조건·진행률 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROCESS_COMPLETION_POLICY | Actor: PLATFORM_OPERATOR | Contract: #3595
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3595_단계별 완료조건진행률 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
