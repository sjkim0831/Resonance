/**
 * Contract: #3367 | Route: /admin/generated/attendance-progress/attendance-progress-s4
 * Process: ATTENDANCE_PROGRESS | Actor: APPROVER
 * Screen: 출석·진도 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.054376
 */
...
// ATTENDANCE_PROGRESS_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3367_출석진도 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: ATTENDANCE_PROGRESS_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="출석·진도 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ATTENDANCE_PROGRESS | Actor: APPROVER | Contract: #3367
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3367_출석진도 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
