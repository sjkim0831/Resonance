/**
 * Contract: #3424 | Route: /generated/newsletter-operation/newsletter-operation-s4
 * Process: NEWSLETTER_OPERATION | Actor: APPROVER
 * Screen: 뉴스레터 구독·발송 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.055871
 */
...
export const C3424_뉴스레터 구독발송  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="뉴스레터 구독·발송 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: NEWSLETTER_OPERATION | Actor: APPROVER | Contract: #3424
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3424_뉴스레터 구독발송  승인확정통지후속업무 연결 사용자 업무 화면Screen;
