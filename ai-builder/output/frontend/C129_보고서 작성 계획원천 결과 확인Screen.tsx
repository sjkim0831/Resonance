/**
 * Contract: #129 | Route: /emission/report_submit
 * Process: REPORT_CERTIFICATION | Actor: COMPANY_MANAGER
 * Screen: 보고서 작성 계획·원천 결과 확인
 * Generated: 2026-07-25T06:45:29.039964
 */
...
export const C129_보고서 작성 계획원천 결과 확인Screen = () => {
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_CERTIFICATION | Actor: COMPANY_MANAGER | Contract: #129
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C129_보고서 작성 계획원천 결과 확인Screen;
