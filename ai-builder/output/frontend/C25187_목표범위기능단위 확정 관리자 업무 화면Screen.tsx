/**
 * Contract: #25187 | Route: /admin/system/process-workspace?process=LCA_EXECUTION&step=LCA_EXECUTION_01_PLAN
 * Process: LCA_EXECUTION | Actor: LCA_PRACTITIONER
 * Screen: 목표·범위·기능단위 확정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.065137
 */
...
export const C25187_목표범위기능단위 확정 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="목표·범위·기능단위 확정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LCA_EXECUTION | Actor: LCA_PRACTITIONER | Contract: #25187
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C25187_목표범위기능단위 확정 관리자 업무 화면Screen;
