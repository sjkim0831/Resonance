/**
 * Contract: #466 | Route: /work/certificate-fee-tax-refund?step=cftr_bill
 * Process: CERTIFICATE_FEE_TAX_REFUND | Actor: SETTLEMENT_OPERATOR
 * Screen: 수수료·가상계좌·청구 생성 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.042082
 */
...
export const C466_수수료가상계좌청구 생성 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="수수료·가상계좌·청구 생성 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CERTIFICATE_FEE_TAX_REFUND | Actor: SETTLEMENT_OPERATOR | Contract: #466
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C466_수수료가상계좌청구 생성 사용자 업무 화면Screen;
