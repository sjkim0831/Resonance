...
export const C2785_조직사업장 등록 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="조직·사업장 등록 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER | Contract: #2785
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2785_조직사업장 등록 사용자 업무 화면Screen;
