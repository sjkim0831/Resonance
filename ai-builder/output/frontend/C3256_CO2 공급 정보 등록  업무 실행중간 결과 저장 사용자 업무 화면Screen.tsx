/**
 * Contract: #3256 | Route: /generated/co2-supply-registration/co2-supply-registration-s2
 * Process: CO2_SUPPLY_REGISTRATION | Actor: TRADE_OPERATOR
 * Screen: CO2 공급 정보 등록 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051450
 */
...
export const C3256_CO2 공급 정보 등록  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="CO2 공급 정보 등록 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_SUPPLY_REGISTRATION | Actor: TRADE_OPERATOR | Contract: #3256
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3256_CO2 공급 정보 등록  업무 실행중간 결과 저장 사용자 업무 화면Screen;
