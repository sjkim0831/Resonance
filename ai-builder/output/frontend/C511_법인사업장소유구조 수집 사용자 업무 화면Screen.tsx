/**
 * Contract: #511 | Route: /emission/organizational-boundary
 * Process: ORGANIZATIONAL_BOUNDARY | Actor: COMPANY_MANAGER
 * Screen: 법인·사업장·소유구조 수집 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.042346
 */
...
export const C511_법인사업장소유구조 수집 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="법인·사업장·소유구조 수집 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ORGANIZATIONAL_BOUNDARY | Actor: COMPANY_MANAGER | Contract: #511
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C511_법인사업장소유구조 수집 사용자 업무 화면Screen;
