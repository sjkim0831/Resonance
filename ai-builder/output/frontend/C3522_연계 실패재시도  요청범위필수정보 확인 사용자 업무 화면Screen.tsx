/**
 * Contract: #3522 | Route: /generated/integration-failure-retry/integration-failure-retry-s1
 * Process: INTEGRATION_FAILURE_RETRY | Actor: SYSTEM_INTEGRATOR
 * Screen: 연계 실패·재시도 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.058134
 */
...
export const C3522_연계 실패재시도  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="연계 실패·재시도 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: INTEGRATION_FAILURE_RETRY | Actor: SYSTEM_INTEGRATOR | Contract: #3522
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3522_연계 실패재시도  요청범위필수정보 확인 사용자 업무 화면Screen;
