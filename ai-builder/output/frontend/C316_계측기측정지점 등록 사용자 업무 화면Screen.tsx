/**
 * Contract: #316 | Route: /ccus/facility/meter-calibration-management?step=mcm_register
 * Process: METER_CALIBRATION_MANAGEMENT | Actor: INSTRUMENT_ENGINEER
 * Screen: 계측기·측정지점 등록 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040917
 */
...
export const C316_계측기측정지점 등록 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="계측기·측정지점 등록 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: METER_CALIBRATION_MANAGEMENT | Actor: INSTRUMENT_ENGINEER | Contract: #316
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C316_계측기측정지점 등록 사용자 업무 화면Screen;
