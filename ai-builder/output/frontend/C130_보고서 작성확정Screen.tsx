/**
 * Contract: #130 | Route: /emission/report_submit
 * Process: REPORT_CERTIFICATION | Actor: SITE_DATA_OWNER
 * Screen: 보고서 작성·확정
 * Generated: 2026-07-25T06:45:29.039987
 */
...
export const C130_보고서 작성확정Screen = () => {
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_CERTIFICATION | Actor: SITE_DATA_OWNER | Contract: #130
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C130_보고서 작성확정Screen;
