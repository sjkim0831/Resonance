/**
 * Contract: #3775 | Route: /admin/generated/measurement-data-quality/measurement-data-quality-s2
 * Process: MEASUREMENT_DATA_QUALITY | Actor: SITE_DATA_OWNER
 * Screen: 교정·가동상태 검증 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.064478
 */
...
// MEASUREMENT_DATA_QUALITY_EXECUTE_2: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3775_교정가동상태 검증 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: MEASUREMENT_DATA_QUALITY_EXECUTE_2
  ...
  return (
    <Card>
      <CardHeader title="교정·가동상태 검증 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEASUREMENT_DATA_QUALITY | Actor: SITE_DATA_OWNER | Contract: #3775
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3775_교정가동상태 검증 관리자 업무 화면Screen;
