/**
 * Contract: #544 | Route: /admin/system/process-workspace?process=REDUCTION_EXECUTION&step=REDUCTION_EXECUTION_02_WORK
 * Process: REDUCTION_EXECUTION | Actor: REDUCTION_MANAGER
 * Screen: 감축 과제 수행 - 자료 입력·업무 수행
 * Generated: 2026-07-25T06:45:29.043131
 */
...
export const C544_감축 과제 수행  자료 입력업무 수행Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 과제 수행 - 자료 입력·업무 수행" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_EXECUTION | Actor: REDUCTION_MANAGER | Contract: #544
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C544_감축 과제 수행  자료 입력업무 수행Screen;
