/**
 * Contract: #3202 | Route: /generated/reduction-reporting/reduction-reporting-s2
 * Process: REDUCTION_REPORTING | Actor: REDUCTION_MANAGER
 * Screen: 감축 성과 보고 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.050181
 */
...
export const C3202_감축 성과 보고  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 성과 보고 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_REPORTING | Actor: REDUCTION_MANAGER | Contract: #3202
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3202_감축 성과 보고  업무 실행중간 결과 저장 사용자 업무 화면Screen;
