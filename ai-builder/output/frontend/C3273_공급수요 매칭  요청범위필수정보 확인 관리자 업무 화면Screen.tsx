/**
 * Contract: #3273 | Route: /admin/generated/supply-demand-matching/supply-demand-matching-s1
 * Process: SUPPLY_DEMAND_MATCHING | Actor: TRADE_OPERATOR
 * Screen: 공급·수요 매칭 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.051856
 */
...
// SUPPLY_DEMAND_MATCHING_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3273_공급수요 매칭  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: SUPPLY_DEMAND_MATCHING_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="공급·수요 매칭 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: SUPPLY_DEMAND_MATCHING | Actor: TRADE_OPERATOR | Contract: #3273
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3273_공급수요 매칭  요청범위필수정보 확인 관리자 업무 화면Screen;
