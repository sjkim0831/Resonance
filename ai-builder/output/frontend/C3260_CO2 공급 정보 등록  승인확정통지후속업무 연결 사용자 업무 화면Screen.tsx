/**
 * Contract: #3260 | Route: /generated/co2-supply-registration/co2-supply-registration-s4
 * Process: CO2_SUPPLY_REGISTRATION | Actor: APPROVER
 * Screen: CO2 공급 정보 등록 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051531
 */
...
export const C3260_CO2 공급 정보 등록  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="CO2 공급 정보 등록 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_SUPPLY_REGISTRATION | Actor: APPROVER | Contract: #3260
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3260_CO2 공급 정보 등록  승인확정통지후속업무 연결 사용자 업무 화면Screen;
