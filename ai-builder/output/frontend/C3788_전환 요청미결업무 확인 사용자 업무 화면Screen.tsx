/**
 * Contract: #3788 | Route: /generated/project-lifecycle-control/project-lifecycle-control-s1
 * Process: PROJECT_LIFECYCLE_CONTROL | Actor: COMPANY_MANAGER
 * Screen: 전환 요청·미결업무 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064797
 */
...
export const C3788_전환 요청미결업무 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="전환 요청·미결업무 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROJECT_LIFECYCLE_CONTROL | Actor: COMPANY_MANAGER | Contract: #3788
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3788_전환 요청미결업무 확인 사용자 업무 화면Screen;
