/**
 * Contract: #3616 | Route: /generated/automation-rule-management/automation-rule-management-s4
 * Process: AUTOMATION_RULE_MANAGEMENT | Actor: APPROVER
 * Screen: 자동 처리 규칙 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.060334
 */
...
export const C3616_자동 처리 규칙 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="자동 처리 규칙 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: AUTOMATION_RULE_MANAGEMENT | Actor: APPROVER | Contract: #3616
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3616_자동 처리 규칙 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen;
