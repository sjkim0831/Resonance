/**
 * Contract: #2977 | Route: /admin/system/consent-history
 * Process: TERMS_CONSENT | Actor: APPROVER
 * Screen: 약관·개인정보·GWP 고지 동의 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045221
 */
...
// TERMS_CONSENT_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2977_약관개인정보GWP 고지 동의  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="약관·개인정보·GWP 고지 동의 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TERMS_CONSENT | Actor: APPROVER | Contract: #2977
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2977_약관개인정보GWP 고지 동의  승인확정통지후속업무 연결 관리자 업무 화면Screen;
