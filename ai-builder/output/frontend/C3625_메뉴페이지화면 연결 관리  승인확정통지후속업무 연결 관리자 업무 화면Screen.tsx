/**
 * Contract: #3625 | Route: /admin/generated/menu-screen-governance/menu-screen-governance-s4
 * Process: MENU_SCREEN_GOVERNANCE | Actor: APPROVER
 * Screen: 메뉴·페이지·화면 연결 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.060584
 */
...
// MENU_SCREEN_GOVERNANCE_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3625_메뉴페이지화면 연결 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: MENU_SCREEN_GOVERNANCE_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="메뉴·페이지·화면 연결 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MENU_SCREEN_GOVERNANCE | Actor: APPROVER | Contract: #3625
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3625_메뉴페이지화면 연결 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
