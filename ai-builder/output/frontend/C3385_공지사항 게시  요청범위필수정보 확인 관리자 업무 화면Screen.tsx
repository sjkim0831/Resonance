/**
 * Contract: #3385 | Route: /admin/generated/notice-publication/notice-publication-s1
 * Process: NOTICE_PUBLICATION | Actor: CONTENT_MANAGER
 * Screen: 공지사항 게시 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.054889
 */
...
// NOTICE_PUBLICATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3385_공지사항 게시  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: NOTICE_PUBLICATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="공지사항 게시 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: NOTICE_PUBLICATION | Actor: CONTENT_MANAGER | Contract: #3385
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3385_공지사항 게시  요청범위필수정보 확인 관리자 업무 화면Screen;
