/**
 * Contract: #2784 | Route: /admin/member/company-approve
 * Process: COMPANY_ONBOARDING | Actor: APPROVER
 * Screen: 기업 심사·승인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044441
 */
...
// APPROVE_COMPANY: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2784_기업 심사승인 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="기업 심사·승인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: APPROVER | Contract: #2784
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2784_기업 심사승인 관리자 업무 화면Screen;
