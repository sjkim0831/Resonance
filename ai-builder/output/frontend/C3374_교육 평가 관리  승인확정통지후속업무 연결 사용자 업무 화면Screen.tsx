/**
 * Contract: #3374 | Route: /generated/education-assessment/education-assessment-s4
 * Process: EDUCATION_ASSESSMENT | Actor: APPROVER
 * Screen: 교육 평가 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.054570
 */
...
export const C3374_교육 평가 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 평가 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_ASSESSMENT | Actor: APPROVER | Contract: #3374
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3374_교육 평가 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen;
