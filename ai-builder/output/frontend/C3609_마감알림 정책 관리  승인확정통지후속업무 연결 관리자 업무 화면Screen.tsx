/**
 * Contract: #3609 | Route: /admin/generated/deadline-notification-policy/deadline-notification-policy-s4
 * Process: DEADLINE_NOTIFICATION_POLICY | Actor: APPROVER
 * Screen: 마감·알림 정책 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.060168
 */
...
// DEADLINE_NOTIFICATION_POLICY_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3609_마감알림 정책 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DEADLINE_NOTIFICATION_POLICY_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="마감·알림 정책 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DEADLINE_NOTIFICATION_POLICY | Actor: APPROVER | Contract: #3609
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3609_마감알림 정책 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
