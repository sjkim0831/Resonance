/**
 * Contract: #2789 | Route: /emission/project/create
 * Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER
 * Screen: 프로젝트 착수 준비 진단 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.044564
 */
...
export const C2789_프로젝트 착수 준비 진단 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="프로젝트 착수 준비 진단 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER | Contract: #2789
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2789_프로젝트 착수 준비 진단 사용자 업무 화면Screen;
