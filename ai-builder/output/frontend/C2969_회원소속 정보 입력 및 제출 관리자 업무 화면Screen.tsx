/**
 * Contract: #2969 | Route: /admin/generated/member-registration/member-registration-s4
 * Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT
 * Screen: 회원·소속 정보 입력 및 제출 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045028
 */
...
// SUBMIT_MEMBER_APPLICATION: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2969_회원소속 정보 입력 및 제출 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: SUBMIT_MEMBER_APPLICATION
  ...
  return (
    <Card>
      <CardHeader title="회원·소속 정보 입력 및 제출 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT | Contract: #2969
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2969_회원소속 정보 입력 및 제출 관리자 업무 화면Screen;
