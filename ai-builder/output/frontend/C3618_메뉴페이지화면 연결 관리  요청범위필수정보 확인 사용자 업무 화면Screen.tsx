/**
 * Contract: #3618 | Route: /generated/menu-screen-governance/menu-screen-governance-s1
 * Process: MENU_SCREEN_GOVERNANCE | Actor: PLATFORM_OPERATOR
 * Screen: 메뉴·페이지·화면 연결 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.060388
 */
...
export const C3618_메뉴페이지화면 연결 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="메뉴·페이지·화면 연결 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MENU_SCREEN_GOVERNANCE | Actor: PLATFORM_OPERATOR | Contract: #3618
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3618_메뉴페이지화면 연결 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
