/**
 * Contract: #3727 | Route: /admin/generated/ccus-lifecycle-mrv/ccus-lifecycle-mrv-s2
 * Process: CCUS_LIFECYCLE_MRV | Actor: CALCULATOR
 * Screen: 포집·수송·저장 데이터 통합 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.063336
 */
...
// CCUS_LIFECYCLE_MRV_EXECUTE_2: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3727_포집수송저장 데이터 통합 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CCUS_LIFECYCLE_MRV_EXECUTE_2
  ...
  return (
    <Card>
      <CardHeader title="포집·수송·저장 데이터 통합 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CCUS_LIFECYCLE_MRV | Actor: CALCULATOR | Contract: #3727
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3727_포집수송저장 데이터 통합 관리자 업무 화면Screen;
