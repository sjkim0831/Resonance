/**
 * Contract: #3556 | Route: /generated/outlier-rule-management/outlier-rule-management-s2
 * Process: OUTLIER_RULE_MANAGEMENT | Actor: DATA_ANALYST
 * Screen: 이상치 규칙 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.058896
 */
...
export const C3556_이상치 규칙 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="이상치 규칙 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: OUTLIER_RULE_MANAGEMENT | Actor: DATA_ANALYST | Contract: #3556
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3556_이상치 규칙 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
