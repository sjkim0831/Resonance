/**
 * Contract: #496 | Route: /work/legal-notification-delivery?step=lnd_compose
 * Process: LEGAL_NOTIFICATION_DELIVERY | Actor: PLATFORM_OPERATOR
 * Screen: 통지 사건·템플릿·대상 확정 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.042283
 */
...
export const C496_통지 사건템플릿대상 확정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="통지 사건·템플릿·대상 확정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LEGAL_NOTIFICATION_DELIVERY | Actor: PLATFORM_OPERATOR | Contract: #496
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C496_통지 사건템플릿대상 확정 사용자 업무 화면Screen;
