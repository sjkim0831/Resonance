/**
 * Contract: #3435 | Route: /admin/generated/report-generation/report-generation-s1
 * Process: REPORT_GENERATION | Actor: CALCULATOR
 * Screen: 보고서 생성·미리보기 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.056139
 */
...
// REPORT_GENERATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3435_보고서 생성미리보기  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REPORT_GENERATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="보고서 생성·미리보기 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_GENERATION | Actor: CALCULATOR | Contract: #3435
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3435_보고서 생성미리보기  요청범위필수정보 확인 관리자 업무 화면Screen;
