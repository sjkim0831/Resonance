/**
 * Contract: #3240 | Route: /generated/analysis-export/analysis-export-s1
 * Process: ANALYSIS_EXPORT | Actor: DATA_ANALYST
 * Screen: 분석 데이터 내보내기 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051099
 */
...
export const C3240_분석 데이터 내보내기  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="분석 데이터 내보내기 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ANALYSIS_EXPORT | Actor: DATA_ANALYST | Contract: #3240
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3240_분석 데이터 내보내기  요청범위필수정보 확인 사용자 업무 화면Screen;
