/**
 * Contract: #3190 | Route: /generated/reduction-scenario/reduction-scenario-s4
 * Process: REDUCTION_SCENARIO | Actor: APPROVER
 * Screen: 감축 시나리오 비교 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049923
 */
...
export const C3190_감축 시나리오 비교  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 시나리오 비교 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_SCENARIO | Actor: APPROVER | Contract: #3190
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3190_감축 시나리오 비교  승인확정통지후속업무 연결 사용자 업무 화면Screen;
