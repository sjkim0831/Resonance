/**
 * Contract: #337 | Route: /admin/ccus/facility/facility-emergency-response?step=fer_control
 * Process: FACILITY_EMERGENCY_RESPONSE | Actor: HSE_MANAGER
 * Screen: 통제·대피·법정보고 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.041888
 */
...
export const C337_통제대피법정보고 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: fer_control
      const r = await fetch('/api/ccus/facility/facility-emergency-response/fer_control');
  ...
  return (
    <Card>
      <CardHeader title="통제·대피·법정보고 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_EMERGENCY_RESPONSE | Actor: HSE_MANAGER | Contract: #337
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C337_통제대피법정보고 관리자 업무 화면Screen;
