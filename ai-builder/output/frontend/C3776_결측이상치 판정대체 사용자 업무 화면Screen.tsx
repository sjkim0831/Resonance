/**
 * Contract: #3776 | Route: /generated/measurement-data-quality/measurement-data-quality-s3
 * Process: MEASUREMENT_DATA_QUALITY | Actor: VERIFIER
 * Screen: 결측·이상치 판정·대체 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064497
 */
...
export const C3776_결측이상치 판정대체 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="결측·이상치 판정·대체 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEASUREMENT_DATA_QUALITY | Actor: VERIFIER | Contract: #3776
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3776_결측이상치 판정대체 사용자 업무 화면Screen;
