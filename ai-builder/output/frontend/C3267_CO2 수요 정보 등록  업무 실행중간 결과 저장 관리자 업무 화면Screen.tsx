/**
 * Contract: #3267 | Route: /admin/generated/co2-demand-registration/co2-demand-registration-s2
 * Process: CO2_DEMAND_REGISTRATION | Actor: TRADE_OPERATOR
 * Screen: CO2 수요 정보 등록 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.051701
 */
...
// CO2_DEMAND_REGISTRATION_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3267_CO2 수요 정보 등록  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CO2_DEMAND_REGISTRATION_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="CO2 수요 정보 등록 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_DEMAND_REGISTRATION | Actor: TRADE_OPERATOR | Contract: #3267
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3267_CO2 수요 정보 등록  업무 실행중간 결과 저장 관리자 업무 화면Screen;
