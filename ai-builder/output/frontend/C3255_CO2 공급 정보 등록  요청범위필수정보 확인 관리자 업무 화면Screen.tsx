/**
 * Contract: #3255 | Route: /admin/generated/co2-supply-registration/co2-supply-registration-s1
 * Process: CO2_SUPPLY_REGISTRATION | Actor: TRADE_OPERATOR
 * Screen: CO2 공급 정보 등록 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.051430
 */
...
// CO2_SUPPLY_REGISTRATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3255_CO2 공급 정보 등록  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CO2_SUPPLY_REGISTRATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="CO2 공급 정보 등록 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_SUPPLY_REGISTRATION | Actor: TRADE_OPERATOR | Contract: #3255
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3255_CO2 공급 정보 등록  요청범위필수정보 확인 관리자 업무 화면Screen;
