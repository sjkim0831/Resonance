/**
 * Contract: #329 | Route: /admin/ccus/facility/co2-injection-storage-operation?step=ciso_plan
 * Process: CO2_INJECTION_STORAGE_OPERATION | Actor: STORAGE_SITE_MANAGER
 * Screen: 주입계획·허용한계 설정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.041347
 */
...
export const C329_주입계획허용한계 설정 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: ciso_plan
      const r = await fetch('/api/ccus/facility/co2-injection-storage-operation/ciso_plan');
  ...
  return (
    <Card>
      <CardHeader title="주입계획·허용한계 설정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_INJECTION_STORAGE_OPERATION | Actor: STORAGE_SITE_MANAGER | Contract: #329
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C329_주입계획허용한계 설정 관리자 업무 화면Screen;
