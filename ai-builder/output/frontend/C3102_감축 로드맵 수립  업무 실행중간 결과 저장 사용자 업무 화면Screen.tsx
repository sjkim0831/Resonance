/**
 * Contract: #3102 | Route: /generated/reduction-roadmap/reduction-roadmap-s2
 * Process: REDUCTION_ROADMAP | Actor: REDUCTION_MANAGER
 * Screen: 감축 로드맵 수립 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.047964
 */
...
export const C3102_감축 로드맵 수립  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 로드맵 수립 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_ROADMAP | Actor: REDUCTION_MANAGER | Contract: #3102
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3102_감축 로드맵 수립  업무 실행중간 결과 저장 사용자 업무 화면Screen;
