/**
 * Contract: #3306 | Route: /generated/refund-management/refund-management-s2
 * Process: REFUND_MANAGEMENT | Actor: SETTLEMENT_OPERATOR
 * Screen: 환불 요청·처리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.052584
 */
...
export const C3306_환불 요청처리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="환불 요청·처리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REFUND_MANAGEMENT | Actor: SETTLEMENT_OPERATOR | Contract: #3306
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3306_환불 요청처리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
