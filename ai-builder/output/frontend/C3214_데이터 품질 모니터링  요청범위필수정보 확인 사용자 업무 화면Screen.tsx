/**
 * Contract: #3214 | Route: /generated/data-quality-monitoring/data-quality-monitoring-s1
 * Process: DATA_QUALITY_MONITORING | Actor: VERIFIER
 * Screen: 데이터 품질 모니터링 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.050437
 */
...
export const C3214_데이터 품질 모니터링  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="데이터 품질 모니터링 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_QUALITY_MONITORING | Actor: VERIFIER | Contract: #3214
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3214_데이터 품질 모니터링  요청범위필수정보 확인 사용자 업무 화면Screen;
