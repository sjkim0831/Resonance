/**
 * Contract: #3051 | Route: /admin/member/company_list
 * Process: COMPANY_REGISTRATION_APPROVAL | Actor: COMPANY_ADMIN
 * Screen: 기업 등록·승인 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.046870
 */
...
// COMPANY_REGISTRATION_APPROVAL_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3051_기업 등록승인  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: COMPANY_REGISTRATION_APPROVAL_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="기업 등록·승인 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_REGISTRATION_APPROVAL | Actor: COMPANY_ADMIN | Contract: #3051
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3051_기업 등록승인  요청범위필수정보 확인 관리자 업무 화면Screen;
