/**
 * Contract: #3560 | Route: /generated/outlier-rule-management/outlier-rule-management-s4
 * Process: OUTLIER_RULE_MANAGEMENT | Actor: APPROVER
 * Screen: 이상치 규칙 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.058992
 */
...
export const C3560_이상치 규칙 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="이상치 규칙 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: OUTLIER_RULE_MANAGEMENT | Actor: APPROVER | Contract: #3560
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3560_이상치 규칙 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen;
