/**
 * Contract: #3377 | Route: /admin/generated/training-certificate/training-certificate-s1
 * Process: TRAINING_CERTIFICATE | Actor: CERTIFICATE_OFFICER
 * Screen: 교육 수료·수료증 발급 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.054650
 */
...
// TRAINING_CERTIFICATE_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3377_교육 수료수료증 발급  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: TRAINING_CERTIFICATE_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="교육 수료·수료증 발급 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TRAINING_CERTIFICATE | Actor: CERTIFICATE_OFFICER | Contract: #3377
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3377_교육 수료수료증 발급  요청범위필수정보 확인 관리자 업무 화면Screen;
