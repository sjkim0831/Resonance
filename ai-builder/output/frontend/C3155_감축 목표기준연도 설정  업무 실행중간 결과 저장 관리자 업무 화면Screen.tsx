/**
 * Contract: #3155 | Route: /admin/generated/reduction-target-planning/reduction-target-planning-s2
 * Process: REDUCTION_TARGET_PLANNING | Actor: REDUCTION_MANAGER
 * Screen: 감축 목표·기준연도 설정 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049164
 */
...
// REDUCTION_TARGET_PLANNING_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3155_감축 목표기준연도 설정  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REDUCTION_TARGET_PLANNING_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="감축 목표·기준연도 설정 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_TARGET_PLANNING | Actor: REDUCTION_MANAGER | Contract: #3155
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3155_감축 목표기준연도 설정  업무 실행중간 결과 저장 관리자 업무 화면Screen;
