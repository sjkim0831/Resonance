/**
 * Contract: #3098 | Route: /generated/faq-management/faq-management-s1
 * Process: FAQ_MANAGEMENT | Actor: CONTENT_MANAGER
 * Screen: FAQ 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.047877
 */
...
export const C3098_FAQ 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="FAQ 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FAQ_MANAGEMENT | Actor: CONTENT_MANAGER | Contract: #3098
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3098_FAQ 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
