/**
 * Contract: #3611 | Route: /admin/generated/automation-rule-management/automation-rule-management-s1
 * Process: AUTOMATION_RULE_MANAGEMENT | Actor: PLATFORM_OPERATOR
 * Screen: 자동 처리 규칙 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.060213
 */
...
// AUTOMATION_RULE_MANAGEMENT_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3611_자동 처리 규칙 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: AUTOMATION_RULE_MANAGEMENT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="자동 처리 규칙 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: AUTOMATION_RULE_MANAGEMENT | Actor: PLATFORM_OPERATOR | Contract: #3611
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3611_자동 처리 규칙 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
