/**
 * Contract: #2974 | Route: /join/step2
 * Process: TERMS_CONSENT | Actor: VERIFIER
 * Screen: 약관·개인정보·GWP 고지 동의 - 독립 검토·보완·권한 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.045152
 */
...
export const C2974_약관개인정보GWP 고지 동의  독립 검토보완권한 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="약관·개인정보·GWP 고지 동의 - 독립 검토·보완·권한 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TERMS_CONSENT | Actor: VERIFIER | Contract: #2974
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2974_약관개인정보GWP 고지 동의  독립 검토보완권한 검증 사용자 업무 화면Screen;
