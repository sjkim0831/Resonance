/**
 * Contract: #3772 | Route: /generated/measurement-data-quality/measurement-data-quality-s1
 * Process: MEASUREMENT_DATA_QUALITY | Actor: SITE_DATA_OWNER
 * Screen: 측정 지점·기기 등록 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064416
 */
...
export const C3772_측정 지점기기 등록 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="측정 지점·기기 등록 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEASUREMENT_DATA_QUALITY | Actor: SITE_DATA_OWNER | Contract: #3772
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3772_측정 지점기기 등록 사용자 업무 화면Screen;
