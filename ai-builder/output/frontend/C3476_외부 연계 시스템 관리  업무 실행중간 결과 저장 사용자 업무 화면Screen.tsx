/**
 * Contract: #3476 | Route: /generated/external-system-registry/external-system-registry-s2
 * Process: EXTERNAL_SYSTEM_REGISTRY | Actor: SYSTEM_INTEGRATOR
 * Screen: 외부 연계 시스템 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.057090
 */
...
export const C3476_외부 연계 시스템 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="외부 연계 시스템 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SYSTEM_REGISTRY | Actor: SYSTEM_INTEGRATOR | Contract: #3476
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3476_외부 연계 시스템 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
