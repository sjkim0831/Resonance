/**
 * Contract: #3795 | Route: /admin/generated/project-lifecycle-control/project-lifecycle-control-s4
 * Process: PROJECT_LIFECYCLE_CONTROL | Actor: APPROVER
 * Screen: 종료·보관·재개·취소 실행 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.064942
 */
...
export const C3795_종료보관재개취소 실행 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: PROJECT_LIFECYCLE_CONTROL_EXECUTE_4
  ...
  return (
    <Card>
      <CardHeader title="종료·보관·재개·취소 실행 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROJECT_LIFECYCLE_CONTROL | Actor: APPROVER | Contract: #3795
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3795_종료보관재개취소 실행 관리자 업무 화면Screen;
