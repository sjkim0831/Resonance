/**
 * Contract: #3771 | Route: /admin/generated/leakage-incident-response/leakage-incident-response-s4
 * Process: LEAKAGE_INCIDENT_RESPONSE | Actor: COMPANY_MANAGER
 * Screen: 원인분석·시정·재가동 승인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.064397
 */
...
// LEAKAGE_INCIDENT_RESPONSE_EXECUTE_4: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3771_원인분석시정재가동 승인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: LEAKAGE_INCIDENT_RESPONSE_EXECUTE_4
  ...
  return (
    <Card>
      <CardHeader title="원인분석·시정·재가동 승인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LEAKAGE_INCIDENT_RESPONSE | Actor: COMPANY_MANAGER | Contract: #3771
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3771_원인분석시정재가동 승인 관리자 업무 화면Screen;
