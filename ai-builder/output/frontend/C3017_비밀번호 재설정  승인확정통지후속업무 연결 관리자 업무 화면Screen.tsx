/**
 * Contract: #3017 | Route: /admin/member/login_history
 * Process: PASSWORD_RECOVERY | Actor: APPROVER
 * Screen: 비밀번호 재설정 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.046134
 */
...
// PASSWORD_RECOVERY_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3017_비밀번호 재설정  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: PASSWORD_RECOVERY_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="비밀번호 재설정 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PASSWORD_RECOVERY | Actor: APPROVER | Contract: #3017
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3017_비밀번호 재설정  승인확정통지후속업무 연결 관리자 업무 화면Screen;
