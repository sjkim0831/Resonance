/**
 * Contract: #3244 | Route: /generated/analysis-export/analysis-export-s3
 * Process: ANALYSIS_EXPORT | Actor: VERIFIER
 * Screen: 분석 데이터 내보내기 - 독립 검토·보완·권한 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051190
 */
...
export const C3244_분석 데이터 내보내기  독립 검토보완권한 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="분석 데이터 내보내기 - 독립 검토·보완·권한 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ANALYSIS_EXPORT | Actor: VERIFIER | Contract: #3244
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3244_분석 데이터 내보내기  독립 검토보완권한 검증 사용자 업무 화면Screen;
