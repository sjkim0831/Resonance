/**
 * Contract: #322 | Route: /ccus/facility/preventive-maintenance?step=pm_plan
 * Process: PREVENTIVE_MAINTENANCE | Actor: MAINTENANCE_ENGINEER
 * Screen: 위험기반 정비계획 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.041128
 */
...
export const C322_위험기반 정비계획 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="위험기반 정비계획 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PREVENTIVE_MAINTENANCE | Actor: MAINTENANCE_ENGINEER | Contract: #322
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C322_위험기반 정비계획 사용자 업무 화면Screen;
