/**
 * Contract: #3773 | Route: /admin/generated/measurement-data-quality/measurement-data-quality-s1
 * Process: MEASUREMENT_DATA_QUALITY | Actor: SITE_DATA_OWNER
 * Screen: 측정 지점·기기 등록 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.064437
 */
...
// MEASUREMENT_DATA_QUALITY_EXECUTE_1: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3773_측정 지점기기 등록 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: MEASUREMENT_DATA_QUALITY_EXECUTE_1
  ...
  return (
    <Card>
      <CardHeader title="측정 지점·기기 등록 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEASUREMENT_DATA_QUALITY | Actor: SITE_DATA_OWNER | Contract: #3773
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3773_측정 지점기기 등록 관리자 업무 화면Screen;
