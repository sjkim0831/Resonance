/**
 * Contract: #3589 | Route: /admin/generated/task-template-management/task-template-management-s2
 * Process: TASK_TEMPLATE_MANAGEMENT | Actor: PLATFORM_OPERATOR
 * Screen: Task 템플릿 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.059697
 */
...
// TASK_TEMPLATE_MANAGEMENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3589_Task 템플릿 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: TASK_TEMPLATE_MANAGEMENT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="Task 템플릿 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TASK_TEMPLATE_MANAGEMENT | Actor: PLATFORM_OPERATOR | Contract: #3589
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3589_Task 템플릿 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
