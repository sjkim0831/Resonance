/**
 * Contract: #3270 | Route: /generated/co2-demand-registration/co2-demand-registration-s4
 * Process: CO2_DEMAND_REGISTRATION | Actor: APPROVER
 * Screen: CO2 수요 정보 등록 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051779
 */
...
export const C3270_CO2 수요 정보 등록  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="CO2 수요 정보 등록 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_DEMAND_REGISTRATION | Actor: APPROVER | Contract: #3270
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3270_CO2 수요 정보 등록  승인확정통지후속업무 연결 사용자 업무 화면Screen;
