/**
 * Contract: #3418 | Route: /generated/newsletter-operation/newsletter-operation-s1
 * Process: NEWSLETTER_OPERATION | Actor: CONTENT_MANAGER
 * Screen: 뉴스레터 구독·발송 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.055742
 */
...
export const C3418_뉴스레터 구독발송  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="뉴스레터 구독·발송 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: NEWSLETTER_OPERATION | Actor: CONTENT_MANAGER | Contract: #3418
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3418_뉴스레터 구독발송  요청범위필수정보 확인 사용자 업무 화면Screen;
