/**
 * Contract: #313 | Route: /admin/ccus/facility/facility-operation-monitoring?step=fom_operate
 * Process: FACILITY_OPERATION_MONITORING | Actor: FACILITY_OPERATOR
 * Screen: 운전·알람·조치 기록 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.040852
 */
...
export const C313_운전알람조치 기록 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: fom_operate
      const r = await fetch('/api/ccus/facility/facility-operation-monitoring/fom_operate');
  ...
  return (
    <Card>
      <CardHeader title="운전·알람·조치 기록 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_OPERATION_MONITORING | Actor: FACILITY_OPERATOR | Contract: #313
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C313_운전알람조치 기록 관리자 업무 화면Screen;
