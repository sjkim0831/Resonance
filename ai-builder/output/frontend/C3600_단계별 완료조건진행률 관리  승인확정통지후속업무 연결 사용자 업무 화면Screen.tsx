/**
 * Contract: #3600 | Route: /generated/process-completion-policy/process-completion-policy-s4
 * Process: PROCESS_COMPLETION_POLICY | Actor: APPROVER
 * Screen: 단계별 완료조건·진행률 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.059945
 */
...
export const C3600_단계별 완료조건진행률 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="단계별 완료조건·진행률 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROCESS_COMPLETION_POLICY | Actor: APPROVER | Contract: #3600
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3600_단계별 완료조건진행률 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen;
