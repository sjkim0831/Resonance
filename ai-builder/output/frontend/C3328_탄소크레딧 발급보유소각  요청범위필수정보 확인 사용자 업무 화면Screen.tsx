/**
 * Contract: #3328 | Route: /generated/carbon-credit-management/carbon-credit-management-s1
 * Process: CARBON_CREDIT_MANAGEMENT | Actor: CERTIFICATE_OFFICER
 * Screen: 탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053092
 */
...
export const C3328_탄소크레딧 발급보유소각  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CARBON_CREDIT_MANAGEMENT | Actor: CERTIFICATE_OFFICER | Contract: #3328
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3328_탄소크레딧 발급보유소각  요청범위필수정보 확인 사용자 업무 화면Screen;
