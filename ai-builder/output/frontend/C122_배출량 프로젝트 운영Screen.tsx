/**
 * Contract: #122 | Route: /admin/emission/project-operations
 * Process: EMISSION_CALCULATION | Actor: COMPANY_MANAGER
 * Screen: 배출량 프로젝트 운영
 * Generated: 2026-07-25T06:45:29.039764
 */
...
export const C122_배출량 프로젝트 운영Screen = () => {
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_CALCULATION | Actor: COMPANY_MANAGER | Contract: #122
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C122_배출량 프로젝트 운영Screen;
