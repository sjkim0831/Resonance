/**
 * Contract: #3596 | Route: /generated/process-completion-policy/process-completion-policy-s2
 * Process: PROCESS_COMPLETION_POLICY | Actor: PLATFORM_OPERATOR
 * Screen: 단계별 완료조건·진행률 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.059855
 */
...
export const C3596_단계별 완료조건진행률 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="단계별 완료조건·진행률 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROCESS_COMPLETION_POLICY | Actor: PLATFORM_OPERATOR | Contract: #3596
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3596_단계별 완료조건진행률 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
