/**
 * Contract: #497 | Route: /admin/work/legal-notification-delivery?step=lnd_compose
 * Process: LEGAL_NOTIFICATION_DELIVERY | Actor: PLATFORM_OPERATOR
 * Screen: 통지 사건·템플릿·대상 확정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.042304
 */
...
export const C497_통지 사건템플릿대상 확정 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: lnd_compose
      const r = await fetch('/api/work/legal-notification-delivery/lnd_compose');
  ...
  return (
    <Card>
      <CardHeader title="통지 사건·템플릿·대상 확정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LEGAL_NOTIFICATION_DELIVERY | Actor: PLATFORM_OPERATOR | Contract: #497
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C497_통지 사건템플릿대상 확정 관리자 업무 화면Screen;
