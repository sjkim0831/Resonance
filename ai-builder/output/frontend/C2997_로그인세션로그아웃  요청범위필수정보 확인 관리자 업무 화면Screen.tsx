/**
 * Contract: #2997 | Route: /admin/member/login_history
 * Process: LOGIN_AUTHENTICATION | Actor: MEMBER_USER
 * Screen: 로그인·세션·로그아웃 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045687
 */
...
// LOGIN_AUTHENTICATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2997_로그인세션로그아웃  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: LOGIN_AUTHENTICATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="로그인·세션·로그아웃 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LOGIN_AUTHENTICATION | Actor: MEMBER_USER | Contract: #2997
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2997_로그인세션로그아웃  요청범위필수정보 확인 관리자 업무 화면Screen;
