/**
 * Contract: #2995 | Route: /admin/member/list
 * Process: MEMBER_APPROVAL | Actor: APPROVER
 * Screen: 가입 검토·승인·반려 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045643
 */
...
// MEMBER_APPROVAL_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2995_가입 검토승인반려  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="가입 검토·승인·반려 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_APPROVAL | Actor: APPROVER | Contract: #2995
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2995_가입 검토승인반려  승인확정통지후속업무 연결 관리자 업무 화면Screen;
