/**
 * Contract: #3124 | Route: /generated/user-authority-assignment/user-authority-assignment-s1
 * Process: USER_AUTHORITY_ASSIGNMENT | Actor: AUTHORITY_ADMIN
 * Screen: 사용자별 권한 배정 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.048439
 */
...
export const C3124_사용자별 권한 배정  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="사용자별 권한 배정 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: USER_AUTHORITY_ASSIGNMENT | Actor: AUTHORITY_ADMIN | Contract: #3124
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3124_사용자별 권한 배정  요청범위필수정보 확인 사용자 업무 화면Screen;
