/**
 * Contract: #307 | Route: /admin/ccus/facility/facility-asset-registry?step=far_assign
 * Process: FACILITY_ASSET_REGISTRY | Actor: MAINTENANCE_ENGINEER
 * Screen: 책임·허가·정비기준 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.040689
 */
...
export const C307_책임허가정비기준 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: far_assign
      const r = await fetch('/api/ccus/facility/facility-asset-registry/far_assign');
  ...
  return (
    <Card>
      <CardHeader title="책임·허가·정비기준 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_ASSET_REGISTRY | Actor: MAINTENANCE_ENGINEER | Contract: #307
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C307_책임허가정비기준 연결 관리자 업무 화면Screen;
