/**
 * Contract: #2823 | Route: /home/certificate-verify
 * Process: CERTIFICATE_ISSUANCE | Actor: VERIFIER
 * Screen: 공개 진위·OCR·시각지문 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.044704
 */
...
export const C2823_공개 진위OCR시각지문 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="공개 진위·OCR·시각지문 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CERTIFICATE_ISSUANCE | Actor: VERIFIER | Contract: #2823
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2823_공개 진위OCR시각지문 검증 사용자 업무 화면Screen;
