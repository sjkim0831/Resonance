/**
 * Contract: #3137 | Route: /admin/generated/data-scope-authority/data-scope-authority-s2
 * Process: DATA_SCOPE_AUTHORITY | Actor: AUTHORITY_ADMIN
 * Screen: 데이터 범위 권한 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.048767
 */
...
// DATA_SCOPE_AUTHORITY_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3137_데이터 범위 권한 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DATA_SCOPE_AUTHORITY_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="데이터 범위 권한 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_SCOPE_AUTHORITY | Actor: AUTHORITY_ADMIN | Contract: #3137
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3137_데이터 범위 권한 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
