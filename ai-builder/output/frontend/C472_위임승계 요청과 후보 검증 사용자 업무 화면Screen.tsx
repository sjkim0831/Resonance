/**
 * Contract: #472 | Route: /work/company-manager-delegation?step=cmd_request
 * Process: COMPANY_MANAGER_DELEGATION | Actor: COMPANY_ADMIN
 * Screen: 위임·승계 요청과 후보 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.042122
 */
...
export const C472_위임승계 요청과 후보 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="위임·승계 요청과 후보 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_MANAGER_DELEGATION | Actor: COMPANY_ADMIN | Contract: #472
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C472_위임승계 요청과 후보 검증 사용자 업무 화면Screen;
