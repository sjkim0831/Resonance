/**
 * Contract: #3246 | Route: /generated/stakeholder-sharing/stakeholder-sharing-s1
 * Process: STAKEHOLDER_SHARING | Actor: APPROVER
 * Screen: 이해관계자 공유 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.051239
 */
...
export const C3246_이해관계자 공유  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="이해관계자 공유 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: STAKEHOLDER_SHARING | Actor: APPROVER | Contract: #3246
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3246_이해관계자 공유  요청범위필수정보 확인 사용자 업무 화면Screen;
