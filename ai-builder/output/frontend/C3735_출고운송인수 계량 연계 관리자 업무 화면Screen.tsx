/**
 * Contract: #3735 | Route: /admin/generated/chain-of-custody/chain-of-custody-s2
 * Process: CHAIN_OF_CUSTODY | Actor: SYSTEM_INTEGRATOR
 * Screen: 출고·운송·인수 계량 연계 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.063527
 */
...
// CHAIN_OF_CUSTODY_EXECUTE_2: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3735_출고운송인수 계량 연계 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CHAIN_OF_CUSTODY_EXECUTE_2
  ...
  return (
    <Card>
      <CardHeader title="출고·운송·인수 계량 연계 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CHAIN_OF_CUSTODY | Actor: SYSTEM_INTEGRATOR | Contract: #3735
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3735_출고운송인수 계량 연계 관리자 업무 화면Screen;
