/**
 * Contract: #3564 | Route: /generated/quality-scoring-policy/quality-scoring-policy-s2
 * Process: QUALITY_SCORING_POLICY | Actor: VERIFIER
 * Screen: 품질 점수 기준 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.059081
 */
...
export const C3564_품질 점수 기준 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="품질 점수 기준 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: QUALITY_SCORING_POLICY | Actor: VERIFIER | Contract: #3564
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3564_품질 점수 기준 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
