/**
 * Contract: #3481 | Route: /admin/generated/external-system-registry/external-system-registry-s4
 * Process: EXTERNAL_SYSTEM_REGISTRY | Actor: APPROVER
 * Screen: 외부 연계 시스템 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.057189
 */
...
// EXTERNAL_SYSTEM_REGISTRY_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3481_외부 연계 시스템 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EXTERNAL_SYSTEM_REGISTRY_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="외부 연계 시스템 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SYSTEM_REGISTRY | Actor: APPROVER | Contract: #3481
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3481_외부 연계 시스템 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
