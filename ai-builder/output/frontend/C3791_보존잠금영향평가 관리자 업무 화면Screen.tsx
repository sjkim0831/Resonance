 ...
 * Generated: 2026-07-25T06:45:29.064861
 */
...
export const C3791_보존잠금영향평가 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보존·잠금·영향평가 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROJECT_LIFECYCLE_CONTROL | Actor: COMPANY_MANAGER | Contract: #3791
            </Typography>
            <Divider sx={ my: 2 } />
