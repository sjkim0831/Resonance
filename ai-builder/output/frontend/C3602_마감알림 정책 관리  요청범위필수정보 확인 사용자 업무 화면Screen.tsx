/**
 * Contract: #3602 | Route: /generated/deadline-notification-policy/deadline-notification-policy-s1
 * Process: DEADLINE_NOTIFICATION_POLICY | Actor: PLATFORM_OPERATOR
 * Screen: 마감·알림 정책 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.059992
 */
...
export const C3602_마감알림 정책 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="마감·알림 정책 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DEADLINE_NOTIFICATION_POLICY | Actor: PLATFORM_OPERATOR | Contract: #3602
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3602_마감알림 정책 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
