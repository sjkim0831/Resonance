/**
 * Contract: #3200 | Route: /generated/reduction-reporting/reduction-reporting-s1
 * Process: REDUCTION_REPORTING | Actor: REDUCTION_MANAGER
 * Screen: 감축 성과 보고 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.050138
 */
...
export const C3200_감축 성과 보고  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 성과 보고 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_REPORTING | Actor: REDUCTION_MANAGER | Contract: #3200
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3200_감축 성과 보고  요청범위필수정보 확인 사용자 업무 화면Screen;
