/**
 * Contract: #3392 | Route: /generated/resource-publication/resource-publication-s1
 * Process: RESOURCE_PUBLICATION | Actor: CONTENT_MANAGER
 * Screen: 자료실·기술자료 게시 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.055058
 */
...
export const C3392_자료실기술자료 게시  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="자료실·기술자료 게시 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: RESOURCE_PUBLICATION | Actor: CONTENT_MANAGER | Contract: #3392
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3392_자료실기술자료 게시  요청범위필수정보 확인 사용자 업무 화면Screen;
