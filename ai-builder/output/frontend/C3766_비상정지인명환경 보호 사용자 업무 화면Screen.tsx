/**
 * Contract: #3766 | Route: /generated/leakage-incident-response/leakage-incident-response-s2
 * Process: LEAKAGE_INCIDENT_RESPONSE | Actor: SITE_DATA_OWNER
 * Screen: 비상정지·인명환경 보호 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064291
 */
...
export const C3766_비상정지인명환경 보호 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="비상정지·인명환경 보호 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LEAKAGE_INCIDENT_RESPONSE | Actor: SITE_DATA_OWNER | Contract: #3766
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3766_비상정지인명환경 보호 사용자 업무 화면Screen;
