 ...
 * Generated: 2026-07-25T06:45:29.064966
 */
...
export const C24180_변경 요청근거 등록 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="변경 요청·근거 등록 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR | Contract: #24180
            </Typography>
            <Divider sx={ my: 2 } />
