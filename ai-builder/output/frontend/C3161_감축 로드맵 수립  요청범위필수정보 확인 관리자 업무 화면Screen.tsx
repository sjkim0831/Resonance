/**
 * Contract: #3161 | Route: /admin/generated/reduction-roadmap/reduction-roadmap-s1
 * Process: REDUCTION_ROADMAP | Actor: REDUCTION_MANAGER
 * Screen: 감축 로드맵 수립 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049294
 */
...
// REDUCTION_ROADMAP_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3161_감축 로드맵 수립  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REDUCTION_ROADMAP_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="감축 로드맵 수립 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_ROADMAP | Actor: REDUCTION_MANAGER | Contract: #3161
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3161_감축 로드맵 수립  요청범위필수정보 확인 관리자 업무 화면Screen;
