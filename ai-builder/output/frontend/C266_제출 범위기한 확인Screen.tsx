/**
 * Contract: #266 | Route: /emission/report-submission
 * Process: REGULATORY_SUBMISSION | Actor: APPROVER
 * Screen: 제출 범위·기한 확인
 * Generated: 2026-07-25T06:45:29.040589
 */
...
export const C266_제출 범위기한 확인Screen = () => {
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REGULATORY_SUBMISSION | Actor: APPROVER | Contract: #266
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C266_제출 범위기한 확인Screen;
