/**
 * Contract: #2980 | Route: /signin/authChoice
 * Process: IDENTITY_VERIFICATION | Actor: PUBLIC_APPLICANT
 * Screen: 이메일·휴대전화·본인 확인 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.045301
 */
...
export const C2980_이메일휴대전화본인 확인  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="이메일·휴대전화·본인 확인 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: IDENTITY_VERIFICATION | Actor: PUBLIC_APPLICANT | Contract: #2980
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2980_이메일휴대전화본인 확인  요청범위필수정보 확인 사용자 업무 화면Screen;
