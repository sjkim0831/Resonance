/**
 * Contract: #2982 | Route: /join/step4
 * Process: IDENTITY_VERIFICATION | Actor: PUBLIC_APPLICANT
 * Screen: 이메일·휴대전화·본인 확인 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.045352
 */
...
export const C2982_이메일휴대전화본인 확인  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="이메일·휴대전화·본인 확인 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: IDENTITY_VERIFICATION | Actor: PUBLIC_APPLICANT | Contract: #2982
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2982_이메일휴대전화본인 확인  업무 실행중간 결과 저장 사용자 업무 화면Screen;
