/**
 * Contract: #3338 | Route: /generated/course-management/course-management-s2
 * Process: COURSE_MANAGEMENT | Actor: EDUCATION_MANAGER
 * Screen: 교육 과정 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053312
 */
...
export const C3338_교육 과정 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 과정 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COURSE_MANAGEMENT | Actor: EDUCATION_MANAGER | Contract: #3338
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3338_교육 과정 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
