/**
 * Contract: #2983 | Route: /admin/member/list
 * Process: IDENTITY_VERIFICATION | Actor: PUBLIC_APPLICANT
 * Screen: 이메일·휴대전화·본인 확인 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045374
 */
...
// IDENTITY_VERIFICATION_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2983_이메일휴대전화본인 확인  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: IDENTITY_VERIFICATION_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="이메일·휴대전화·본인 확인 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: IDENTITY_VERIFICATION | Actor: PUBLIC_APPLICANT | Contract: #2983
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2983_이메일휴대전화본인 확인  업무 실행중간 결과 저장 관리자 업무 화면Screen;
