/**
 * Contract: #310 | Route: /ccus/facility/facility-operation-monitoring?step=fom_plan
 * Process: FACILITY_OPERATION_MONITORING | Actor: FACILITY_OPERATOR
 * Screen: 운전계획·허용범위 설정 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040756
 */
...
export const C310_운전계획허용범위 설정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="운전계획·허용범위 설정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_OPERATION_MONITORING | Actor: FACILITY_OPERATOR | Contract: #310
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C310_운전계획허용범위 설정 사용자 업무 화면Screen;
