/**
 * Contract: #333 | Route: /admin/ccus/facility/co2-injection-storage-operation?step=ciso_review
 * Process: CO2_INJECTION_STORAGE_OPERATION | Actor: HSE_MANAGER
 * Screen: 건전성 검토·MRV 인계 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.041798
 */
...
export const C333_건전성 검토MRV 인계 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: ciso_review
      const r = await fetch('/api/ccus/facility/co2-injection-storage-operation/ciso_review');
  ...
  return (
    <Card>
      <CardHeader title="건전성 검토·MRV 인계 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CO2_INJECTION_STORAGE_OPERATION | Actor: HSE_MANAGER | Contract: #333
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C333_건전성 검토MRV 인계 관리자 업무 화면Screen;
