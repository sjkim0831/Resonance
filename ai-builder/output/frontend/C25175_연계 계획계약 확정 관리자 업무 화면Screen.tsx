/**
 * Contract: #25175 | Route: /admin/system/process-workspace?process=DATA_INTEGRATION&step=DATA_INTEGRATION_01_PLAN
 * Process: DATA_INTEGRATION | Actor: SYSTEM_INTEGRATOR
 * Screen: 연계 계획·계약 확정 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.065115
 */
...
export const C25175_연계 계획계약 확정 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="연계 계획·계약 확정 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_INTEGRATION | Actor: SYSTEM_INTEGRATOR | Contract: #25175
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C25175_연계 계획계약 확정 관리자 업무 화면Screen;
