/**
 * Contract: #3134 | Route: /generated/data-scope-authority/data-scope-authority-s1
 * Process: DATA_SCOPE_AUTHORITY | Actor: AUTHORITY_ADMIN
 * Screen: 데이터 범위 권한 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.048700
 */
...
export const C3134_데이터 범위 권한 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="데이터 범위 권한 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_SCOPE_AUTHORITY | Actor: AUTHORITY_ADMIN | Contract: #3134
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3134_데이터 범위 권한 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
