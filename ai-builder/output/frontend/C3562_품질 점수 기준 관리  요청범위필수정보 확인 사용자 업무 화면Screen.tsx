/**
 * Contract: #3562 | Route: /generated/quality-scoring-policy/quality-scoring-policy-s1
 * Process: QUALITY_SCORING_POLICY | Actor: VERIFIER
 * Screen: 품질 점수 기준 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.059031
 */
...
export const C3562_품질 점수 기준 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="품질 점수 기준 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: QUALITY_SCORING_POLICY | Actor: VERIFIER | Contract: #3562
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3562_품질 점수 기준 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
