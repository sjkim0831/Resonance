/**
 * Contract: #3066 | Route: /mypage/company
 * Process: BUSINESS_SITE_ADMINISTRATION | Actor: COMPANY_ADMIN
 * Screen: 사업장 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.047203
 */
...
export const C3066_사업장 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="사업장 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: BUSINESS_SITE_ADMINISTRATION | Actor: COMPANY_ADMIN | Contract: #3066
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3066_사업장 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
