/**
 * Contract: #3760 | Route: /generated/lca-data-quality-uncertainty/lca-data-quality-uncertainty-s3
 * Process: LCA_DATA_QUALITY_UNCERTAINTY | Actor: VERIFIER
 * Screen: 불확도·민감도 계산 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064116
 */
...
export const C3760_불확도민감도 계산 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="불확도·민감도 계산 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LCA_DATA_QUALITY_UNCERTAINTY | Actor: VERIFIER | Contract: #3760
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3760_불확도민감도 계산 사용자 업무 화면Screen;
