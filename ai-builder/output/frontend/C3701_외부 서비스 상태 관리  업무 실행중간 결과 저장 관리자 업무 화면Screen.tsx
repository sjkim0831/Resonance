/**
 * Contract: #3701 | Route: /admin/generated/external-service-status/external-service-status-s2
 * Process: EXTERNAL_SERVICE_STATUS | Actor: SYSTEM_INTEGRATOR
 * Screen: 외부 서비스 상태 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.062505
 */
...
// EXTERNAL_SERVICE_STATUS_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3701_외부 서비스 상태 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EXTERNAL_SERVICE_STATUS_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="외부 서비스 상태 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SERVICE_STATUS | Actor: SYSTEM_INTEGRATOR | Contract: #3701
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3701_외부 서비스 상태 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
