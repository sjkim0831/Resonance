/**
 * Contract: #3041 | Route: /admin/member/withdrawn
 * Process: ACCOUNT_WITHDRAWAL | Actor: APPROVER
 * Screen: 회원 탈퇴·보유정보 처리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.046654
 */
...
// ACCOUNT_WITHDRAWAL_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3041_회원 탈퇴보유정보 처리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: ACCOUNT_WITHDRAWAL_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="회원 탈퇴·보유정보 처리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ACCOUNT_WITHDRAWAL | Actor: APPROVER | Contract: #3041
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3041_회원 탈퇴보유정보 처리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
