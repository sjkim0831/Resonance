/**
 * Contract: #3167 | Route: /admin/generated/reduction-project-registration/reduction-project-registration-s3
 * Process: REDUCTION_PROJECT_REGISTRATION | Actor: VERIFIER
 * Screen: 감축 과제 등록 - 독립 검토·보완·권한 검증 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049426
 */
...
// REDUCTION_PROJECT_REGISTRATION_REVIEW: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3167_감축 과제 등록  독립 검토보완권한 검증 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REDUCTION_PROJECT_REGISTRATION_REVIEW
  ...
  return (
    <Card>
      <CardHeader title="감축 과제 등록 - 독립 검토·보완·권한 검증 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PROJECT_REGISTRATION | Actor: VERIFIER | Contract: #3167
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3167_감축 과제 등록  독립 검토보완권한 검증 관리자 업무 화면Screen;
