/**
 * Contract: #3421 | Route: /admin/generated/newsletter-operation/newsletter-operation-s2
 * Process: NEWSLETTER_OPERATION | Actor: CONTENT_MANAGER
 * Screen: 뉴스레터 구독·발송 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.055807
 */
...
// NEWSLETTER_OPERATION_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3421_뉴스레터 구독발송  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: NEWSLETTER_OPERATION_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="뉴스레터 구독·발송 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: NEWSLETTER_OPERATION | Actor: CONTENT_MANAGER | Contract: #3421
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3421_뉴스레터 구독발송  업무 실행중간 결과 저장 관리자 업무 화면Screen;
