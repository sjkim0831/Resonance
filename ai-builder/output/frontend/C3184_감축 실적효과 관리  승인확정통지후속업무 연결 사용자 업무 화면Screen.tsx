/**
 * Contract: #3184 | Route: /generated/reduction-performance/reduction-performance-s4
 * Process: REDUCTION_PERFORMANCE | Actor: APPROVER
 * Screen: 감축 실적·효과 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049788
 */
...
export const C3184_감축 실적효과 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 실적·효과 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PERFORMANCE | Actor: APPROVER | Contract: #3184
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3184_감축 실적효과 관리  승인확정통지후속업무 연결 사용자 업무 화면Screen;
