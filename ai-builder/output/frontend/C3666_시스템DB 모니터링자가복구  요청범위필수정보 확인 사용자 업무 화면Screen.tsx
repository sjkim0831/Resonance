/**
 * Contract: #3666 | Route: /generated/system-monitoring-recovery/system-monitoring-recovery-s1
 * Process: SYSTEM_MONITORING_RECOVERY | Actor: PLATFORM_OPERATOR
 * Screen: 시스템·DB 모니터링·자가복구 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.061538
 */
...
// SYSTEM_MONITORING_RECOVERY_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3666_시스템DB 모니터링자가복구  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: SYSTEM_MONITORING_RECOVERY_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="시스템·DB 모니터링·자가복구 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: SYSTEM_MONITORING_RECOVERY | Actor: PLATFORM_OPERATOR | Contract: #3666
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3666_시스템DB 모니터링자가복구  요청범위필수정보 확인 사용자 업무 화면Screen;
