/**
 * Contract: #3477 | Route: /admin/generated/external-system-registry/external-system-registry-s2
 * Process: EXTERNAL_SYSTEM_REGISTRY | Actor: SYSTEM_INTEGRATOR
 * Screen: 외부 연계 시스템 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.057109
 */
...
// EXTERNAL_SYSTEM_REGISTRY_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3477_외부 연계 시스템 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EXTERNAL_SYSTEM_REGISTRY_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="외부 연계 시스템 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SYSTEM_REGISTRY | Actor: SYSTEM_INTEGRATOR | Contract: #3477
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3477_외부 연계 시스템 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
