/**
 * Contract: #336 | Route: /ccus/facility/facility-emergency-response?step=fer_control
 * Process: FACILITY_EMERGENCY_RESPONSE | Actor: HSE_MANAGER
 * Screen: 통제·대피·법정보고 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.041868
 */
...
export const C336_통제대피법정보고 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="통제·대피·법정보고 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_EMERGENCY_RESPONSE | Actor: HSE_MANAGER | Contract: #336
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C336_통제대피법정보고 사용자 업무 화면Screen;
