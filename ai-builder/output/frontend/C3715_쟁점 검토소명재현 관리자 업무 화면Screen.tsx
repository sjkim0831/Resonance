/**
 * Contract: #3715 | Route: /admin/generated/appeal-dispute-audit/appeal-dispute-audit-s3
 * Process: APPEAL_DISPUTE_AUDIT | Actor: VERIFIER
 * Screen: 쟁점 검토·소명·재현 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.062994
 */
...
export const C3715_쟁점 검토소명재현 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: APPEAL_DISPUTE_AUDIT_EXECUTE_3
  ...
  return (
    <Card>
      <CardHeader title="쟁점 검토·소명·재현 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: APPEAL_DISPUTE_AUDIT | Actor: VERIFIER | Contract: #3715
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3715_쟁점 검토소명재현 관리자 업무 화면Screen;
