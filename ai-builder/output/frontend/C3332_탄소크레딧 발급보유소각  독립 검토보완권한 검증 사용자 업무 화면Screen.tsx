/**
 * Contract: #3332 | Route: /generated/carbon-credit-management/carbon-credit-management-s3
 * Process: CARBON_CREDIT_MANAGEMENT | Actor: VERIFIER
 * Screen: 탄소크레딧 발급·보유·소각 - 독립 검토·보완·권한 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053174
 */
...
export const C3332_탄소크레딧 발급보유소각  독립 검토보완권한 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="탄소크레딧 발급·보유·소각 - 독립 검토·보완·권한 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CARBON_CREDIT_MANAGEMENT | Actor: VERIFIER | Contract: #3332
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3332_탄소크레딧 발급보유소각  독립 검토보완권한 검증 사용자 업무 화면Screen;
