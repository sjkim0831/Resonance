/**
 * Contract: #3474 | Route: /generated/external-system-registry/external-system-registry-s1
 * Process: EXTERNAL_SYSTEM_REGISTRY | Actor: SYSTEM_INTEGRATOR
 * Screen: 외부 연계 시스템 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.057050
 */
...
export const C3474_외부 연계 시스템 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="외부 연계 시스템 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SYSTEM_REGISTRY | Actor: SYSTEM_INTEGRATOR | Contract: #3474
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3474_외부 연계 시스템 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
