/**
 * Contract: #3751 | Route: /admin/generated/lca-allocation-sensitivity/lca-allocation-sensitivity-s2
 * Process: LCA_ALLOCATION_SENSITIVITY | Actor: LCA_PRACTITIONER
 * Screen: 할당 회피·규칙 선택 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.063903
 */
...
// LCA_ALLOCATION_SENSITIVITY_EXECUTE_2: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3751_할당 회피규칙 선택 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: LCA_ALLOCATION_SENSITIVITY_EXECUTE_2
  ...
  return (
    <Card>
      <CardHeader title="할당 회피·규칙 선택 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LCA_ALLOCATION_SENSITIVITY | Actor: LCA_PRACTITIONER | Contract: #3751
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3751_할당 회피규칙 선택 관리자 업무 화면Screen;
