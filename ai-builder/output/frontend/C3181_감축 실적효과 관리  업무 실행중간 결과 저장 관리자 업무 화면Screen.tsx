/**
 * Contract: #3181 | Route: /admin/generated/reduction-performance/reduction-performance-s2
 * Process: REDUCTION_PERFORMANCE | Actor: REDUCTION_MANAGER
 * Screen: 감축 실적·효과 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049724
 */
...
// REDUCTION_PERFORMANCE_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3181_감축 실적효과 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REDUCTION_PERFORMANCE_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="감축 실적·효과 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PERFORMANCE | Actor: REDUCTION_MANAGER | Contract: #3181
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3181_감축 실적효과 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
