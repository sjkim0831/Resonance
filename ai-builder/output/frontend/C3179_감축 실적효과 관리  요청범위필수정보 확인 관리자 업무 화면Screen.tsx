/**
 * Contract: #3179 | Route: /admin/generated/reduction-performance/reduction-performance-s1
 * Process: REDUCTION_PERFORMANCE | Actor: REDUCTION_MANAGER
 * Screen: 감축 실적·효과 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049684
 */
...
// REDUCTION_PERFORMANCE_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3179_감축 실적효과 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REDUCTION_PERFORMANCE_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="감축 실적·효과 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PERFORMANCE | Actor: REDUCTION_MANAGER | Contract: #3179
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3179_감축 실적효과 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
