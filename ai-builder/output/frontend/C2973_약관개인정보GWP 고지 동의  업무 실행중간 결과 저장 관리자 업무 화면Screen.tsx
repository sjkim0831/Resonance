/**
 * Contract: #2973 | Route: /admin/system/consent-history
 * Process: TERMS_CONSENT | Actor: PUBLIC_APPLICANT
 * Screen: 약관·개인정보·GWP 고지 동의 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045131
 */
...
// TERMS_CONSENT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2973_약관개인정보GWP 고지 동의  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="약관·개인정보·GWP 고지 동의 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TERMS_CONSENT | Actor: PUBLIC_APPLICANT | Contract: #2973
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2973_약관개인정보GWP 고지 동의  업무 실행중간 결과 저장 관리자 업무 화면Screen;
