/**
 * Contract: #335 | Route: /admin/ccus/facility/facility-emergency-response?step=fer_declare
 * Process: FACILITY_EMERGENCY_RESPONSE | Actor: FACILITY_OPERATOR
 * Screen: 사고 탐지·비상 선언 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.041848
 */
...
export const C335_사고 탐지비상 선언 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: fer_declare
      const r = await fetch('/api/ccus/facility/facility-emergency-response/fer_declare');
  ...
  return (
    <Card>
      <CardHeader title="사고 탐지·비상 선언 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_EMERGENCY_RESPONSE | Actor: FACILITY_OPERATOR | Contract: #335
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C335_사고 탐지비상 선언 관리자 업무 화면Screen;
