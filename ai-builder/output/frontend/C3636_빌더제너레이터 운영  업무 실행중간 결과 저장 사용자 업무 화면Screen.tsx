/**
 * Contract: #3636 | Route: /generated/builder-generator-operation/builder-generator-operation-s2
 * Process: BUILDER_GENERATOR_OPERATION | Actor: PLATFORM_OPERATOR
 * Screen: 빌더·제너레이터 운영 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.060835
 */
...
export const C3636_빌더제너레이터 운영  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="빌더·제너레이터 운영 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: BUILDER_GENERATOR_OPERATION | Actor: PLATFORM_OPERATOR | Contract: #3636
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3636_빌더제너레이터 운영  업무 실행중간 결과 저장 사용자 업무 화면Screen;
