/**
 * Contract: #3222 | Route: /generated/anomaly-alert-management/anomaly-alert-management-s1
 * Process: ANOMALY_ALERT_MANAGEMENT | Actor: DATA_ANALYST
 * Screen: 이상치·경보 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.050607
 */
...
export const C3222_이상치경보 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="이상치·경보 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ANOMALY_ALERT_MANAGEMENT | Actor: DATA_ANALYST | Contract: #3222
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3222_이상치경보 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
