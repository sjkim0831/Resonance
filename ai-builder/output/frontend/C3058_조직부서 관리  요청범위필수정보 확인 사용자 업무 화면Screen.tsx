/**
 * Contract: #3058 | Route: /mypage/company
 * Process: ORGANIZATION_DEPARTMENT | Actor: COMPANY_ADMIN
 * Screen: 조직·부서 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.047013
 */
...
export const C3058_조직부서 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="조직·부서 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ORGANIZATION_DEPARTMENT | Actor: COMPANY_ADMIN | Contract: #3058
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3058_조직부서 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
