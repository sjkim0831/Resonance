/**
 * Contract: #3746 | Route: /generated/external-verification-engagement/external-verification-engagement-s2
 * Process: EXTERNAL_VERIFICATION_ENGAGEMENT | Actor: COMPANY_MANAGER
 * Screen: 독립성·역량 심사 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063796
 */
...
export const C3746_독립성역량 심사 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="독립성·역량 심사 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_VERIFICATION_ENGAGEMENT | Actor: COMPANY_MANAGER | Contract: #3746
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3746_독립성역량 심사 사용자 업무 화면Screen;
