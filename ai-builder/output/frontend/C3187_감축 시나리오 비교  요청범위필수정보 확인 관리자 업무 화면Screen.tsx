/**
 * Contract: #3187 | Route: /admin/generated/reduction-scenario/reduction-scenario-s1
 * Process: REDUCTION_SCENARIO | Actor: DATA_ANALYST
 * Screen: 감축 시나리오 비교 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049860
 */
...
// REDUCTION_SCENARIO_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3187_감축 시나리오 비교  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REDUCTION_SCENARIO_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="감축 시나리오 비교 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_SCENARIO | Actor: DATA_ANALYST | Contract: #3187
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3187_감축 시나리오 비교  요청범위필수정보 확인 관리자 업무 화면Screen;
