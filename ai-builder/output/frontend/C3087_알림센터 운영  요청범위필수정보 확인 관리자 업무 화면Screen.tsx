/**
 * Contract: #3087 | Route: /admin/generated/notification-center-operation/notification-center-operation-s1
 * Process: NOTIFICATION_CENTER_OPERATION | Actor: PLATFORM_OPERATOR
 * Screen: 알림센터 운영 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.047639
 */
...
// NOTIFICATION_CENTER_OPERATION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3087_알림센터 운영  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: NOTIFICATION_CENTER_OPERATION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="알림센터 운영 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: NOTIFICATION_CENTER_OPERATION | Actor: PLATFORM_OPERATOR | Contract: #3087
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3087_알림센터 운영  요청범위필수정보 확인 관리자 업무 화면Screen;
