/**
 * Contract: #3320 | Route: /generated/double-use-prevention/double-use-prevention-s1
 * Process: DOUBLE_USE_PREVENTION | Actor: AUDITOR
 * Screen: 중복 사용·이중계상 방지 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.052895
 */
...
export const C3320_중복 사용이중계상 방지  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="중복 사용·이중계상 방지 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DOUBLE_USE_PREVENTION | Actor: AUDITOR | Contract: #3320
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3320_중복 사용이중계상 방지  요청범위필수정보 확인 사용자 업무 화면Screen;
