/**
 * Contract: #123 | Route: /admin/emission/calculation-rule
 * Process: EMISSION_CALCULATION | Actor: CALCULATOR
 * Screen: 배출계수 매핑·배출량 산정
 * Generated: 2026-07-25T06:45:29.039786
 */
...
export const C123_배출계수 매핑배출량 산정Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="배출계수 매핑·배출량 산정" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_CALCULATION | Actor: CALCULATOR | Contract: #123
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C123_배출계수 매핑배출량 산정Screen;
