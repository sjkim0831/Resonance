/**
 * Contract: #3436 | Route: /generated/report-generation/report-generation-s2
 * Process: REPORT_GENERATION | Actor: CALCULATOR
 * Screen: 보고서 생성·미리보기 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.056159
 */
...
export const C3436_보고서 생성미리보기  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 생성·미리보기 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_GENERATION | Actor: CALCULATOR | Contract: #3436
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3436_보고서 생성미리보기  업무 실행중간 결과 저장 사용자 업무 화면Screen;
