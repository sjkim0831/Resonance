/**
 * Contract: #3108 | Route: /generated/reduction-roadmap/reduction-roadmap-s4
 * Process: REDUCTION_ROADMAP | Actor: APPROVER
 * Screen: 감축 로드맵 수립 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.048095
 */
...
export const C3108_감축 로드맵 수립  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 로드맵 수립 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_ROADMAP | Actor: APPROVER | Contract: #3108
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3108_감축 로드맵 수립  승인확정통지후속업무 연결 사용자 업무 화면Screen;
