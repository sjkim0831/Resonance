/**
 * Contract: #3588 | Route: /generated/task-template-management/task-template-management-s2
 * Process: TASK_TEMPLATE_MANAGEMENT | Actor: PLATFORM_OPERATOR
 * Screen: Task 템플릿 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.059676
 */
...
export const C3588_Task 템플릿 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="Task 템플릿 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TASK_TEMPLATE_MANAGEMENT | Actor: PLATFORM_OPERATOR | Contract: #3588
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3588_Task 템플릿 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
