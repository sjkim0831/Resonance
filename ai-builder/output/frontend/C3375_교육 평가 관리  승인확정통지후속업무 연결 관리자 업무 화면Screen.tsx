/**
 * Contract: #3375 | Route: /admin/generated/education-assessment/education-assessment-s4
 * Process: EDUCATION_ASSESSMENT | Actor: APPROVER
 * Screen: 교육 평가 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.054594
 */
...
// EDUCATION_ASSESSMENT_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3375_교육 평가 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EDUCATION_ASSESSMENT_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="교육 평가 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_ASSESSMENT | Actor: APPROVER | Contract: #3375
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3375_교육 평가 관리  승인확정통지후속업무 연결 관리자 업무 화면Screen;
