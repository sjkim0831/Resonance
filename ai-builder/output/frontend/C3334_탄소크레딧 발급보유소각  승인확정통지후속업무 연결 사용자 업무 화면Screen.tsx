/**
 * Contract: #3334 | Route: /generated/carbon-credit-management/carbon-credit-management-s4
 * Process: CARBON_CREDIT_MANAGEMENT | Actor: APPROVER
 * Screen: 탄소크레딧 발급·보유·소각 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053228
 */
...
export const C3334_탄소크레딧 발급보유소각  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="탄소크레딧 발급·보유·소각 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CARBON_CREDIT_MANAGEMENT | Actor: APPROVER | Contract: #3334
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3334_탄소크레딧 발급보유소각  승인확정통지후속업무 연결 사용자 업무 화면Screen;
