/**
 * Contract: #3612 | Route: /generated/automation-rule-management/automation-rule-management-s2
 * Process: AUTOMATION_RULE_MANAGEMENT | Actor: PLATFORM_OPERATOR
 * Screen: 자동 처리 규칙 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.060236
 */
...
export const C3612_자동 처리 규칙 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="자동 처리 규칙 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: AUTOMATION_RULE_MANAGEMENT | Actor: PLATFORM_OPERATOR | Contract: #3612
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3612_자동 처리 규칙 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
