...
export const C3010_비밀번호 재설정  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="비밀번호 재설정 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PASSWORD_RECOVERY | Actor: MEMBER_USER | Contract: #3010
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3010_비밀번호 재설정  요청범위필수정보 확인 사용자 업무 화면Screen;
