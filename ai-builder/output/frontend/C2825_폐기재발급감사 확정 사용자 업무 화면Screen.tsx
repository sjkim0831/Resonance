/**
 * Contract: #2825 | Route: /emission/report_submit
 * Process: CERTIFICATE_ISSUANCE | Actor: APPROVER
 * Screen: 폐기·재발급·감사 확정 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.044746
 */
...
export const C2825_폐기재발급감사 확정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="폐기·재발급·감사 확정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CERTIFICATE_ISSUANCE | Actor: APPROVER | Contract: #2825
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2825_폐기재발급감사 확정 사용자 업무 화면Screen;
