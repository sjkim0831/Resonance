/**
 * Contract: #2866 | Route: /admin/generated/role-authority-management/role-authority-management-s1
 * Process: ROLE_AUTHORITY_MANAGEMENT | Actor: AUTHORITY_ADMIN
 * Screen: 역할·권한 그룹 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044881
 */
...
// ROLE_AUTHORITY_MANAGEMENT_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2866_역할권한 그룹 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: ROLE_AUTHORITY_MANAGEMENT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="역할·권한 그룹 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ROLE_AUTHORITY_MANAGEMENT | Actor: AUTHORITY_ADMIN | Contract: #2866
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2866_역할권한 그룹 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
