/**
 * Contract: #3305 | Route: /admin/generated/refund-management/refund-management-s1
 * Process: REFUND_MANAGEMENT | Actor: SETTLEMENT_OPERATOR
 * Screen: 환불 요청·처리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.052557
 */
...
// REFUND_MANAGEMENT_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3305_환불 요청처리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REFUND_MANAGEMENT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="환불 요청·처리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REFUND_MANAGEMENT | Actor: SETTLEMENT_OPERATOR | Contract: #3305
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3305_환불 요청처리  요청범위필수정보 확인 관리자 업무 화면Screen;
