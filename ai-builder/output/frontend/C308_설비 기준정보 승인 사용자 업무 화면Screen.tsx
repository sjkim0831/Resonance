/**
 * Contract: #308 | Route: /ccus/facility/facility-asset-registry?step=far_approve
 * Process: FACILITY_ASSET_REGISTRY | Actor: HSE_MANAGER
 * Screen: 설비 기준정보 승인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040713
 */
...
export const C308_설비 기준정보 승인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="설비 기준정보 승인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_ASSET_REGISTRY | Actor: HSE_MANAGER | Contract: #308
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C308_설비 기준정보 승인 사용자 업무 화면Screen;
