/**
 * Contract: #317 | Route: /admin/ccus/facility/meter-calibration-management?step=mcm_register
 * Process: METER_CALIBRATION_MANAGEMENT | Actor: INSTRUMENT_ENGINEER
 * Screen: 계측기·측정지점 등록 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.040937
 */
...
// Contract #317 APIs
// mcm_register: GET /api/ccus/facility/meter-calibration-management/mcm_register

export const C317_계측기측정지점 등록 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: mcm_register
      const r = await fetch('/api/ccus/facility/meter-calibration-management/mcm_register');
  ...
  return (
    <Card>
      <CardHeader title="계측기·측정지점 등록 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: METER_CALIBRATION_MANAGEMENT | Actor: INSTRUMENT_ENGINEER | Contract: #317
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C317_계측기측정지점 등록 관리자 업무 화면Screen;
