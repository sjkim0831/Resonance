/**
 * Contract: #2813 | Route: /emission/report_submit
 * Process: CERTIFICATE_ISSUANCE | Actor: COMPANY_MANAGER
 * Screen: 보고서 확정·발급 준비 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.044662
 */
...
export const C2813_보고서 확정발급 준비 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 확정·발급 준비 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CERTIFICATE_ISSUANCE | Actor: COMPANY_MANAGER | Contract: #2813
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2813_보고서 확정발급 준비 사용자 업무 화면Screen;
