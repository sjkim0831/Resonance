/**
 * Contract: #3083 | Route: /admin/generated/comparative-assertion-review/comparative-assertion-review-s1
 * Process: COMPARATIVE_ASSERTION_REVIEW | Actor: LCA_PRACTITIONER
 * Screen: 비교 목적·동등 조건 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.047546
 */
...
// COMPARATIVE_ASSERTION_REVIEW_EXECUTE_1: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3083_비교 목적동등 조건 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: COMPARATIVE_ASSERTION_REVIEW_EXECUTE_1
  ...
  return (
    <Card>
      <CardHeader title="비교 목적·동등 조건 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPARATIVE_ASSERTION_REVIEW | Actor: LCA_PRACTITIONER | Contract: #3083
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3083_비교 목적동등 조건 확인 관리자 업무 화면Screen;
