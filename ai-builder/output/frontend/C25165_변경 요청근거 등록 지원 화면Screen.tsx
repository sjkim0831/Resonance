/**
 * Contract: #25165 | Route: /admin/system/actor-process
 * Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR
 * Screen: 변경 요청·근거 등록 지원 화면
 * Generated: 2026-07-25T06:45:29.064989
 */
...
export const C25165_변경 요청근거 등록 지원 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="변경 요청·근거 등록 지원 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR | Contract: #25165
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C25165_변경 요청근거 등록 지원 화면Screen;
