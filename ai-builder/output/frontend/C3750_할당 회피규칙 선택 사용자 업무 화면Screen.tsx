/**
 * Contract: #3750 | Route: /generated/lca-allocation-sensitivity/lca-allocation-sensitivity-s2
 * Process: LCA_ALLOCATION_SENSITIVITY | Actor: LCA_PRACTITIONER
 * Screen: 할당 회피·규칙 선택 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063881
 */
...
export const C3750_할당 회피규칙 선택 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="할당 회피·규칙 선택 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LCA_ALLOCATION_SENSITIVITY | Actor: LCA_PRACTITIONER | Contract: #3750
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3750_할당 회피규칙 선택 사용자 업무 화면Screen;
