/**
 * Contract: #3170 | Route: /generated/reduction-project-approval/reduction-project-approval-s1
 * Process: REDUCTION_PROJECT_APPROVAL | Actor: APPROVER
 * Screen: 감축 과제 검토·승인 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049489
 */
...
export const C3170_감축 과제 검토승인  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 과제 검토·승인 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_PROJECT_APPROVAL | Actor: APPROVER | Contract: #3170
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3170_감축 과제 검토승인  요청범위필수정보 확인 사용자 업무 화면Screen;
