/**
 * Contract: #3782 | Route: /generated/pcr-epd-verification/pcr-epd-verification-s2
 * Process: PCR_EPD_VERIFICATION | Actor: LCA_PRACTITIONER
 * Screen: PCR 적합성·유효기간 판정 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064665
 */
...
export const C3782_PCR 적합성유효기간 판정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="PCR 적합성·유효기간 판정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PCR_EPD_VERIFICATION | Actor: LCA_PRACTITIONER | Contract: #3782
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3782_PCR 적합성유효기간 판정 사용자 업무 화면Screen;
