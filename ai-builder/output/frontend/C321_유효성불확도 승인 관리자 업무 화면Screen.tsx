/**
 * Contract: #321 | Route: /admin/ccus/facility/meter-calibration-management?step=mcm_approve
 * Process: METER_CALIBRATION_MANAGEMENT | Actor: HSE_MANAGER
 * Screen: 유효성·불확도 승인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.041105
 */
...
export const C321_유효성불확도 승인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: mcm_approve
      const r = await fetch('/api/ccus/facility/meter-calibration-management/mcm_approve');
  ...
  return (
    <Card>
      <CardHeader title="유효성·불확도 승인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: METER_CALIBRATION_MANAGEMENT | Actor: HSE_MANAGER | Contract: #321
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C321_유효성불확도 승인 관리자 업무 화면Screen;
