/**
 * Contract: #2975 | Route: /admin/system/consent-history
 * Process: TERMS_CONSENT | Actor: VERIFIER
 * Screen: 약관·개인정보·GWP 고지 동의 - 독립 검토·보완·권한 검증 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.045173
 */
...
// TERMS_CONSENT_REVIEW: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2975_약관개인정보GWP 고지 동의  독립 검토보완권한 검증 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="약관·개인정보·GWP 고지 동의 - 독립 검토·보완·권한 검증 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: TERMS_CONSENT | Actor: VERIFIER | Contract: #2975
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2975_약관개인정보GWP 고지 동의  독립 검토보완권한 검증 관리자 업무 화면Screen;
