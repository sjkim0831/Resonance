/**
 * Contract: #3501 | Route: /admin/generated/data-schema-contract/data-schema-contract-s2
 * Process: DATA_SCHEMA_CONTRACT | Actor: SYSTEM_INTEGRATOR
 * Screen: 데이터 스키마·계약 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.057646
 */
...
// DATA_SCHEMA_CONTRACT_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3501_데이터 스키마계약 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DATA_SCHEMA_CONTRACT_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="데이터 스키마·계약 관리 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_SCHEMA_CONTRACT | Actor: SYSTEM_INTEGRATOR | Contract: #3501
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3501_데이터 스키마계약 관리  업무 실행중간 결과 저장 관리자 업무 화면Screen;
