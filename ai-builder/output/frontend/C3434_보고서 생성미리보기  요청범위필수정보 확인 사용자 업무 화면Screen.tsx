/**
 * Contract: #3434 | Route: /generated/report-generation/report-generation-s1
 * Process: REPORT_GENERATION | Actor: CALCULATOR
 * Screen: 보고서 생성·미리보기 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.056115
 */
...
export const C3434_보고서 생성미리보기  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 생성·미리보기 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_GENERATION | Actor: CALCULATOR | Contract: #3434
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3434_보고서 생성미리보기  요청범위필수정보 확인 사용자 업무 화면Screen;
