/**
 * Contract: #510 | Route: /admin/emission/organizational-boundary
 * Process: ORGANIZATIONAL_BOUNDARY | Actor: COMPANY_MANAGER
 * Screen: 법인·사업장·소유구조 수집 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.042325
 */
...
export const C510_법인사업장소유구조 수집 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    setLoading(true);
    try {
      // GET: organizational-boundary
      const r = await fetch('/home/api/emission-projects/{id}/organizational-boundary');
  ...
  return (
    <Card>
      <CardHeader title="법인·사업장·소유구조 수집 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ORGANIZATIONAL_BOUNDARY | Actor: COMPANY_MANAGER | Contract: #510
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C510_법인사업장소유구조 수집 관리자 업무 화면Screen;
