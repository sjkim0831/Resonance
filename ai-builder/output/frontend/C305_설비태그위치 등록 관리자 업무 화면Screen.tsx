/**
 * Contract: #305 | Route: /admin/ccus/facility/facility-asset-registry?step=far_register
 * Process: FACILITY_ASSET_REGISTRY | Actor: FACILITY_OPERATOR
 * Screen: 설비·태그·위치 등록 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.040648
 */
...
export const C305_설비태그위치 등록 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: far_register
      const r = await fetch('/api/ccus/facility/facility-asset-registry/far_register');
  ...
  return (
    <Card>
      <CardHeader title="설비·태그·위치 등록 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_ASSET_REGISTRY | Actor: FACILITY_OPERATOR | Contract: #305
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C305_설비태그위치 등록 관리자 업무 화면Screen;
