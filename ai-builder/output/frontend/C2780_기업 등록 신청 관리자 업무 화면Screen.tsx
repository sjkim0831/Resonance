/**
 * Contract: #2780 | Route: /admin/member/company-approve
 * Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER
 * Screen: 기업 등록 신청 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044345
 */
...
// APPLY_COMPANY: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2780_기업 등록 신청 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="기업 등록 신청 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPANY_ONBOARDING | Actor: COMPANY_MANAGER | Contract: #2780
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2780_기업 등록 신청 관리자 업무 화면Screen;
