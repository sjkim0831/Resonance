 ...
 * Generated: 2026-07-25T06:45:29.044282
 */
...
export const C742_프로세스 단계 실행 작업공간Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="프로세스 단계 실행 작업공간" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_PROJECT | Actor: SITE_DATA_OWNER | Contract: #742
            </Typography>
            <Divider sx={ my: 2 } />
