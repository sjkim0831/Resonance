/**
 * Contract: #3193 | Route: /admin/generated/macc-portfolio/macc-portfolio-s1
 * Process: MACC_PORTFOLIO | Actor: DATA_ANALYST
 * Screen: 한계감축비용·포트폴리오 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.049984
 */
...
// MACC_PORTFOLIO_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3193_한계감축비용포트폴리오  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="한계감축비용·포트폴리오 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MACC_PORTFOLIO | Actor: DATA_ANALYST | Contract: #3193
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3193_한계감축비용포트폴리오  요청범위필수정보 확인 관리자 업무 화면Screen;
