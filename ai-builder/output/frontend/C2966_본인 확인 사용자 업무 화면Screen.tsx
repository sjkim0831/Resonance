...
export const C2966_본인 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="본인 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT | Contract: #2966
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2966_본인 확인 사용자 업무 화면Screen;
