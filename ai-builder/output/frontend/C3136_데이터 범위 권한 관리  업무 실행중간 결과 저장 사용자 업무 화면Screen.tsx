/**
 * Contract: #3136 | Route: /generated/data-scope-authority/data-scope-authority-s2
 * Process: DATA_SCOPE_AUTHORITY | Actor: AUTHORITY_ADMIN
 * Screen: 데이터 범위 권한 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.048745
 */
...
export const C3136_데이터 범위 권한 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="데이터 범위 권한 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_SCOPE_AUTHORITY | Actor: AUTHORITY_ADMIN | Contract: #3136
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3136_데이터 범위 권한 관리  업무 실행중간 결과 저장 사용자 업무 화면Screen;
