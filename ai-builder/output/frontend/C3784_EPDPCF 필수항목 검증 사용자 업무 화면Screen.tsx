/**
 * Contract: #3784 | Route: /generated/pcr-epd-verification/pcr-epd-verification-s3
 * Process: PCR_EPD_VERIFICATION | Actor: VERIFIER
 * Screen: EPD·PCF 필수항목 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064715
 */
...
export const C3784_EPDPCF 필수항목 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="EPD·PCF 필수항목 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PCR_EPD_VERIFICATION | Actor: VERIFIER | Contract: #3784
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3784_EPDPCF 필수항목 검증 사용자 업무 화면Screen;
