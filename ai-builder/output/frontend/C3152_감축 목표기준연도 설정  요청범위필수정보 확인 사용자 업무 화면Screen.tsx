/**
 * Contract: #3152 | Route: /generated/reduction-target-planning/reduction-target-planning-s1
 * Process: REDUCTION_TARGET_PLANNING | Actor: REDUCTION_MANAGER
 * Screen: 감축 목표·기준연도 설정 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.049102
 */
...
export const C3152_감축 목표기준연도 설정  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 목표·기준연도 설정 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_TARGET_PLANNING | Actor: REDUCTION_MANAGER | Contract: #3152
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3152_감축 목표기준연도 설정  요청범위필수정보 확인 사용자 업무 화면Screen;
