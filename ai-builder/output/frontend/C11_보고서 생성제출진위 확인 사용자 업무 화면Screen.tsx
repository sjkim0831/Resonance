/**
 * Contract: #11 | Route: /emission/report_submit
 * Process: EMISSION_PROJECT | Actor: COMPANY_MANAGER
 * Screen: 보고서 생성·제출·진위 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.039355
 */
...
export const C11_보고서 생성제출진위 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 생성·제출·진위 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_PROJECT | Actor: COMPANY_MANAGER | Contract: #11
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C11_보고서 생성제출진위 확인 사용자 업무 화면Screen;
