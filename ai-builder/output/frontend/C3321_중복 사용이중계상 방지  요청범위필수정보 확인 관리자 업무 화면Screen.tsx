/**
 * Contract: #3321 | Route: /admin/generated/double-use-prevention/double-use-prevention-s1
 * Process: DOUBLE_USE_PREVENTION | Actor: AUDITOR
 * Screen: 중복 사용·이중계상 방지 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.052916
 */
...
// DOUBLE_USE_PREVENTION_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3321_중복 사용이중계상 방지  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DOUBLE_USE_PREVENTION_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="중복 사용·이중계상 방지 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DOUBLE_USE_PREVENTION | Actor: AUDITOR | Contract: #3321
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3321_중복 사용이중계상 방지  요청범위필수정보 확인 관리자 업무 화면Screen;
