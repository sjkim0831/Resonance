/**
 * Contract: #2865 | Route: /generated/role-authority-management/role-authority-management-s1
 * Process: ROLE_AUTHORITY_MANAGEMENT | Actor: AUTHORITY_ADMIN
 * Screen: 역할·권한 그룹 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.044860
 */
...
export const C2865_역할권한 그룹 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="역할·권한 그룹 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ROLE_AUTHORITY_MANAGEMENT | Actor: AUTHORITY_ADMIN | Contract: #2865
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2865_역할권한 그룹 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
