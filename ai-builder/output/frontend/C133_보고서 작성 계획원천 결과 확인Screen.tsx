/**
 * Contract: #133 | Route: /admin/emission/report-certificates
 * Process: REPORT_CERTIFICATION | Actor: COMPANY_MANAGER
 * Screen: 보고서 작성 계획·원천 결과 확인
 * Generated: 2026-07-25T06:45:29.040051
 */
...
export const C133_보고서 작성 계획원천 결과 확인Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 작성 계획·원천 결과 확인" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_CERTIFICATION | Actor: COMPANY_MANAGER | Contract: #133
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C133_보고서 작성 계획원천 결과 확인Screen;
