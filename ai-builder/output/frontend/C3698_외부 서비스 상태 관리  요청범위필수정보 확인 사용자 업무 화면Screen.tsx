/**
 * Contract: #3698 | Route: /generated/external-service-status/external-service-status-s1
 * Process: EXTERNAL_SERVICE_STATUS | Actor: SYSTEM_INTEGRATOR
 * Screen: 외부 서비스 상태 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.062442
 */
...
export const C3698_외부 서비스 상태 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="외부 서비스 상태 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SERVICE_STATUS | Actor: SYSTEM_INTEGRATOR | Contract: #3698
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3698_외부 서비스 상태 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
