/**
 * Contract: #3451 | Route: /admin/generated/certificate-review-issuance/certificate-review-issuance-s1
 * Process: CERTIFICATE_REVIEW_ISSUANCE | Actor: CERTIFICATE_OFFICER
 * Screen: 인증서 검토·발급 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.056498
 */
...
// CERTIFICATE_REVIEW_ISSUANCE_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3451_인증서 검토발급  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: CERTIFICATE_REVIEW_ISSUANCE_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="인증서 검토·발급 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CERTIFICATE_REVIEW_ISSUANCE | Actor: CERTIFICATE_OFFICER | Contract: #3451
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3451_인증서 검토발급  요청범위필수정보 확인 관리자 업무 화면Screen;
