/**
 * Contract: #3525 | Route: /admin/generated/integration-failure-retry/integration-failure-retry-s2
 * Process: INTEGRATION_FAILURE_RETRY | Actor: SYSTEM_INTEGRATOR
 * Screen: 연계 실패·재시도 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.058195
 */
...
// INTEGRATION_FAILURE_RETRY_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3525_연계 실패재시도  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: INTEGRATION_FAILURE_RETRY_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="연계 실패·재시도 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: INTEGRATION_FAILURE_RETRY | Actor: SYSTEM_INTEGRATOR | Contract: #3525
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3525_연계 실패재시도  업무 실행중간 결과 저장 관리자 업무 화면Screen;
