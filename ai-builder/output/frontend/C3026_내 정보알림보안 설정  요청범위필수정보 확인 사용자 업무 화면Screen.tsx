...
export const C3026_내 정보알림보안 설정  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="내 정보·알림·보안 설정 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROFILE_MANAGEMENT | Actor: MEMBER_USER | Contract: #3026
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3026_내 정보알림보안 설정  요청범위필수정보 확인 사용자 업무 화면Screen;
