/**
 * Contract: #3437 | Route: /admin/generated/report-generation/report-generation-s2
 * Process: REPORT_GENERATION | Actor: CALCULATOR
 * Screen: 보고서 생성·미리보기 - 업무 실행·중간 결과 저장 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.056180
 */
...
// REPORT_GENERATION_EXECUTE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3437_보고서 생성미리보기  업무 실행중간 결과 저장 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: REPORT_GENERATION_EXECUTE
  ...
  return (
    <Card>
      <CardHeader title="보고서 생성·미리보기 - 업무 실행·중간 결과 저장 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_GENERATION | Actor: CALCULATOR | Contract: #3437
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3437_보고서 생성미리보기  업무 실행중간 결과 저장 관리자 업무 화면Screen;
