/**
 * Contract: #3780 | Route: /generated/pcr-epd-verification/pcr-epd-verification-s1
 * Process: PCR_EPD_VERIFICATION | Actor: LCA_PRACTITIONER
 * Screen: 제품 분류·PCR 탐색 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064621
 */
...
export const C3780_제품 분류PCR 탐색 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="제품 분류·PCR 탐색 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PCR_EPD_VERIFICATION | Actor: LCA_PRACTITIONER | Contract: #3780
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3780_제품 분류PCR 탐색 사용자 업무 화면Screen;
