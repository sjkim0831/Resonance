/**
 * Contract: #312 | Route: /ccus/facility/facility-operation-monitoring?step=fom_operate
 * Process: FACILITY_OPERATION_MONITORING | Actor: FACILITY_OPERATOR
 * Screen: 운전·알람·조치 기록 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040832
 */
...
export const C312_운전알람조치 기록 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="운전·알람·조치 기록 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: FACILITY_OPERATION_MONITORING | Actor: FACILITY_OPERATOR | Contract: #312
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C312_운전알람조치 기록 사용자 업무 화면Screen;
