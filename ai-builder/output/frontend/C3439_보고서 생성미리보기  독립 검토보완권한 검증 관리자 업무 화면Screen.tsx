/**
 * Contract: #3439 | Route: /admin/generated/report-generation/report-generation-s3
 * Process: REPORT_GENERATION | Actor: VERIFIER
 * Screen: 보고서 생성·미리보기 - 독립 검토·보완·권한 검증 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.056228
 */
...
// REPORT_GENERATION_REVIEW: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3439_보고서 생성미리보기  독립 검토보완권한 검증 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="보고서 생성·미리보기 - 독립 검토·보완·권한 검증 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REPORT_GENERATION | Actor: VERIFIER | Contract: #3439
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3439_보고서 생성미리보기  독립 검토보완권한 검증 관리자 업무 화면Screen;
