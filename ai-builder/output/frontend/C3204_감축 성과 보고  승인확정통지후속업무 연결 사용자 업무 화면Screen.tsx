/**
 * Contract: #3204 | Route: /generated/reduction-reporting/reduction-reporting-s4
 * Process: REDUCTION_REPORTING | Actor: APPROVER
 * Screen: 감축 성과 보고 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.050223
 */
...
export const C3204_감축 성과 보고  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 성과 보고 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_REPORTING | Actor: APPROVER | Contract: #3204
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3204_감축 성과 보고  승인확정통지후속업무 연결 사용자 업무 화면Screen;
