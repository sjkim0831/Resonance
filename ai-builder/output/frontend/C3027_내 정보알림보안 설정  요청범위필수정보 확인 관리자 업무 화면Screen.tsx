...
// PROFILE_MANAGEMENT_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3027_내 정보알림보안 설정  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: PROFILE_MANAGEMENT_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="내 정보·알림·보안 설정 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROFILE_MANAGEMENT | Actor: MEMBER_USER | Contract: #3027
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3027_내 정보알림보안 설정  요청범위필수정보 확인 관리자 업무 화면Screen;
