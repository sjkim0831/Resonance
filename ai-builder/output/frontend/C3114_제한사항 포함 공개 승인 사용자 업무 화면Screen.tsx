/**
 * Contract: #3114 | Route: /generated/comparative-assertion-review/comparative-assertion-review-s4
 * Process: COMPARATIVE_ASSERTION_REVIEW | Actor: APPROVER
 * Screen: 제한사항 포함 공개 승인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.048222
 */
...
export const C3114_제한사항 포함 공개 승인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="제한사항 포함 공개 승인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: COMPARATIVE_ASSERTION_REVIEW | Actor: APPROVER | Contract: #3114
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3114_제한사항 포함 공개 승인 사용자 업무 화면Screen;
