/**
 * Contract: #3554 | Route: /generated/outlier-rule-management/outlier-rule-management-s1
 * Process: OUTLIER_RULE_MANAGEMENT | Actor: DATA_ANALYST
 * Screen: 이상치 규칙 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.058853
 */
...
export const C3554_이상치 규칙 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="이상치 규칙 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: OUTLIER_RULE_MANAGEMENT | Actor: DATA_ANALYST | Contract: #3554
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3554_이상치 규칙 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
