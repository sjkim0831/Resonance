/**
 * Contract: #702 | Route: /admin/system/process-workspace
 * Process: PLATFORM_OPERATION | Actor: PLATFORM_OPERATOR
 * Screen: 콘텐츠·교육·지원 운영 통합 작업공간
 * Generated: 2026-07-25T06:45:29.044023
 */
...
export const C702_콘텐츠교육지원 운영 통합 작업공간Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="콘텐츠·교육·지원 운영 통합 작업공간" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PLATFORM_OPERATION | Actor: PLATFORM_OPERATOR | Contract: #702
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C702_콘텐츠교육지원 운영 통합 작업공간Screen;
