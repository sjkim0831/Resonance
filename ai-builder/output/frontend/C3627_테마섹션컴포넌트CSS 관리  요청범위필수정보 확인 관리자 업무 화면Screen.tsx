/**
 * Contract: #3627 | Route: /admin/generated/design-asset-governance/design-asset-governance-s1
 * Process: DESIGN_ASSET_GOVERNANCE | Actor: PLATFORM_OPERATOR
 * Screen: 테마·섹션·컴포넌트·CSS 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.060636
 */
...
// DESIGN_ASSET_GOVERNANCE_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3627_테마섹션컴포넌트CSS 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: DESIGN_ASSET_GOVERNANCE_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="테마·섹션·컴포넌트·CSS 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DESIGN_ASSET_GOVERNANCE | Actor: PLATFORM_OPERATOR | Contract: #3627
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3627_테마섹션컴포넌트CSS 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
