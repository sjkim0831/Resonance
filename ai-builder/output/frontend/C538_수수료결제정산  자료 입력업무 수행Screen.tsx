/**
 * Contract: #538 | Route: /admin/system/process-workspace?process=PAYMENT_SETTLEMENT&step=PAYMENT_SETTLEMENT_02_WORK
 * Process: PAYMENT_SETTLEMENT | Actor: SITE_DATA_OWNER
 * Screen: 수수료·결제·정산 - 자료 입력·업무 수행
 * Generated: 2026-07-25T06:45:29.043004
 */
...
export const C538_수수료결제정산  자료 입력업무 수행Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="수수료·결제·정산 - 자료 입력·업무 수행" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PAYMENT_SETTLEMENT | Actor: SITE_DATA_OWNER | Contract: #538
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C538_수수료결제정산  자료 입력업무 수행Screen;
