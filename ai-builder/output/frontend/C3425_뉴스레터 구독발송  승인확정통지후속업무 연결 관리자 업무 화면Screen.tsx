/**
 * Contract: #3425 | Route: /admin/generated/newsletter-operation/newsletter-operation-s4
 * Process: NEWSLETTER_OPERATION | Actor: APPROVER
 * Screen: 뉴스레터 구독·발송 - 승인·확정·통지·후속업무 연결 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.055892
 */
...
// NEWSLETTER_OPERATION_COMPLETE: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3425_뉴스레터 구독발송  승인확정통지후속업무 연결 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: NEWSLETTER_OPERATION_COMPLETE
  ...
  return (
    <Card>
      <CardHeader title="뉴스레터 구독·발송 - 승인·확정·통지·후속업무 연결 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: NEWSLETTER_OPERATION | Actor: APPROVER | Contract: #3425
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3425_뉴스레터 구독발송  승인확정통지후속업무 연결 관리자 업무 화면Screen;
