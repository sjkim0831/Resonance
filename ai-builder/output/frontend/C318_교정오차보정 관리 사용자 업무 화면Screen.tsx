/**
 * Contract: #318 | Route: /ccus/facility/meter-calibration-management?step=mcm_calibrate
 * Process: METER_CALIBRATION_MANAGEMENT | Actor: INSTRUMENT_ENGINEER
 * Screen: 교정·오차·보정 관리 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040957
 */
...
export const C318_교정오차보정 관리 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교정·오차·보정 관리 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: METER_CALIBRATION_MANAGEMENT | Actor: INSTRUMENT_ENGINEER | Contract: #318
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C318_교정오차보정 관리 사용자 업무 화면Screen;
