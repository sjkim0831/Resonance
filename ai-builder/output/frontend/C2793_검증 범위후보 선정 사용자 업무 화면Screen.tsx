/**
 * Contract: #2793 | Route: /generated/external-verification-engagement/external-verification-engagement-s1
 * Process: EXTERNAL_VERIFICATION_ENGAGEMENT | Actor: COMPANY_MANAGER
 * Screen: 검증 범위·후보 선정 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.044609
 */
...
export const C2793_검증 범위후보 선정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="검증 범위·후보 선정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_VERIFICATION_ENGAGEMENT | Actor: COMPANY_MANAGER | Contract: #2793
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2793_검증 범위후보 선정 사용자 업무 화면Screen;
