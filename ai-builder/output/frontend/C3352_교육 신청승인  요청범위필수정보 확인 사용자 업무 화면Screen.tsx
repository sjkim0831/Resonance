/**
 * Contract: #3352 | Route: /generated/education-application/education-application-s1
 * Process: EDUCATION_APPLICATION | Actor: MEMBER_USER
 * Screen: 교육 신청·승인 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053702
 */
...
export const C3352_교육 신청승인  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 신청·승인 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_APPLICATION | Actor: MEMBER_USER | Contract: #3352
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3352_교육 신청승인  요청범위필수정보 확인 사용자 업무 화면Screen;
