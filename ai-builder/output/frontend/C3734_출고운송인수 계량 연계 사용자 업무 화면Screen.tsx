/**
 * Contract: #3734 | Route: /generated/chain-of-custody/chain-of-custody-s2
 * Process: CHAIN_OF_CUSTODY | Actor: SYSTEM_INTEGRATOR
 * Screen: 출고·운송·인수 계량 연계 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063505
 */
...
export const C3734_출고운송인수 계량 연계 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="출고·운송·인수 계량 연계 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CHAIN_OF_CUSTODY | Actor: SYSTEM_INTEGRATOR | Contract: #3734
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3734_출고운송인수 계량 연계 사용자 업무 화면Screen;
