/**
 * Contract: #5 | Route: /emission/activity-data
 * Process: EMISSION_PROJECT | Actor: SITE_DATA_OWNER
 * Screen: 활동자료·증빙 수집 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.039147
 */
...
export const C5_활동자료증빙 수집 사용자 업무 화면Screen = () => {
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_PROJECT | Actor: SITE_DATA_OWNER | Contract: #5
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C5_활동자료증빙 수집 사용자 업무 화면Screen;
