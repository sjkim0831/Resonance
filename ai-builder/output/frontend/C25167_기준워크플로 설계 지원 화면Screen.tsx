/**
 * Contract: #25167 | Route: /admin/system/actor-process
 * Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR
 * Screen: 기준·워크플로 설계 지원 화면
 * Generated: 2026-07-25T06:45:29.065029
 */
...
export const C25167_기준워크플로 설계 지원 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="기준·워크플로 설계 지원 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR | Contract: #25167
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C25167_기준워크플로 설계 지원 화면Screen;
