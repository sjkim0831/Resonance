/**
 * Contract: #121 | Route: /emission/project/detail
 * Process: EMISSION_CALCULATION | Actor: COMPANY_MANAGER
 * Screen: 산정 계획·범위 확인
 * Generated: 2026-07-25T06:45:29.039744
 */
...
export const C121_산정 계획범위 확인Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // POST: emission-projects
      const r = await fetch('/home/api/emission-projects',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(formData)});
  ...
  return (
    <Card>
      <CardHeader title="산정 계획·범위 확인" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EMISSION_CALCULATION | Actor: COMPANY_MANAGER | Contract: #121
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C121_산정 계획범위 확인Screen;
