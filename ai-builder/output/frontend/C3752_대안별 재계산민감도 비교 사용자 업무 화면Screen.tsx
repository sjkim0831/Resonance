/**
 * Contract: #3752 | Route: /generated/lca-allocation-sensitivity/lca-allocation-sensitivity-s3
 * Process: LCA_ALLOCATION_SENSITIVITY | Actor: VERIFIER
 * Screen: 대안별 재계산·민감도 비교 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.063926
 */
...
export const C3752_대안별 재계산민감도 비교 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="대안별 재계산·민감도 비교 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: LCA_ALLOCATION_SENSITIVITY | Actor: VERIFIER | Contract: #3752
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3752_대안별 재계산민감도 비교 사용자 업무 화면Screen;
