/**
 * Contract: #241 | Route: /emission/activity-data
 * Process: CUSTOMER_WORK_COORDINATION | Actor: SITE_DATA_OWNER
 * Screen: 활동자료 수집·제출
 * Generated: 2026-07-25T06:45:29.040269
 */
...
export const C241_활동자료 수집제출Screen = () => {
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: CUSTOMER_WORK_COORDINATION | Actor: SITE_DATA_OWNER | Contract: #241
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C241_활동자료 수집제출Screen;
