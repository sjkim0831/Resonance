/**
 * Contract: #3699 | Route: /admin/generated/external-service-status/external-service-status-s1
 * Process: EXTERNAL_SERVICE_STATUS | Actor: SYSTEM_INTEGRATOR
 * Screen: 외부 서비스 상태 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.062466
 */
...
// EXTERNAL_SERVICE_STATUS_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3699_외부 서비스 상태 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: EXTERNAL_SERVICE_STATUS_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="외부 서비스 상태 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EXTERNAL_SERVICE_STATUS | Actor: SYSTEM_INTEGRATOR | Contract: #3699
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3699_외부 서비스 상태 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
