/**
 * Contract: #513 | Route: /emission/organizational-boundary
 * Process: ORGANIZATIONAL_BOUNDARY | Actor: COMPANY_MANAGER
 * Screen: 경계 기준·포함 여부 판정 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.042387
 */
...
export const C513_경계 기준포함 여부 판정 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="경계 기준·포함 여부 판정 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ORGANIZATIONAL_BOUNDARY | Actor: COMPANY_MANAGER | Contract: #513
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C513_경계 기준포함 여부 판정 사용자 업무 화면Screen;
