/**
 * Contract: #3126 | Route: /generated/user-authority-assignment/user-authority-assignment-s2
 * Process: USER_AUTHORITY_ASSIGNMENT | Actor: AUTHORITY_ADMIN
 * Screen: 사용자별 권한 배정 - 업무 실행·중간 결과 저장 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.048488
 */
...
export const C3126_사용자별 권한 배정  업무 실행중간 결과 저장 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="사용자별 권한 배정 - 업무 실행·중간 결과 저장 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: USER_AUTHORITY_ASSIGNMENT | Actor: AUTHORITY_ADMIN | Contract: #3126
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3126_사용자별 권한 배정  업무 실행중간 결과 저장 사용자 업무 화면Screen;
