/**
 * Contract: #2992 | Route: /join/companyJoinStatusDetail
 * Process: MEMBER_APPROVAL | Actor: VERIFIER
 * Screen: 가입 검토·승인·반려 - 독립 검토·보완·권한 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.045572
 */
...
// MEMBER_APPROVAL_REVIEW: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2992_가입 검토승인반려  독립 검토보완권한 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="가입 검토·승인·반려 - 독립 검토·보완·권한 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_APPROVAL | Actor: VERIFIER | Contract: #2992
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2992_가입 검토승인반려  독립 검토보완권한 검증 사용자 업무 화면Screen;
