/**
 * Contract: #3133 | Route: /admin/generated/menu-access-control/menu-access-control-s1
 * Process: MENU_ACCESS_CONTROL | Actor: AUTHORITY_ADMIN
 * Screen: 메뉴 접근 권한 관리 - 요청·범위·필수정보 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.048671
 */
...
// MENU_ACCESS_CONTROL_REQUEST: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C3133_메뉴 접근 권한 관리  요청범위필수정보 확인 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const d = await r.json(); setData(d);
      // POST: MENU_ACCESS_CONTROL_REQUEST
  ...
  return (
    <Card>
      <CardHeader title="메뉴 접근 권한 관리 - 요청·범위·필수정보 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MENU_ACCESS_CONTROL | Actor: AUTHORITY_ADMIN | Contract: #3133
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3133_메뉴 접근 권한 관리  요청범위필수정보 확인 관리자 업무 화면Screen;
