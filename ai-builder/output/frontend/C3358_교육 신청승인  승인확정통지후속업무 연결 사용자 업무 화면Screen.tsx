/**
 * Contract: #3358 | Route: /generated/education-application/education-application-s4
 * Process: EDUCATION_APPLICATION | Actor: APPROVER
 * Screen: 교육 신청·승인 - 승인·확정·통지·후속업무 연결 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053904
 */
...
export const C3358_교육 신청승인  승인확정통지후속업무 연결 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="교육 신청·승인 - 승인·확정·통지·후속업무 연결 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: EDUCATION_APPLICATION | Actor: APPROVER | Contract: #3358
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3358_교육 신청승인  승인확정통지후속업무 연결 사용자 업무 화면Screen;
