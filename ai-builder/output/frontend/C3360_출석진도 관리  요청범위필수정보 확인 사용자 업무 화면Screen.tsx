/**
 * Contract: #3360 | Route: /generated/attendance-progress/attendance-progress-s1
 * Process: ATTENDANCE_PROGRESS | Actor: EDUCATION_MANAGER
 * Screen: 출석·진도 관리 - 요청·범위·필수정보 확인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.053961
 */
...
export const C3360_출석진도 관리  요청범위필수정보 확인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="출석·진도 관리 - 요청·범위·필수정보 확인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: ATTENDANCE_PROGRESS | Actor: EDUCATION_MANAGER | Contract: #3360
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3360_출석진도 관리  요청범위필수정보 확인 사용자 업무 화면Screen;
