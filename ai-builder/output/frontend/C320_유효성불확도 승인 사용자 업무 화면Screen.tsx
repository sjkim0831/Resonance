/**
 * Contract: #320 | Route: /ccus/facility/meter-calibration-management?step=mcm_approve
 * Process: METER_CALIBRATION_MANAGEMENT | Actor: HSE_MANAGER
 * Screen: 유효성·불확도 승인 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.040998
 */
...
export const C320_유효성불확도 승인 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="유효성·불확도 승인 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: METER_CALIBRATION_MANAGEMENT | Actor: HSE_MANAGER | Contract: #320
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C320_유효성불확도 승인 사용자 업무 화면Screen;
