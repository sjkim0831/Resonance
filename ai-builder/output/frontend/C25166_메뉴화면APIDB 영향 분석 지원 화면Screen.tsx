/**
 * Contract: #25166 | Route: /admin/system/design-governance
 * Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR
 * Screen: 메뉴·화면·API·DB 영향 분석 지원 화면
 * Generated: 2026-07-25T06:45:29.065010
 */
...
export const C25166_메뉴화면APIDB 영향 분석 지원 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="메뉴·화면·API·DB 영향 분석 지원 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: GOVERNANCE_CHANGE | Actor: PLATFORM_OPERATOR | Contract: #25166
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C25166_메뉴화면APIDB 영향 분석 지원 화면Screen;
