/**
 * Contract: #2967 | Route: /admin/generated/member-registration/member-registration-s3
 * Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT
 * Screen: 본인 확인 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.044985
 */
...
// VERIFY_IDENTITY: POST /home/api/process-executions/{executionId}/commands
// LOAD_DRAFT: GET /home/api/process-executions/draft
// SAVE_DRAFT: PUT /home/api/process-executions/draft

export const C2967_본인 확인 관리자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="본인 확인 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: MEMBER_REGISTRATION | Actor: PUBLIC_APPLICANT | Contract: #2967
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C2967_본인 확인 관리자 업무 화면Screen;
