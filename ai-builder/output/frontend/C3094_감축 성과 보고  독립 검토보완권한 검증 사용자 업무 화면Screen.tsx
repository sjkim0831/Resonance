/**
 * Contract: #3094 | Route: /generated/reduction-reporting/reduction-reporting-s3
 * Process: REDUCTION_REPORTING | Actor: VERIFIER
 * Screen: 감축 성과 보고 - 독립 검토·보완·권한 검증 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.047788
 */
...
export const C3094_감축 성과 보고  독립 검토보완권한 검증 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="감축 성과 보고 - 독립 검토·보완·권한 검증 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: REDUCTION_REPORTING | Actor: VERIFIER | Contract: #3094
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3094_감축 성과 보고  독립 검토보완권한 검증 사용자 업무 화면Screen;
