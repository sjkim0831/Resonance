 ...
 * Generated: 2026-07-25T06:45:29.043461
 */
...
export const C675_외부 데이터 연계  수집 실행원본 보존Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="외부 데이터 연계 - 수집 실행·원본 보존" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: DATA_INTEGRATION | Actor: SYSTEM_INTEGRATOR | Contract: #675
            </Typography>
            <Divider sx={ my: 2 } />
