/**
 * Contract: #323 | Route: /admin/ccus/facility/preventive-maintenance?step=pm_plan
 * Process: PREVENTIVE_MAINTENANCE | Actor: MAINTENANCE_ENGINEER
 * Screen: 위험기반 정비계획 관리자 업무 화면
 * Generated: 2026-07-25T06:45:29.041216
 */
...
export const C323_위험기반 정비계획 관리자 업무 화면Screen = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      // GET: pm_plan
      const r = await fetch('/api/ccus/facility/preventive-maintenance/pm_plan');
  ...
  return (
    <Card>
      <CardHeader title="위험기반 정비계획 관리자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PREVENTIVE_MAINTENANCE | Actor: MAINTENANCE_ENGINEER | Contract: #323
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C323_위험기반 정비계획 관리자 업무 화면Screen;
