/**
 * Contract: #3794 | Route: /generated/project-lifecycle-control/project-lifecycle-control-s4
 * Process: PROJECT_LIFECYCLE_CONTROL | Actor: APPROVER
 * Screen: 종료·보관·재개·취소 실행 사용자 업무 화면
 * Generated: 2026-07-25T06:45:29.064922
 */
...
export const C3794_종료보관재개취소 실행 사용자 업무 화면Screen = () => {
  ...
  return (
    <Card>
      <CardHeader title="종료·보관·재개·취소 실행 사용자 업무 화면" subheader="Contract-based" />
      <CardContent>
        ...
        {!error && screenState !== 'LOADING' && (
          <Box>
            <Typography variant="body2" color="textSecondary">
              Process: PROJECT_LIFECYCLE_CONTROL | Actor: APPROVER | Contract: #3794
            </Typography>
            <Divider sx={ my: 2 } />
...
export default C3794_종료보관재개취소 실행 사용자 업무 화면Screen;
