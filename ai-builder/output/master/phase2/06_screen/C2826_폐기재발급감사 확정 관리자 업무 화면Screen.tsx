 ...
 * Generated: 2026-07-25T09:34:04.560555
 */
...
export const C2826_폐기재발급감사 확정 관리자 업무 화면Screen = () => {
  ...
  const [screenState, setScreenState] = useState("VERIFIED, LOADING, EMPTY, READY, SAVING");
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">폐기·재발급·감사 확정 관리자 업무 화면</Typography>
