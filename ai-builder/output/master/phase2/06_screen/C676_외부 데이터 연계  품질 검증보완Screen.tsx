/**
 * Screen: 외부 데이터 연계 - 품질 검증·보완
 * Contract: #676 | Route: /admin/system/process-workspace
 * Generated: 2026-07-25T09:34:04.558717
 */
...
export const C676_외부 데이터 연계  품질 검증보완Screen = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">외부 데이터 연계 - 품질 검증·보완</Typography>
...
export default C676_외부 데이터 연계  품질 검증보완Screen;