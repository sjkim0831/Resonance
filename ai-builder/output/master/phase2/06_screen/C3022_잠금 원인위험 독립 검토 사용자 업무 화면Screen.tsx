 ...
 * Generated: 2026-07-25T09:34:04.562506
 */
...
// GET /admin/api/member-recovery/{requestId}
// POST /admin/api/member-recovery/{requestId}/review
...
export const C3022_잠금 원인위험 독립 검토 사용자 업무 화면Screen = () => {
  ...
  const [screenState, setScreenState] = useState("IDENTITY_VERIFIED, LOADING, EMPTY, READY, SAVING");
