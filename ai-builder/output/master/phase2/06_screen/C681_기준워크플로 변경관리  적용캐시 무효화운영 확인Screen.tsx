 ...
 * Contract: #681 | Route: /admin/system/process-workspace
 * Generated: 2026-07-25T09:34:04.558920
 */
...
export const C681_기준워크플로 변경관리  적용캐시 무효화운영 확인Screen = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">기준·워크플로 변경관리 - 적용·캐시 무효화·운영 확인</Typography>
...
export default C681_기준워크플로 변경관리  적용캐시 무효화운영 확인Screen;