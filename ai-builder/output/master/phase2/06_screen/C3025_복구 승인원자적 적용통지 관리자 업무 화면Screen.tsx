 ...
 * Generated: 2026-07-25T09:34:04.562596
 */
...
// POST /admin/api/member-recovery/{requestId}/complete
...
export const C3025_복구 승인원자적 적용통지 관리자 업무 화면Screen = () => {
  ...
  const [screenState, setScreenState] = useState("REVIEW_APPROVED, LOADING, EMPTY, READY, SAVING");
