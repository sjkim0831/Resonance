 ...
 * Generated: 2026-07-25T09:34:04.560492
 */
...
export const C2824_공개 진위OCR시각지문 검증 관리자 업무 화면Screen = () => {
  ...
  const [screenState, setScreenState] = useState("ISSUED, LOADING, EMPTY, READY, SAVING");
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">공개 진위·OCR·시각지문 검증 관리자 업무 화면</Typography>
