/**
 * Screen: 외부 데이터 연계 - 수집 실행·원본 보존
 * Contract: #675 | Route: /admin/system/process-workspace
 * Generated: 2026-07-25T09:34:04.558673
 */
...
export const C675_외부 데이터 연계  수집 실행원본 보존Screen = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">외부 데이터 연계 - 수집 실행·원본 보존</Typography>
...
export default C675_외부 데이터 연계  수집 실행원본 보존Screen;