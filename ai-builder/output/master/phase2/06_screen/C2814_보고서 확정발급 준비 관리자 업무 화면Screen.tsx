 ...
 * Generated: 2026-07-25T09:34:04.560436
 */
...
export const C2814_보고서 확정발급 준비 관리자 업무 화면Screen = () => {
  ...
  const [screenState, setScreenState] = useState("APPROVED, LOADING, EMPTY, READY, SAVING");
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">보고서 확정·발급 준비 관리자 업무 화면</Typography>
