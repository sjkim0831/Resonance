/**
 * Screen: 변경 요청·근거 등록 관리자 업무 화면
 * Contract: #24180 | Route: /admin/system/process-workspace?process=GOVERNANCE_CHANGE&step=GOV_REQUEST
 * Generated: 2026-07-25T09:34:04.587019
 */
...
// GET /admin/api/system/actor-process/cases
// GET /home/api/process-executions
// GET /home/api/process-executions/screen-contract

export const C24180_변경 요청근거 등록 관리자 업무 화면Screen = () => {
  const navigate = useNavigate();
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState(null);
  const [formData, setFormData] = useState({});
  const [screenState, setScreenState] = useState("DRAFT, LOADING, EMPTY, READY, SAVING");
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">변경 요청·근거 등록 관리자 업무 화면</Typography>
...
export default C24180_변경 요청근거 등록 관리자 업무 화면Screen;