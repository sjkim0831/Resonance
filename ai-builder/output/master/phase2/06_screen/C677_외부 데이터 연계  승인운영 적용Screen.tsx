/**
 * Screen: 외부 데이터 연계 - 승인·운영 적용
 * Contract: #677 | Route: /admin/system/process-workspace
 * Generated: 2026-07-25T09:34:04.558757
 */
...
export const C677_외부 데이터 연계  승인운영 적용Screen = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">외부 데이터 연계 - 승인·운영 적용</Typography>
...
export default C677_외부 데이터 연계  승인운영 적용Screen;