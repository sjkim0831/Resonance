/**
 * Screen: 전문 업무 실행
 * Contract: #744 | Route: /work/execution
 * Generated: 2026-07-25T09:34:04.559977
 */
...
// PUT /home/api/process-executions/draft
// GET /home/api/process-executions
// POST /home/api/process-executions/start

export const C744_전문 업무 실행Screen = () => {
  const navigate = useNavigate();
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState(null);
  const [formData, setFormData] = useState({});
  const [screenState, setScreenState] = useState("LOADING, NOT_SAVED, DRAFT, READY, SAVING");
        ...
        <Box>
          <Paper sx={{ mb: 2 }}>
            <Tabs value={activeTab} onChange={(_, v) => setActiveTab(v)}>
              ...
              <Tab key=6 label="Section 7" />
              <Tab key=7 label="Section 8" />
            </Tabs>
          </Paper>
          <Card>
...
export default C744_전문 업무 실행Screen;