...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=b60dfed40c0e5fe36ecde2e984c7bcadf2a33110f117e36576d951cdb7301462;endpointHash=77f9932014852cbb120290f6355a458d8cf84b945bee618075c405c0312909c6")
public final class Opbf9a9038d8c549132a9c379d123e26fb277bdf5fController {
    ...
    public Opbf9a9038d8c549132a9c379d123e26fb277bdf5fController(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_project_approval/reduction_project_approval_s2/admin", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Opbf9a9038d8c549132a9c379d123e26fb277bdf5fRequest request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.decidedAt()==null || request.decidedAt().isBlank() || request.decisionCode()==null || request.decisionCode().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.rejectionReasonCode()==null || request.rejectionReasonCode().isBlank() || request.reviewComment()==null || request.reviewComment().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"APPROVER".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("stepCode","REDUCTION_PROJECT_APPROVAL_S2");
        payload.put("commandCode","REDUCTION_PROJECT_APPROVAL_EXECUTE");
        payload.put("routePath","/admin/generated/reduction-project-approval/reduction-project-approval-s2");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Opbf9a9038d8c549132a9c379d123e26fb277bdf5fRecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Opbf9a9038d8c549132a9c379d123e26fb277bdf5fRecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Opbf9a9038d8c549132a9c379d123e26fb277bdf5fSuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Opbf9a9038d8c549132a9c379d123e26fb277bdf5fSuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Opbf9a9038d8c549132a9c379d123e26fb277bdf5fErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
