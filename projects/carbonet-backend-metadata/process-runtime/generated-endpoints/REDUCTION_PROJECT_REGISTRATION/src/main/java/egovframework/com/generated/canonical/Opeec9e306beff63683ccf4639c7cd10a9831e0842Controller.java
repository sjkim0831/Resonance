...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=a539f036650ac1d505869c26b3d7ef22347db116308d5da7debd6271b3ad204f;endpointHash=f95cae5eed8981972ca92b04cb5b8af71c42becec69416b6f0f424d88028282c")
public final class Opeec9e306beff63683ccf4639c7cd10a9831e0842Controller {
    ...
    public Opeec9e306beff63683ccf4639c7cd10a9831e0842Controller(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_project_registration/reduction_project_registration_s4/admin", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Opeec9e306beff63683ccf4639c7cd10a9831e0842Request request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.decidedAt()==null || request.decidedAt().isBlank() || request.decisionCode()==null || request.decisionCode().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.rejectionReasonCode()==null || request.rejectionReasonCode().isBlank() || request.reviewComment()==null || request.reviewComment().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"APPROVER".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("routePath","/admin/generated/reduction-project-registration/reduction-project-registration-s4");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Opeec9e306beff63683ccf4639c7cd10a9831e0842RecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Opeec9e306beff63683ccf4639c7cd10a9831e0842RecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Opeec9e306beff63683ccf4639c7cd10a9831e0842SuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Opeec9e306beff63683ccf4639c7cd10a9831e0842SuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Opeec9e306beff63683ccf4639c7cd10a9831e0842ErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
