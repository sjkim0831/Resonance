...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=bc557d217919011567bb58da2dea75ee5c30e809f44ba4f7d741dc230c27b324;endpointHash=1257f4bf6aed48cfffcb1de05586e32a6d2a931ab858a401b1f0c85cfd11b06c")
public final class Op59ca8f781ce8d13b0ce41b07250ee62191071d88Controller {
    ...
    public Op59ca8f781ce8d13b0ce41b07250ee62191071d88Controller(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_scenario/reduction_scenario_s1/user", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Op59ca8f781ce8d13b0ce41b07250ee62191071d88Request request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.dueAt()==null || request.dueAt().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.nextActorCode()==null || request.nextActorCode().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.taskComment()==null || request.taskComment().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"DATA_ANALYST".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("routePath","/generated/reduction-scenario/reduction-scenario-s1");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Op59ca8f781ce8d13b0ce41b07250ee62191071d88RecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Op59ca8f781ce8d13b0ce41b07250ee62191071d88RecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Op59ca8f781ce8d13b0ce41b07250ee62191071d88SuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Op59ca8f781ce8d13b0ce41b07250ee62191071d88SuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Op59ca8f781ce8d13b0ce41b07250ee62191071d88ErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
