...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=b5ad90664d8eb97569122fc7a1ff780072864ccda7b63c21082cc99cefa4dd29;endpointHash=ba20121a37be5e30befcc734205d258d113d250c9ddc63769ec1845eebf686dd")
public final class Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764Controller {
    ...
    public Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764Controller(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_scenario/reduction_scenario_s1/admin", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764Request request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.dueAt()==null || request.dueAt().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.nextActorCode()==null || request.nextActorCode().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.taskComment()==null || request.taskComment().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"DATA_ANALYST".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("stepCode","REDUCTION_SCENARIO_S1");
        payload.put("commandCode","REDUCTION_SCENARIO_REQUEST");
        payload.put("routePath","/admin/generated/reduction-scenario/reduction-scenario-s1");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764RecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764RecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764SuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764SuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Op11423ed7ca5d7823ba6b5be6a30e1eeacece2764ErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
