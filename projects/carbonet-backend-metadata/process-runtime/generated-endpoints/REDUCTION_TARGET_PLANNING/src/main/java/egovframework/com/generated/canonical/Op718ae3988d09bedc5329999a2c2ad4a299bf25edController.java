...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=b6726727f1e19da80558b520a05ca3ed3dbea6c6282f8ee754548c90247d82e5;endpointHash=16a7a0ae3724765b697d8db3dba2474f7a96f83e157edac47ac8842499f9fd58")
public final class Op718ae3988d09bedc5329999a2c2ad4a299bf25edController {
    ...
    public Op718ae3988d09bedc5329999a2c2ad4a299bf25edController(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_target_planning/reduction_target_planning_s3/admin", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Op718ae3988d09bedc5329999a2c2ad4a299bf25edRequest request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.decidedAt()==null || request.decidedAt().isBlank() || request.decisionCode()==null || request.decisionCode().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.rejectionReasonCode()==null || request.rejectionReasonCode().isBlank() || request.reviewComment()==null || request.reviewComment().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"VERIFIER".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("stepCode","REDUCTION_TARGET_PLANNING_S3");
        payload.put("commandCode","REDUCTION_TARGET_PLANNING_REVIEW");
        payload.put("routePath","/admin/generated/reduction-target-planning/reduction-target-planning-s3");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Op718ae3988d09bedc5329999a2c2ad4a299bf25edRecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Op718ae3988d09bedc5329999a2c2ad4a299bf25edRecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Op718ae3988d09bedc5329999a2c2ad4a299bf25edSuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Op718ae3988d09bedc5329999a2c2ad4a299bf25edSuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Op718ae3988d09bedc5329999a2c2ad4a299bf25edErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
