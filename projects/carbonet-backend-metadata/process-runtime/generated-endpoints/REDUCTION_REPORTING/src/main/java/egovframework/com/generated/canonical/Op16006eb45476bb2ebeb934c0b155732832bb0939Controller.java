...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=14d24325f75d610cfe253d9cfddf3b6da1a72a328d48ff59bd1026e65d70adbe;endpointHash=53f401a8283cbfbd9993fe9cc5c6de673f79243be1784a84dd4c279eb3d3563b")
public final class Op16006eb45476bb2ebeb934c0b155732832bb0939Controller {
    ...
    public Op16006eb45476bb2ebeb934c0b155732832bb0939Controller(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_reporting/reduction_reporting_s1/admin", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Op16006eb45476bb2ebeb934c0b155732832bb0939Request request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.documentHash()==null || request.documentHash().isBlank() || request.documentVersion()==null || request.downloadFormat()==null || request.downloadFormat().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.languageCode()==null || request.languageCode().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"REDUCTION_MANAGER".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("routePath","/admin/generated/reduction-reporting/reduction-reporting-s1");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Op16006eb45476bb2ebeb934c0b155732832bb0939RecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Op16006eb45476bb2ebeb934c0b155732832bb0939RecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Op16006eb45476bb2ebeb934c0b155732832bb0939SuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Op16006eb45476bb2ebeb934c0b155732832bb0939SuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Op16006eb45476bb2ebeb934c0b155732832bb0939ErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
