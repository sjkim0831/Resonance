...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=cd3744476ed500779ba7b5d488ed40efbab1d0dd54cdd0f0f4387dccf14ff799;endpointHash=9480162d0886d2e5b7cdd0ff3d8d855ccf951e44013355889c5c942ef77bba59")
public final class Op3e54778277f31ba9a04b2efc783b87567161aa63Controller {
    ...
    public Op3e54778277f31ba9a04b2efc783b87567161aa63Controller(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_performance/reduction_performance_s4/admin", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Op3e54778277f31ba9a04b2efc783b87567161aa63Request request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.decidedAt()==null || request.decidedAt().isBlank() || request.decisionCode()==null || request.decisionCode().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.rejectionReasonCode()==null || request.rejectionReasonCode().isBlank() || request.reviewComment()==null || request.reviewComment().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"APPROVER".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("stepCode","REDUCTION_PERFORMANCE_S4");
        payload.put("commandCode","REDUCTION_PERFORMANCE_COMPLETE");
        payload.put("routePath","/admin/generated/reduction-performance/reduction-performance-s4");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Op3e54778277f31ba9a04b2efc783b87567161aa63RecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Op3e54778277f31ba9a04b2efc783b87567161aa63RecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Op3e54778277f31ba9a04b2efc783b87567161aa63SuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Op3e54778277f31ba9a04b2efc783b87567161aa63SuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Op3e54778277f31ba9a04b2efc783b87567161aa63ErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
