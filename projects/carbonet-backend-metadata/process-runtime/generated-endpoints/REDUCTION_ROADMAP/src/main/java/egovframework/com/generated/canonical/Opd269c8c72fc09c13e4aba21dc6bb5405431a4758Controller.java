...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=243c3b1d293fe011eb573d8ae496581ee49123d413606abbf05da3f11bdcc5fb;endpointHash=3011334a173bab09a94ae63b86d7d112253b7211752d1b6c1190891e0fba66af")
public final class Opd269c8c72fc09c13e4aba21dc6bb5405431a4758Controller {
    ...
    public Opd269c8c72fc09c13e4aba21dc6bb5405431a4758Controller(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_roadmap/reduction_roadmap_s4/admin", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Opd269c8c72fc09c13e4aba21dc6bb5405431a4758Request request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.decidedAt()==null || request.decidedAt().isBlank() || request.decisionCode()==null || request.decisionCode().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.rejectionReasonCode()==null || request.rejectionReasonCode().isBlank() || request.reviewComment()==null || request.reviewComment().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"APPROVER".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("routePath","/admin/generated/reduction-roadmap/reduction-roadmap-s4");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Opd269c8c72fc09c13e4aba21dc6bb5405431a4758RecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Opd269c8c72fc09c13e4aba21dc6bb5405431a4758RecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Opd269c8c72fc09c13e4aba21dc6bb5405431a4758SuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Opd269c8c72fc09c13e4aba21dc6bb5405431a4758SuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Opd269c8c72fc09c13e4aba21dc6bb5405431a4758ErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
