...
@javax.annotation.processing.Generated(value="canonical-design", comments="designHash=d13b2b7c0b1968d3f09214fd608dbf653cac2ecb8c8613d420cfc6663e60ec33;endpointHash=ae62aeb2c48eadef464c1049b7e36ea6641e1b0a900c7a964ceb9ae020cff3ea")
public final class Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757Controller {
    ...
    public Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757Controller(
    ...
    @org.springframework.web.bind.annotation.PostMapping(path="/home/api/process-executions/{executionId}/commands/reduction_roadmap/reduction_roadmap_s2/admin", consumes="application/json")
    public org.springframework.http.ResponseEntity<?> execute(
            ...
            @org.springframework.web.bind.annotation.RequestBody Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757Request request,
        ...
        if(context==null || !context.isAuthenticated() || context.getUserId()==null || context.getUserId().isBlank())
            return org.springframework.http.ResponseEntity.status(401).body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("AUTHENTICATION_REQUIRED","Authentication is required.",false));
        if(request==null || request.actorCode()==null || request.actorCode().isBlank() || request.actualReduction()==null || request.baselineEmission()==null || request.baselineYear()==null || request.baselineYear().isBlank() || request.capex()==null || request.dueAt()==null || request.dueAt().isBlank() || request.expectedReduction()==null || request.idempotencyKey()==null || request.idempotencyKey().isBlank() || request.nextActorCode()==null || request.nextActorCode().isBlank() || request.opex()==null || request.ownerActorCode()==null || request.ownerActorCode().isBlank() || request.projectId()==null || request.projectId().isBlank() || request.reductionMethod()==null || request.reductionMethod().isBlank() || request.targetReduction()==null || request.targetYear()==null || request.targetYear().isBlank() || request.taskComment()==null || request.taskComment().isBlank() || request.tenantId()==null || request.tenantId().isBlank())
            return org.springframework.http.ResponseEntity.badRequest().body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("INVALID_REQUEST","Request failed",false));
        if(!"REDUCTION_MANAGER".equals(request.actorCode()))
            return org.springframework.http.ResponseEntity.status(403).body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("ACCESS_DENIED","Access denied",false));
        ...
        payload.put("stepCode","REDUCTION_ROADMAP_S2");
        payload.put("commandCode","REDUCTION_ROADMAP_EXECUTE");
        payload.put("routePath","/admin/generated/reduction-roadmap/reduction-roadmap-s2");
        ...
        try {
            try { payload.put("requestJson",objectMapper.writeValueAsString(business)); }
                ...
                return org.springframework.http.ResponseEntity.badRequest().body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("INVALID_REQUEST","Request serialization failed",false));
            }
            ...
            if(!Boolean.TRUE.equals(result.get("success"))
                ...
                return org.springframework.http.ResponseEntity.status(500).body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            ...
            if(Boolean.TRUE.equals(result.get("idempotent"))) {
                ...
                Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757RecoveryResponse response;
                try { response=objectMapper.convertValue(responsePayload,Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757RecoveryResponse.class); }
                catch(IllegalArgumentException mismatch) {
                    return org.springframework.http.ResponseEntity.status(500).body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
                }
                return org.springframework.http.ResponseEntity.status(200).body(response);
            }
            Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757SuccessResponse response;
            try { response=objectMapper.convertValue(responsePayload,Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757SuccessResponse.class); }
            catch(IllegalArgumentException mismatch) {
                return org.springframework.http.ResponseEntity.status(500).body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("INTERNAL_ERROR","Response contract mismatch",false));
            }
            return org.springframework.http.ResponseEntity.status(200).body(response);
        }
        catch(SecurityException denied) { return org.springframework.http.ResponseEntity.status(403).body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("ACCESS_DENIED","Access denied",false)); }
        catch(IllegalArgumentException invalid) { return org.springframework.http.ResponseEntity.badRequest().body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("INVALID_REQUEST","Request failed",false)); }
        catch(IllegalStateException conflict) { return org.springframework.http.ResponseEntity.status(409).body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("CONFLICT","Request conflicts with the current state",false)); }
        catch(Exception unexpected) { return org.springframework.http.ResponseEntity.status(500).body(new Op7fac4129bd7ee47b1fc7313d1c4f7efb71201757ErrorResponse("INTERNAL_ERROR","Internal processing failed",false)); }
    }
}
