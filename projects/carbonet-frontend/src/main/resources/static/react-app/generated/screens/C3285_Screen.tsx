...
// Screen: 거래 계약 승인 요청 범위 필수정보 확인 관리자 업무 화면
// Route: /admin/generated/trade-contract/trade-contract-s1
// Contract ID: 3285
...
const Screen3285: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">거래 계약 승인 요청 범위 필수정보 확인 관리자 업무 화면</Typography>
