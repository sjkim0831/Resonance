...
// Screen: 거래 제안 협상 요청 범위 필수정보 확인 사용자 업무 화면
// Route: /generated/trade-proposal/trade-proposal-s1
// Contract ID: 3280
...
const Screen3280: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">거래 제안 협상 요청 범위 필수정보 확인 사용자 업무 화면</Typography>
