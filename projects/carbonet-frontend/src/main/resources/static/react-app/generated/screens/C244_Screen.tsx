...
const fieldDefinitions = [
  ...
  {name: 'contract_544d0508bfd4', label: '사용량', type: 'TEXT', required: true},
  {name: 'contract_dab29ba0bf4c', label: '원단위', type: 'TEXT', required: true},
  {name: 'contract_547f19605fc0', label: '배출계수', type: 'TEXT', required: true},
  {name: 'contract_ab5bbba69a5d', label: '계수 출처·버전', type: 'TEXT', required: true},
  {name: 'contract_dde4893be6cc', label: '환산식', type: 'TEXT', required: true},
  {name: 'contract_7cb95c4d5532', label: 'GWP', type: 'TEXT', required: true},
  {name: 'contract_6f92b94e4355', label: '배출량', type: 'TEXT', required: true},
  {name: 'contract_5d113f2038d2', label: 'Scope', type: 'TEXT', required: true},
  {name: 'contract_fd9dfed68805', label: '계산 버전', type: 'TEXT', required: true},
];

const Screen244: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">배출계수 매핑 배출량 산정</Typography>
