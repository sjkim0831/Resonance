...
// Screen: 복구 요청 접수 범위 확인 사용자 업무 화면
// Route: /signin/loginForbidden
// Contract ID: 3018
...
const Screen3018: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">복구 요청 접수 범위 확인 사용자 업무 화면</Typography>
