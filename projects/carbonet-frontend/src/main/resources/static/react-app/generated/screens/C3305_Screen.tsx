...
// Screen: 환불 요청 처리 요청 범위 필수정보 확인 관리자 업무 화면
// Route: /admin/generated/refund-management/refund-management-s1
// Contract ID: 3305
...
const Screen3305: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">환불 요청 처리 요청 범위 필수정보 확인 관리자 업무 화면</Typography>
