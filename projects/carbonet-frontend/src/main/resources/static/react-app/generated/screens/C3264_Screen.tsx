...
// Screen: 거래 제안 협상 독립 검토 보완 권한 검증 사용자 업무 화면
// Route: /generated/trade-proposal/trade-proposal-s3
// Contract ID: 3264
...
const Screen3264: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">거래 제안 협상 독립 검토 보완 권한 검증 사용자 업무 화면</Typography>
