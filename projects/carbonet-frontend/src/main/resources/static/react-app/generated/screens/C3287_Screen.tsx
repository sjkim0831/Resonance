...
// Screen: 거래 계약 승인 업무 실행 중간 결과 저장 관리자 업무 화면
// Route: /admin/generated/trade-contract/trade-contract-s2
// Contract ID: 3287
...
const Screen3287: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">거래 계약 승인 업무 실행 중간 결과 저장 관리자 업무 화면</Typography>
