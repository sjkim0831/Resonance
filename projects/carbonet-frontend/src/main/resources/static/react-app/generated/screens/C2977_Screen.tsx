...
// Route: /admin/system/consent-history
// Contract ID: 2977
...
const Screen2977: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">약관 개인정보 GWP 고지 동의 승인 확정 통지 후속업무 연결 관리자 업무 화면</Typography>
