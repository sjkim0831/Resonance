...
// Screen: 거래 제안 협상 업무 실행 중간 결과 저장 관리자 업무 화면
// Route: /admin/generated/trade-proposal/trade-proposal-s2
// Contract ID: 3141
...
const Screen3141: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">거래 제안 협상 업무 실행 중간 결과 저장 관리자 업무 화면</Typography>
