...
// Screen: CO2 수요 정보 등록 요청 범위 필수정보 확인 관리자 업무 화면
// Route: /admin/generated/co2-demand-registration/co2-demand-registration-s1
// Contract ID: 3263
...
const Screen3263: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">CO2 수요 정보 등록 요청 범위 필수정보 확인 관리자 업무 화면</Typography>
