...
// Screen: 내 정보 알림 보안 설정 요청 범위 필수정보 확인 사용자 업무 화면
...
const Screen3026: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">내 정보 알림 보안 설정 요청 범위 필수정보 확인 사용자 업무 화면</Typography>
