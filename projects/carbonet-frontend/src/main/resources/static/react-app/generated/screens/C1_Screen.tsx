...
const fieldDefinitions = [
  ...
  {name: 'businessname', label: '업무명', type: 'TEXT', required: true},
  {name: 'businesspurpose', label: '목적·근거', type: 'TEXT', required: true},
  {name: 'effectivefrom', label: '적용 시작일', type: 'DATE', required: true},
  {name: 'effectiveto', label: '적용 종료일', type: 'DATE', required: false},
  {name: 'contract_70e3b383e5c1', label: '프로젝트명', type: 'TEXT', required: true},
  {name: 'contract_b0a768e73509', label: '보고목적', type: 'TEXT', required: true},
  {name: 'contract_9e2842ed6837', label: '산정기간', type: 'TEXT', required: true},
  {name: 'contract_def24df8e083', label: '조직·사업장', type: 'TEXT', required: true},
  {name: 'contract_fb19cef77a6e', label: '경계방법', type: 'TEXT', required: true},
  {name: 'contract_ac18a16adeba', label: 'Scope 1·2·3', type: 'TEXT', required: true},
  {name: 'contract_75151a683029', label: 'Scope 2 방식', type: 'TEXT', required: true},
  {name: 'contract_60d47f03728c', label: 'GWP 버전', type: 'TEXT', required: true},
  {name: 'contract_3474cee7273c', label: '배출계수 버전', type: 'TEXT', required: true},
  {name: 'contract_9b9c808be270', label: '책임자', type: 'TEXT', required: true},
  {name: 'contract_11be68a8156c', label: '단계별 마감', type: 'TEXT', required: true},
];
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">프로젝트 기본정보 및 책임 확정 사용자 업무 화면</Typography>
