...
const fieldDefinitions = [
  ...
  {name: 'contract_106cd492d00e', label: '오류번호', type: 'TEXT', required: true},
  {name: 'contract_5d6b4c0ee868', label: '검증의견', type: 'TEXT', required: true},
  {name: 'contract_eaa64c174a9c', label: '수정 전 값', type: 'TEXT', required: true},
  {name: 'contract_24afe6bc8f2f', label: '수정 후 값', type: 'TEXT', required: true},
  {name: 'contract_6894d7b7a7f1', label: '변경사유', type: 'TEXT', required: true},
  {name: 'contract_64a82081f822', label: '대체 증빙', type: 'TEXT', required: true},
  {name: 'contract_e3b16e9d020d', label: '영향 항목', type: 'TEXT', required: true},
  {name: 'contract_86c9af3e1136', label: '재산정 버전', type: 'TEXT', required: true},
  {name: 'contract_5b743c46db0e', label: '재검증 상태', type: 'TEXT', required: true},
];

const Screen14: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">보완 재산정 관리자 업무 화면</Typography>
