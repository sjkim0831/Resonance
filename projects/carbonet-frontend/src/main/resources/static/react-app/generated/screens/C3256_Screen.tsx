...
// Screen: CO2 공급 정보 등록 업무 실행 중간 결과 저장 사용자 업무 화면
// Route: /generated/co2-supply-registration/co2-supply-registration-s2
// Contract ID: 3256
...
const Screen3256: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">CO2 공급 정보 등록 업무 실행 중간 결과 저장 사용자 업무 화면</Typography>
