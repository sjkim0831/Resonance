...
// Screen: 내 정보 알림 보안 설정 업무 실행 중간 결과 저장 관리자 업무 화면
...
const Screen3029: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">내 정보 알림 보안 설정 업무 실행 중간 결과 저장 관리자 업무 화면</Typography>
