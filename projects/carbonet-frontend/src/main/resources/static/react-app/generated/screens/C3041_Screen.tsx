...
const Screen3041: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">회원 탈퇴 보유정보 처리 승인 확정 통지 후속업무 연결 관리자 업무 화면</Typography>
