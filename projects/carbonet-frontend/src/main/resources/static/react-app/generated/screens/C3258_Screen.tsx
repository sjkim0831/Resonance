...
// Screen: CO2 공급 정보 등록 독립 검토 보완 권한 검증 사용자 업무 화면
// Route: /generated/co2-supply-registration/co2-supply-registration-s3
// Contract ID: 3258
...
const Screen3258: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">CO2 공급 정보 등록 독립 검토 보완 권한 검증 사용자 업무 화면</Typography>
