...
// Screen: 기업 등록 신청 사용자 업무 화면
// Route: /join/companyRegister
// Contract ID: 2779
...
const Screen2779: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">기업 등록 신청 사용자 업무 화면</Typography>
