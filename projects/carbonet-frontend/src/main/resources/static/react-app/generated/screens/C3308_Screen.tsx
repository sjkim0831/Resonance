...
// Screen: 환불 요청 처리 독립 검토 보완 권한 검증 사용자 업무 화면
// Route: /generated/refund-management/refund-management-s3
// Contract ID: 3308
...
const Screen3308: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">환불 요청 처리 독립 검토 보완 권한 검증 사용자 업무 화면</Typography>
