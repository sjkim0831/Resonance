...
// Screen: 비밀번호 재설정 업무 실행 중간 결과 저장 관리자 업무 화면
// Route: /admin/member/reset_password
// Contract ID: 3013
...
const Screen3013: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">비밀번호 재설정 업무 실행 중간 결과 저장 관리자 업무 화면</Typography>
