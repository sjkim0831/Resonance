...
// Screen: CO2 공급 정보 등록 승인 확정 통지 후속업무 연결 관리자 업무 화면
// Route: /admin/generated/co2-supply-registration/co2-supply-registration-s4
// Contract ID: 3261
...
const Screen3261: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">CO2 공급 정보 등록 승인 확정 통지 후속업무 연결 관리자 업무 화면</Typography>
