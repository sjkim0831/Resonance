...
// Screen: 거래 정산 승인 확정 통지 후속업무 연결 사용자 업무 화면
// Route: /generated/trade-settlement/trade-settlement-s4
// Contract ID: 3302
...
const Screen3302: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">거래 정산 승인 확정 통지 후속업무 연결 사용자 업무 화면</Typography>
