...
// Screen: 프로세스 단계 실행 작업공간
// Route: /admin/system/process-step-workspace
// Contract ID: 742
...
const fieldDefinitions = [
  ...
  {name: 'sourcetype', label: '자료 출처', type: 'CODE', required: true},
  {name: 'sourcereference', label: '원본 참조', type: 'TEXT', required: true},
  {name: 'attachmentids', label: '첨부 증빙', type: 'TEXT', required: false},
  {name: 'submittedat', label: '제출 일시', type: 'DATETIME', required: false},
  {name: 'contract_72711358232b', label: '사업장', type: 'TEXT', required: true},
  {name: 'contract_d26c7c7e25bc', label: '배출원', type: 'TEXT', required: true},
  {name: 'contract_32c75e57a82d', label: '활동자료', type: 'TEXT', required: true},
  {name: 'contract_4ea5456fb1e6', label: '값', type: 'TEXT', required: true},
  {name: 'contract_fe887252f138', label: '단위', type: 'TEXT', required: true},
  {name: 'contract_7bc7c5c4241a', label: '기간', type: 'TEXT', required: true},
  {name: 'contract_20e87f548266', label: '출처', type: 'TEXT', required: true},
  {name: 'contract_c219ccfeeb53', label: '증빙', type: 'TEXT', required: true},
  {name: 'contract_9ff7e209dc62', label: '담당자', type: 'TEXT', required: true},
  {name: 'contract_df23376316ee', label: '마감', type: 'TEXT', required: true},
  {name: 'contract_87a1e1d51628', label: '품질상태', type: 'TEXT', required: true},
];

const Screen742: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">프로세스 단계 실행 작업공간</Typography>
