...
// Screen: 환불 요청 처리 업무 실행 중간 결과 저장 관리자 업무 화면
// Route: /admin/generated/refund-management/refund-management-s2
// Contract ID: 3307
...
const Screen3307: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">환불 요청 처리 업무 실행 중간 결과 저장 관리자 업무 화면</Typography>
