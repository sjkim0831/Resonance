...
// Screen: 조직 사업장 등록 관리자 업무 화면
// Route: /admin/emission/site-management
// Contract ID: 2786
...
const Screen2786: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">조직 사업장 등록 관리자 업무 화면</Typography>
