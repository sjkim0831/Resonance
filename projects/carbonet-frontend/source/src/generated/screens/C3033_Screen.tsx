...
// Route: /admin/member/login_history
// Contract ID: 3033
...
const Screen3033: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">내 정보 알림 보안 설정 승인 확정 통지 후속업무 연결 관리자 업무 화면</Typography>
