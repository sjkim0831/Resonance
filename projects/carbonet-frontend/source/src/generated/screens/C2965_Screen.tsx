...
// Screen: 약관 개인정보 GWP 고지 동의 관리자 업무 화면
// Route: /admin/generated/member-registration/member-registration-s2
// Contract ID: 2965
...
const fieldDefinitions = [
  ...
  {name: 'companyid', label: '기업', type: 'TEXT', required: true},
  {name: 'accountid', label: '사용자 계정', type: 'TEXT', required: true},
  {name: 'actorcodes', label: '업무 액터', type: 'TEXT', required: true},
  {name: 'authoritycode', label: '권한 그룹', type: 'CODE', required: true},
  {name: 'accountstatus', label: '계정 상태', type: 'CODE', required: true},
  {name: 'consentversion', label: '동의서 버전', type: 'TEXT', required: false},
...
const Screen2965: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">약관 개인정보 GWP 고지 동의 관리자 업무 화면</Typography>
