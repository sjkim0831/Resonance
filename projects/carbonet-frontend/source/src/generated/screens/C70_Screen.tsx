...
const fieldDefinitions = [
  ...
  {name: 'contract_0a4477010a9c', label: '규칙', type: 'TEXT', required: true},
  {name: 'contract_20bc30834b9b', label: '대상 위치', type: 'TEXT', required: true},
  {name: 'contract_2db6d21d4901', label: '심각도', type: 'TEXT', required: true},
  {name: 'contract_279a40766f79', label: '기대값', type: 'TEXT', required: true},
  {name: 'contract_a67cdb80a94a', label: '실제값', type: 'TEXT', required: true},
  {name: 'contract_8256be84de79', label: '근거', type: 'TEXT', required: true},
  {name: 'contract_9ff7e209dc62', label: '담당자', type: 'TEXT', required: true},
  {name: 'contract_296db94e3365', label: '기한', type: 'TEXT', required: true},
  {name: 'contract_8e3ccf6ffc96', label: '조치상태', type: 'TEXT', required: true},
];

const Screen70: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">데이터 산정 결과 검증 관리자 업무 화면</Typography>
