...
// Screen: 환불 요청 처리 승인 확정 통지 후속업무 연결 관리자 업무 화면
// Route: /admin/generated/refund-management/refund-management-s4
// Contract ID: 3311
...
const Screen3311: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">환불 요청 처리 승인 확정 통지 후속업무 연결 관리자 업무 화면</Typography>
