...
// Screen: CO2 공급 정보 등록 업무 실행 중간 결과 저장 관리자 업무 화면
// Route: /admin/generated/co2-supply-registration/co2-supply-registration-s2
// Contract ID: 3257
...
const fieldDefinitions = [
  ...
  {name: 'listingid', label: '거래 공고', type: 'TEXT', required: true},
  {name: 'tradetype', label: '거래 구분', type: 'CODE', required: true},
  {name: 'quantity', label: '거래 수량', type: 'TEXT', required: true},
  {name: 'unitprice', label: '단가', type: 'TEXT', required: true},
  {name: 'counterpartyid', label: '거래 상대', type: 'TEXT', required: true},
  {name: 'mrvreference', label: 'MRV 근거', type: 'TEXT', required: true},
  {name: 'contractstatus', label: '계약 상태', type: 'CODE', required: true},
  {name: 'settlementstatus', label: '정산 상태', type: 'CODE', required: false},
...
const Screen3257: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">CO2 공급 정보 등록 업무 실행 중간 결과 저장 관리자 업무 화면</Typography>
