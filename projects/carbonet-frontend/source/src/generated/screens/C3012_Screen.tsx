...
// Screen: 비밀번호 재설정 업무 실행 중간 결과 저장 사용자 업무 화면
// Route: /signin/findPassword
// Contract ID: 3012
...
const Screen3012: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">비밀번호 재설정 업무 실행 중간 결과 저장 사용자 업무 화면</Typography>
