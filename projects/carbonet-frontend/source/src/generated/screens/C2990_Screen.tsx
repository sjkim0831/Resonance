...
// Route: /join/companyJoinStatusDetail
// Contract ID: 2990
...
const Screen2990: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">가입 검토 승인 반려 업무 실행 중간 결과 저장 사용자 업무 화면</Typography>
