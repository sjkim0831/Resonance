...
// Screen: 기업 등록 신청 관리자 업무 화면
// Route: /admin/member/company-approve
// Contract ID: 2780
...
const Screen2780: React.FC = () => {
  // Screen component
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
        <Typography variant="h5">기업 등록 신청 관리자 업무 화면</Typography>
