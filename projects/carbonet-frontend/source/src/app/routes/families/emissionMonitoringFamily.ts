...
const EMISSION_MONITORING_ROUTE_DEFINITIONS = [
  ...
  { id: "emission-survey-report-print", label: "배출 설문 리포트 출력", group: "admin", koPath: "/admin/emission/survey-report-print", enPath: "/en/admin/emission/survey-report-print" },
  { id: "emission-survey-report-verify", label: "리포트 진위확인", group: "admin", koPath: "/admin/emission/survey-report-verify", enPath: "/en/admin/emission/survey-report-verify" },
  { id: "emission-survey-lca-summary-print", label: "LCA 요약보고서 출력", group: "admin", koPath: "/admin/emission/survey-report-lca-summary", enPath: "/en/admin/emission/survey-report-lca-summary" },
  ...
  { id: "emission-dashboard", label: "탄소 배출 대시보드", group: "home", koPath: "/emission/index", enPath: "/en/emission/index" },
...
const EMISSION_MONITORING_PAGE_UNITS = [
  ...
  { id: "emission-survey-report-print", exportName: "EmissionSurveyReportPrintPage", loader: () => import("../../../features/emission-survey-report/EmissionSurveyReportMigrationPage") },
  { id: "emission-survey-report-verify", exportName: "EmissionSurveyReportVerifyPage", loader: () => import("../../../features/emission-survey-report/EmissionSurveyReportMigrationPage") },
  { id: "emission-survey-lca-summary-print", exportName: "EmissionSurveyLcaSummaryPrintPage", loader: () => import("../../../features/emission-survey-report/EmissionSurveyReportMigrationPage") },
  ...
  { id: "emission-dashboard", exportName: "EmissionDashboardPage", loader: () => import("../../../features/emission-dashboard/EmissionDashboardPage") },
