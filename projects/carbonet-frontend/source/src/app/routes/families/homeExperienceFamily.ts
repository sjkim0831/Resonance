...
const HOME_EXPERIENCE_ROUTE_DEFINITIONS = [
  ...
  { id: "edu-index", label: "교육 대시보드", group: "home", koPath: "/edu/index", enPath: "/en/edu/index" },
  ...
  { id: "mypage-index", label: "마이페이지 대시보드", group: "home", koPath: "/mypage/index", enPath: "/en/mypage/index" },
...
const HOME_EXPERIENCE_PAGE_UNITS = [
  ...
  { id: "mtn-index", exportName: "MtnIndexPage", loader: () => import("../../../features/major-menu-index/MajorMenuIndexPage") },
