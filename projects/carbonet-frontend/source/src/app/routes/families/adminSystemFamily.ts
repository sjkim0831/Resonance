...
const ADMIN_SYSTEM_ROUTE_DEFINITIONS = [
  ...
  { id: "process-step-workspace", label: "프로세스 단계 실행", group: "admin", koPath: "/admin/system/process-step-workspace", enPath: "/en/admin/system/process-step-workspace" },
...
const ADMIN_SYSTEM_PAGE_UNITS = [
  ...
  { id: "process-step-workspace", exportName: "ProcessStepWorkspacePage", loader: () => import("../../../features/process-step-workspace/ProcessStepWorkspacePage") },
