...
const ADMIN_SYSTEM_ROUTE_DEFINITIONS = [
  ...
  { id: "screen-builder-framework", label: "스크린 빌더 허브", group: "admin", koPath: "/admin/system/screen-builder-framework", enPath: "/en/admin/system/screen-builder-framework" },
  { id: "page-inventory", label: "페이지 인벤토리", group: "admin", koPath: "/admin/system/page-inventory", enPath: "/en/admin/system/page-inventory" },
...
const ADMIN_SYSTEM_PAGE_UNITS = [
  ...
  { id: "screen-builder-framework", exportName: "ScreenBuilderFrameworkHubPage", loader: () => import("../../../features/screen-builder-framework") },
  { id: "page-inventory", exportName: "PageInventoryManagementPage", loader: () => import("../../../features/screen-builder-framework") },
