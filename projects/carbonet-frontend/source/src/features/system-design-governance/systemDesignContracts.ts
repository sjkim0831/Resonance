...
export const SYSTEM_DESIGN_DOMAINS: DesignDomain[] = [
  {
    ...
    stages: [
      ...
      {id:"collect",nameKo:"자료 수집",nameEn:"Data Collection",userPath:"/emission/data_input",adminPath:"/admin/emission/survey-admin-data",capabilities:["request","upload","evidence","submit"],apiContract:"emission-activity-workflow",dataOwner:"emission_activity_data",authority:"PROJECT_ASSIGNEE",nextStage:"calculate"},
      {id:"calculate",nameKo:"산정",nameEn:"Calculation",userPath:"/emission/simulate",adminPath:"/admin/emission/calculation-rule",capabilities:["map-factor","convert-unit","calculate","recalculate"],apiContract:"emission-calculation-workflow",dataOwner:"emission_calculation_result",authority:"CALCULATOR",nextStage:"validate"},
