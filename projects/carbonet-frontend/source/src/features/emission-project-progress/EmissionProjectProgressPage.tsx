...
const stages = [
  ...
  { code: "COLLECT", ko: "활동자료·증빙", en: "Data & Evidence", actor: "자료 담당자", path: "/emission/activity-data", rule: "필수값·단위·증빙 누락 0건" },
  ...
  { code: "CORRECT", ko: "보완·재산정", en: "Correction", actor: "자료·산정 담당자", path: "/emission/activity-data?mode=correction", rule: "보완 사유·변경 이력·재산정 기록" },
