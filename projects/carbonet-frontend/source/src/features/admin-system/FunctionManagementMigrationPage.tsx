...
import { stringOf, submitFormRequest } from "./adminSystemShared";
...
export function FunctionManagementMigrationPage() {
  ...
  useEffect(() => {
    function syncFromNavigation() {
      ...
      setFilters((current) => ({
        menuType: nextSearchParams.get("menuType") || current.menuType,
        searchMenuCode: nextSearchParams.get("searchMenuCode") || "",
        searchKeyword: nextSearchParams.get("searchKeyword") || ""
      }));
    }
