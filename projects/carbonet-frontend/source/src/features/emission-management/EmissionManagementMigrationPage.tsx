...
export function EmissionManagementMigrationPage() {
  ...
  void LookupContextStrip;
  void MemberActionBar;
  void PageStatusNotice;
  void EmissionClassificationCatalogPanel;
  void rolloutStatusTone;
  void rolloutStatusLabel;
  void definitionScopeStatusTone;
  void definitionScopeStatusLabel;
  void candidateStatusTone;
  void candidateStatusLabel;
  void scopeBlockingReasonLabel;
  void elementRegistrySaving;
  void wizardStep;
  void saving;
  void calculating;
  void materializingDraftId;
  void precheckingDraftId;
  void message;
  void error;
  void scopeStatusLoading;
  void activityFeedOverlayOpen;
  void elementRegistrySummary;
  void elementTypeOptions;
  void layoutZoneOptions;
  void componentTypeOptions;
  void formulaReference;
  void rolloutSummaryCards;
  void rolloutStatusRows;
  void definitionScopeSummaryCards;
  void selectedMajorOption;
  void selectedMiddleOption;
  void lciSmallCandidates;
  void blockedSelectedCategoryDefinitionScopeRows;
  void appliedDefinitionPolicies;
  void effectiveFormulaSummary;
  void selectedScopeBlockingReasons;
  void selectedScopeWarnings;
  void selectedScopePrecheckBlockingReasons;
  void selectedScopeActionGuide;
  void selectedScopeTimeline;
  void selectedScopeEvidence;
  void hasAdditionalSelectedScopeActivityFeed;
  void updateElementDefinitionDraft;
  void applyCurrentSelectionPolicyToDraft;
  void applyElementTemplate;
  void sectionFormulaMappings;
  void activeSectionPreviewCards;
  void definitionFormulaPreview;
  void renderFormulaSection;
  void resetCurrentDraft;
  void handleMaterializeDefinitionScope;
  void handlePrecheckDefinitionScope;
  void focusDefinitionScope;
  void focusRegisteredElement;
  void handleCalculate;
  void handleSaveElementDefinition;
  void handleNewElementDefinition;
