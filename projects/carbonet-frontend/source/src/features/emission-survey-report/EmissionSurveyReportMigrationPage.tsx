...
<PrintMetric
        ...
        <section className="pdf-page-start pdf-page-content print-page grid gap-4 px-8 py-7 lg:grid-cols-2">
        ...
        <section className="pdf-page-start pdf-page-content print-card print-table mx-8 mb-7 overflow-hidden rounded-3xl border border-slate-200 bg-white print:overflow-hidden">
