...
type Payload = { actors: Row[]; assignments: Row[]; processes: Row[]; steps: Row[]; cases: Row[]; runs: Row[]; artifacts:Row[]; summary?: Row };
const empty: Payload = { actors: [], assignments: [], processes: [], steps: [], cases: [], runs: [], artifacts:[] };
...
export function ActorProcessGovernancePage() {
  ...
  const tabs = [["overview", "전체 현황"], ["actors", "액터"], ["assignments", "계정 배정"], ["processes", "프로세스"], ["steps", "단계"], ["artifacts", "개발 산출물"], ["simulation", "시나리오·실행"]];
