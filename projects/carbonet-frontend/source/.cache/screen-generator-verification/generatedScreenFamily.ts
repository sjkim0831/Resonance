...
const GENERATED_SCREEN_ROUTES = [
  {
    ...
    "label": "배출량 프로젝트 등록",
    "group": "home",
    "koPath": "/generated/emission-project/create",
    "enPath": "/en/generated/emission-project/create"
  }
] as const satisfies RouteDefinitionsOf;
const GENERATED_SCREEN_PAGE_UNITS = [
  { id: "detailed-user-page", exportName: "GeneratedScreenPage", loader: () => import("../../features/generated-screen/GeneratedScreenPage") }
