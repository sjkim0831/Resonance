...
export const screen_auto_91ade0f0415b3eea52d4 = {
  ...
  "pageName": "이상치·경보 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 이상치·경보 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3228,
    "requirementIds": [
      "ANOMALY_ALERT_MANAGEMENT:ANOMALY_ALERT_MANAGEMENT_S4:USER"
    ],
