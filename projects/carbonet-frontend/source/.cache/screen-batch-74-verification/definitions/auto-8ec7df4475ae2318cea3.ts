...
export const screen_auto_8ec7df4475ae2318cea3 = {
  "id": "auto-8ec7df4475ae2318cea3",
  "blueprintCode": "BP_AUTO_8EC7DF4475AE2318CEA365BB",
  "processCode": "ANALYSIS_EXPORT",
  "stepCode": "ANALYSIS_EXPORT_S4",
  "actorCode": "APPROVER",
  "audience": "USER",
  "pageId": "AUTO_8EC7DF4475AE2318CEA3",
  "pageName": "분석 데이터 내보내기 - 승인·확정·통지·후속업무 연결 사용자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "분석 데이터 내보내기 프로세스의 분석 데이터 내보내기 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 ANALYSIS_EXPORT_COMPLETE 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 분석 데이터 내보내기 - 승인·확정·통지·후속업무 연결 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3230,
    "requirementIds": [
      "ANALYSIS_EXPORT:ANALYSIS_EXPORT_S4:USER"
    ],
