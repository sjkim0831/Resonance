...
export const screen_auto_10edfe98dbf8a25a4599 = {
  "id": "auto-10edfe98dbf8a25a4599",
  "blueprintCode": "BP_AUTO_10EDFE98DBF8A25A4599749A",
  "processCode": "CO2_LOT_TAG_MANAGEMENT",
  "stepCode": "CLT_CREATE",
  "actorCode": "TRADE_OPERATOR",
  "audience": "USER",
  "pageId": "AUTO_10EDFE98DBF8A25A4599",
  "pageName": "로트 생성·원본 태그 확정 사용자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "TRADE_OPERATOR 액터가 권한·업무분리 정책에 따라 로트 생성·원본 태그 확정 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "승인된 포집 기업·설비·계측기와 생산 실적이 존재한다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
  ...
  "traceability": {
    "contractId": 448,
    "requirementIds": [
      "CO2_LOT_TAG_MANAGEMENT:CLT_CREATE:USER"
    ],
