...
export const screen_auto_f8923f80b9fc699c7f91 = {
  ...
  "blueprintCode": "BP_AUTO_F8923F80B9FC699C7F91F187",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "TRADE_OPERATOR 액터가 권한·업무분리 정책에 따라 CO2 공급 정보 등록 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3254,
    "requirementIds": [
      "CO2_SUPPLY_REGISTRATION:CO2_SUPPLY_REGISTRATION_S1:USER"
    ],
