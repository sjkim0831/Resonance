...
export const screen_auto_be24e4b521823fc2ef6f = {
  ...
  "blueprintCode": "BP_AUTO_BE24E4B521823FC2EF6FB5DD",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 분석 데이터 내보내기 - 독립 검토·보완·권한 검증 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3244,
    "requirementIds": [
      "ANALYSIS_EXPORT:ANALYSIS_EXPORT_S3:USER"
    ],
