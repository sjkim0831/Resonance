...
export const screen_auto_f90f3a24bf97cba872ea = {
  ...
  "specification": {
    ...
    "businessPurpose": "회원가입 신청 프로세스의 약관·개인정보·GWP 고지 동의 단계에서 PUBLIC_APPLICANT 액터가 ACCEPT_REQUIRED_CONSENTS 명령을 안전하게 수행하고 이용약관·개인정보·GWP 필수 동의의 버전과 증적이 저장된다.를 완료한다.",
    "actorResponsibilities": [
      "PUBLIC_APPLICANT 액터가 권한·업무분리 정책에 따라 약관·개인정보·GWP 고지 동의 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "비로그인 사용자가 홈 또는 로그인 화면에서 회원가입을 선택한다.을 충족하고 현재 상태가 MEMBER_TYPE_SELECTED이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
      "이용약관·개인정보·GWP 필수 동의의 버전과 증적이 저장된다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 CONSENTS_ACCEPTED 상태로 원자적으로 전이한다."
    ],
    "states": [
    ...
    "completionRule": "이용약관·개인정보·GWP 필수 동의의 버전과 증적이 저장된다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 CONSENTS_ACCEPTED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 2965,
      "sharedRuntime": true
    }
