...
export const screen_auto_bf7abd3f53ffec88b2ca = {
  ...
  "blueprintCode": "BP_AUTO_BF7ABD3F53FFEC88B2CA4E33",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SETTLEMENT_OPERATOR 액터가 권한·업무분리 정책에 따라 환불 요청·처리 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3304,
    "requirementIds": [
      "REFUND_MANAGEMENT:REFUND_MANAGEMENT_S1:USER"
    ],
