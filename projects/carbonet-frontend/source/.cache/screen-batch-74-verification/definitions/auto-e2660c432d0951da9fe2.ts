...
export const screen_auto_e2660c432d0951da9fe2 = {
  ...
  "blueprintCode": "BP_AUTO_E2660C432D0951DA9FE23118",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SETTLEMENT_OPERATOR 액터가 권한·업무분리 정책에 따라 환불 요청·처리 - 업무 실행·중간 결과 저장 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3307,
    "requirementIds": [
      "REFUND_MANAGEMENT:REFUND_MANAGEMENT_S2:ADMIN"
    ],
