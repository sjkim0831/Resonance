...
export const screen_auto_713f192413e9a2f14e1a = {
  "id": "auto-713f192413e9a2f14e1a",
  "blueprintCode": "BP_AUTO_713F192413E9A2F14E1A1ABA",
  "processCode": "ANOMALY_ALERT_MANAGEMENT",
  "stepCode": "ANOMALY_ALERT_MANAGEMENT_S4",
  "actorCode": "APPROVER",
  "audience": "ADMIN",
  "pageId": "AUTO_713F192413E9A2F14E1A",
  "pageName": "이상치·경보 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "이상치·경보 관리 프로세스의 이상치·경보 관리 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 ANOMALY_ALERT_MANAGEMENT_COMPLETE 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 이상치·경보 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3229,
    "requirementIds": [
      "ANOMALY_ALERT_MANAGEMENT:ANOMALY_ALERT_MANAGEMENT_S4:ADMIN"
    ],
