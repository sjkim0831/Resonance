...
export const screen_auto_8ea030f515d2fc1bc0c0 = {
  ...
  "specification": {
    ...
    "businessPurpose": "LCA 데이터 품질·불확도 프로세스의 대표성·완전성 점수화 단계에서 LCA_PRACTITIONER 액터가 LCA_DATA_QUALITY_UNCERTAINTY_EXECUTE_2 명령을 안전하게 수행하고 대표성·완전성 점수화의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "LCA_PRACTITIONER 액터가 권한·업무분리 정책에 따라 대표성·완전성 점수화 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "인벤토리 데이터와 출처·기간·지역·기술 메타데이터가 존재한다.을 충족하고 현재 상태가 STEP_1_COMPLETED이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
      "대표성·완전성 점수화의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 STEP_2_COMPLETED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "STEP_1_COMPLETED",
      "LOADING",
    ...
    "completionRule": "대표성·완전성 점수화의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 STEP_2_COMPLETED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 3759,
      "sharedRuntime": true
    }
