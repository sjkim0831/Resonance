...
export const screen_auto_09f1e6599a00ac932b72 = {
  ...
  "blueprintCode": "BP_AUTO_09F1E6599A00AC932B72FF26",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 품질등급 승인·개선조치 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3778,
    "requirementIds": [
      "MEASUREMENT_DATA_QUALITY:MEASUREMENT_DATA_QUALITY_S4:USER"
    ],
