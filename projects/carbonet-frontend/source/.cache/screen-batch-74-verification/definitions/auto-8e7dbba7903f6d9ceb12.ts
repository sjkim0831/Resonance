...
export const screen_auto_8e7dbba7903f6d9ceb12 = {
  ...
  "blueprintCode": "BP_AUTO_8E7DBBA7903F6D9CEB12421F",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 데이터 품질 모니터링 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3216,
    "requirementIds": [
      "DATA_QUALITY_MONITORING:DATA_QUALITY_MONITORING_S2:USER"
    ],
