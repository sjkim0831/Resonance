...
export const screen_auto_2389c252d99eaf1d5750 = {
  ...
  "blueprintCode": "BP_AUTO_2389C252D99EAF1D5750FD37",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 공지사항 게시 - 독립 검토·보완·권한 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3389,
    "requirementIds": [
      "NOTICE_PUBLICATION:NOTICE_PUBLICATION_S3:ADMIN"
    ],
