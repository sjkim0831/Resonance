...
export const screen_auto_766450fc1d34e918533a = {
  ...
  "specification": {
    ...
    "businessPurpose": "감축 과제 등록 프로세스의 감축 과제 등록 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 REDUCTION_PROJECT_REGISTRATION_COMPLETE 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 감축 과제 등록 - 승인·확정·통지·후속업무 연결 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3169,
    "requirementIds": [
      "REDUCTION_PROJECT_REGISTRATION:REDUCTION_PROJECT_REGISTRATION_S4:ADMIN"
    ],
