...
export const screen_auto_f8d6aa5fb598cf6ad9e7 = {
  "id": "auto-f8d6aa5fb598cf6ad9e7",
  "blueprintCode": "BP_AUTO_F8D6AA5FB598CF6AD9E7B66D",
  ...
  "pageName": "탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 관리자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "탄소크레딧 발급·보유·소각 프로세스의 탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 단계에서 CERTIFICATE_OFFICER 액터가 CARBON_CREDIT_MANAGEMENT_REQUEST 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "CERTIFICATE_OFFICER 액터가 권한·업무분리 정책에 따라 탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
    ...
    "kpis": [
      {
        ...
        "unit": "PERCENT",
        "label": "탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 완료율"
      },
      {
        "code": "SLA_REMAINING",
        "unit": "MINUTE",
    ...
    "actions": [
      {
        ...
        "label": "탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 실행",
        "transactional": true,
    ...
    "apiContracts": [
      ...
      },
      {
        ...
        "method": "POST",
        "purpose": "탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 상태 명령 실행"
      },
      {
        "code": "LOAD_DRAFT",
