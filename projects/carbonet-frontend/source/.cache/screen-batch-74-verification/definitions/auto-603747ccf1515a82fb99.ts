...
export const screen_auto_603747ccf1515a82fb99 = {
  ...
  "specification": {
    ...
    "businessPurpose": "비교주장·비판적 검토 보고 프로세스의 제한사항 포함 공개 승인 단계에서 APPROVER 액터가 COMPARATIVE_ASSERTION_REVIEW_EXECUTE_4 명령을 안전하게 수행하고 제한사항 포함 공개 승인의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 제한사항 포함 공개 승인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "비교 대상과 기능단위, 경계, 데이터 품질, 공개 목적이 정의되어 있다.을 충족하고 현재 상태가 STEP_3_COMPLETED이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
      "제한사항 포함 공개 승인의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 STEP_4_COMPLETED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "STEP_3_COMPLETED",
      "LOADING",
    ...
    "completionRule": "제한사항 포함 공개 승인의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 STEP_4_COMPLETED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 3115,
      "sharedRuntime": true
    }
  ...
  "traceability": {
    "contractId": 3115,
    "requirementIds": [
      "COMPARATIVE_ASSERTION_REVIEW:COMPARATIVE_ASSERTION_REVIEW_S4:ADMIN"
    ],
