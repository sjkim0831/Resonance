...
export const screen_auto_5e10fb6fce6f43c06b31 = {
  ...
  "blueprintCode": "BP_AUTO_5E10FB6FCE6F43C06B31C249",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "TRADE_OPERATOR 액터가 권한·업무분리 정책에 따라 CO2 수요 정보 등록 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3266,
    "requirementIds": [
      "CO2_DEMAND_REGISTRATION:CO2_DEMAND_REGISTRATION_S2:USER"
    ],
