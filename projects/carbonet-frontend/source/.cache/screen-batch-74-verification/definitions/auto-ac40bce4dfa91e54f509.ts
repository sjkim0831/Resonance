...
export const screen_auto_ac40bce4dfa91e54f509 = {
  ...
  "blueprintCode": "BP_AUTO_AC40BCE4DFA91E54F5099406",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "DATA_ANALYST 액터가 권한·업무분리 정책에 따라 감축 시나리오 비교 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3186,
    "requirementIds": [
      "REDUCTION_SCENARIO:REDUCTION_SCENARIO_S1:USER"
    ],
