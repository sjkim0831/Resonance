...
export const screen_auto_fbcdf4994e0c21ec53e5 = {
  ...
  "pageName": "CO2 수요 정보 등록 - 독립 검토·보완·권한 검증 사용자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 CO2 수요 정보 등록 - 독립 검토·보완·권한 검증 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3268,
    "requirementIds": [
      "CO2_DEMAND_REGISTRATION:CO2_DEMAND_REGISTRATION_S3:USER"
    ],
