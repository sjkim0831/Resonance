...
export const screen_auto_55d39e783c3aa047f28f = {
  "id": "auto-55d39e783c3aa047f28f",
  "blueprintCode": "BP_AUTO_55D39E783C3AA047F28F1C67",
  "processCode": "TRADE_EXECUTION_TRACKING",
  "stepCode": "TRADE_EXECUTION_TRACKING_S3",
  "actorCode": "VERIFIER",
  "audience": "USER",
  "pageId": "AUTO_55D39E783C3AA047F28F",
  "pageName": "거래 이행·인수인계 - 독립 검토·보완·권한 검증 사용자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "거래 이행·인수인계 프로세스의 거래 이행·인수인계 - 독립 검토·보완·권한 검증 단계에서 VERIFIER 액터가 TRADE_EXECUTION_TRACKING_REVIEW 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 거래 이행·인수인계 - 독립 검토·보완·권한 검증 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3294,
    "requirementIds": [
      "TRADE_EXECUTION_TRACKING:TRADE_EXECUTION_TRACKING_S3:USER"
    ],
