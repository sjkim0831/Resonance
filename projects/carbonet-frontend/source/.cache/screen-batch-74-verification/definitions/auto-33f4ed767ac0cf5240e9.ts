...
export const screen_auto_33f4ed767ac0cf5240e9 = {
  ...
  "pageName": "인증서 이의신청·감사 - 독립 검토·보완·권한 검증 관리자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "인증서 이의신청·감사 프로세스의 인증서 이의신청·감사 - 독립 검토·보완·권한 검증 단계에서 AUDITOR 액터가 CERTIFICATE_OBJECTION_REVIEW 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "AUDITOR 액터가 권한·업무분리 정책에 따라 인증서 이의신청·감사 - 독립 검토·보완·권한 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3471,
    "requirementIds": [
      "CERTIFICATE_OBJECTION:CERTIFICATE_OBJECTION_S3:ADMIN"
    ],
