...
export const screen_auto_935d620c3d7e11d36162 = {
  ...
  "blueprintCode": "BP_AUTO_935D620C3D7E11D3616261C8",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 감축 성과 보고 - 승인·확정·통지·후속업무 연결 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3205,
    "requirementIds": [
      "REDUCTION_REPORTING:REDUCTION_REPORTING_S4:ADMIN"
    ],
