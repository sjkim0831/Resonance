...
export const screen_auto_e60631ee66ab1f5edcca = {
  "id": "auto-e60631ee66ab1f5edcca",
  "blueprintCode": "BP_AUTO_E60631EE66AB1F5EDCCA78D3",
  ...
  "pageName": "법인·회원사·신청 유효성 검증 관리자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "CERTIFICATE_OFFICER 액터가 권한·업무분리 정책에 따라 법인·회원사·신청 유효성 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "검토 가능한 인증 신청과 잠긴 산정·보고서 데이터셋이 존재한다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
      "신청 주체와 법인 유효성이 확인됨을 검증하고 결과·버전·감사 증적을 저장한 뒤 IN_PROGRESS 상태로 원자적으로 전이한다."
    ],
    "states": [
      "LOADING",
      "EMPTY",
    ...
    "completionRule": "신청 주체와 법인 유효성이 확인됨을 검증하고 결과·버전·감사 증적을 저장한 뒤 IN_PROGRESS 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 461,
      "sharedRuntime": true
    }
  ...
  "traceability": {
    "contractId": 461,
    "requirementIds": [
      "CERTIFICATION_ELIGIBILITY_CHECK:CEC_VALIDATE_COMPANY:ADMIN"
    ],
