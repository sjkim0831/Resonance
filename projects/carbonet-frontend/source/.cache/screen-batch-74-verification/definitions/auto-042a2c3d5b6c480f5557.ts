...
export const screen_auto_042a2c3d5b6c480f5557 = {
  ...
  "blueprintCode": "BP_AUTO_042A2C3D5B6C480F55579337",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SUPPORT_AGENT 액터가 권한·업무분리 정책에 따라 문의 접수·답변 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3404,
    "requirementIds": [
      "CUSTOMER_INQUIRY:CUSTOMER_INQUIRY_S2:USER"
    ],
