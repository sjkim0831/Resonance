...
export const screen_auto_bafc42cb1ed982f10ad9 = {
  ...
  "blueprintCode": "BP_AUTO_BAFC42CB1ED982F10AD9A503",
  ...
  "specification": {
    ...
    "businessPurpose": "프로젝트 종료·보관·재개·취소 프로세스의 보존·잠금·영향평가 단계에서 COMPANY_MANAGER 액터가 PROJECT_LIFECYCLE_CONTROL_EXECUTE_2 명령을 안전하게 수행하고 보존·잠금·영향평가의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "COMPANY_MANAGER 액터가 권한·업무분리 정책에 따라 보존·잠금·영향평가 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "전환 요청자와 사유, 미결 태스크, 보존 정책이 확인된다.을 충족하고 현재 상태가 STEP_1_COMPLETED이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
      "보존·잠금·영향평가의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 STEP_2_COMPLETED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "STEP_1_COMPLETED",
      "LOADING",
    ...
    "completionRule": "보존·잠금·영향평가의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 STEP_2_COMPLETED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 3791,
      "sharedRuntime": true
    }
  ...
  "traceability": {
    "contractId": 3791,
    "requirementIds": [
      "PROJECT_LIFECYCLE_CONTROL:PROJECT_LIFECYCLE_CONTROL_S2:ADMIN"
    ],
