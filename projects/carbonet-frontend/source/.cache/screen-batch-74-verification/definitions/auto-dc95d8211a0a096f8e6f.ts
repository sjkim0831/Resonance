...
export const screen_auto_dc95d8211a0a096f8e6f = {
  ...
  "pageName": "API 키 수명주기 관리 - 요청·범위·필수정보 확인 관리자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SYSTEM_INTEGRATOR 액터가 권한·업무분리 정책에 따라 API 키 수명주기 관리 - 요청·범위·필수정보 확인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3491,
    "requirementIds": [
      "API_KEY_LIFECYCLE:API_KEY_LIFECYCLE_S1:ADMIN"
    ],
