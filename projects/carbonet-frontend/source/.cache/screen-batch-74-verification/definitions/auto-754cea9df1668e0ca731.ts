...
export const screen_auto_754cea9df1668e0ca731 = {
  ...
  "blueprintCode": "BP_AUTO_754CEA9DF1668E0CA7313FEA",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "CERTIFICATE_OFFICER 액터가 권한·업무분리 정책에 따라 탄소크레딧 발급·보유·소각 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3328,
    "requirementIds": [
      "CARBON_CREDIT_MANAGEMENT:CARBON_CREDIT_MANAGEMENT_S1:USER"
    ],
