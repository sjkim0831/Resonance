...
export const screen_auto_c84c15e0ba7d12c3272f = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "MAINTENANCE_ENGINEER 액터가 권한·업무분리 정책에 따라 위험기반 정비계획 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "설비 자산과 정비주기 및 위험등급이 확정되어 있다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
  ...
  "traceability": {
    "contractId": 323,
    "requirementIds": [
      "PREVENTIVE_MAINTENANCE:PM_PLAN:ADMIN"
    ],
