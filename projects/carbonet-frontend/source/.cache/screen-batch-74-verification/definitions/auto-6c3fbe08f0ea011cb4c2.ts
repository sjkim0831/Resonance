...
export const screen_auto_6c3fbe08f0ea011cb4c2 = {
  ...
  "pageName": "제한사항 포함 공개 승인 사용자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 제한사항 포함 공개 승인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3114,
    "requirementIds": [
      "COMPARATIVE_ASSERTION_REVIEW:COMPARATIVE_ASSERTION_REVIEW_S4:USER"
    ],
