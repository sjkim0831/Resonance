...
export const screen_auto_ea50835f2d7f25f8f84a = {
  "id": "auto-ea50835f2d7f25f8f84a",
  ...
  "pageName": "외부 서비스 상태 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 외부 서비스 상태 관리 - 승인·확정·통지·후속업무 연결 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3085,
    "requirementIds": [
      "EXTERNAL_SERVICE_STATUS:EXTERNAL_SERVICE_STATUS_S4:ADMIN"
    ],
