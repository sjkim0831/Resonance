...
export const screen_auto_86d57335f6726b46e13f = {
  ...
  "blueprintCode": "BP_AUTO_86D57335F6726B46E13F2933",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SYSTEM_INTEGRATOR 액터가 권한·업무분리 정책에 따라 동기화 실행·스케줄 - 업무 실행·중간 결과 저장 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3519,
    "requirementIds": [
      "SYNC_EXECUTION:SYNC_EXECUTION_S2:ADMIN"
    ],
