...
export const screen_auto_fefc385737c94c22fadb = {
  ...
  "blueprintCode": "BP_AUTO_FEFC385737C94C22FADB04E3",
  "processCode": "WEBHOOK_MANAGEMENT",
  "stepCode": "WEBHOOK_MANAGEMENT_S3",
  "actorCode": "VERIFIER",
  "audience": "ADMIN",
  ...
  "specification": {
    ...
    "businessPurpose": "웹훅 관리 프로세스의 웹훅 관리 - 독립 검토·보완·권한 검증 단계에서 VERIFIER 액터가 WEBHOOK_MANAGEMENT_REVIEW 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 웹훅 관리 - 독립 검토·보완·권한 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
    ...
    "kpis": [
      {
        ...
        "unit": "PERCENT",
        "label": "웹훅 관리 - 독립 검토·보완·권한 검증 완료율"
      },
      {
        "code": "SLA_REMAINING",
        "unit": "MINUTE",
    ...
    "actions": [
      {
        "code": "WEBHOOK_MANAGEMENT_REVIEW",
        "label": "웹훅 관리 - 독립 검토·보완·권한 검증 실행",
        "transactional": true,
    ...
    "apiContracts": [
      ...
      },
      {
        ...
        "method": "POST",
        "purpose": "웹훅 관리 - 독립 검토·보완·권한 검증 상태 명령 실행"
      },
      {
        "code": "LOAD_DRAFT",
  ...
  "traceability": {
    "contractId": 3513,
    "requirementIds": [
      "WEBHOOK_MANAGEMENT:WEBHOOK_MANAGEMENT_S3:ADMIN"
    ],
