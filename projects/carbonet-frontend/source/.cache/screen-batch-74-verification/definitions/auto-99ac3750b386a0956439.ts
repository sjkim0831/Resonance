...
export const screen_auto_99ac3750b386a0956439 = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "STORAGE_SITE_MANAGER 액터가 권한·업무분리 정책에 따라 주입계획·허용한계 설정 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "승인된 저장소·주입정·운영계획과 유효 계측기가 존재한다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
      "허가조건 내 주입계획이 승인됨을 검증하고 결과·버전·감사 증적을 저장한 뒤 PLANNED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "LOADING",
      "EMPTY",
    ...
    "completionRule": "허가조건 내 주입계획이 승인됨을 검증하고 결과·버전·감사 증적을 저장한 뒤 PLANNED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 329,
      "sharedRuntime": true
    }
  ...
  "traceability": {
    "contractId": 329,
    "requirementIds": [
      "CO2_INJECTION_STORAGE_OPERATION:CISO_PLAN:ADMIN"
    ],
