...
export const screen_auto_3015f4c52df22c174431 = {
  "id": "auto-3015f4c52df22c174431",
  "blueprintCode": "BP_AUTO_3015F4C52DF22C174431260F",
  "processCode": "DATA_QUALITY_MONITORING",
  "stepCode": "DATA_QUALITY_MONITORING_S3",
  "actorCode": "VERIFIER",
  "audience": "USER",
  "pageId": "AUTO_3015F4C52DF22C174431",
  "pageName": "데이터 품질 모니터링 - 독립 검토·보완·권한 검증 사용자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "데이터 품질 모니터링 프로세스의 데이터 품질 모니터링 - 독립 검토·보완·권한 검증 단계에서 VERIFIER 액터가 DATA_QUALITY_MONITORING_REVIEW 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 데이터 품질 모니터링 - 독립 검토·보완·권한 검증 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3218,
    "requirementIds": [
      "DATA_QUALITY_MONITORING:DATA_QUALITY_MONITORING_S3:USER"
    ],
