...
export const screen_auto_0a9ba2ed0bdb4603001d = {
  ...
  "blueprintCode": "BP_AUTO_0A9BA2ED0BDB4603001D819D",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "CERTIFICATE_OFFICER 액터가 권한·업무분리 정책에 따라 탄소크레딧 발급·보유·소각 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3330,
    "requirementIds": [
      "CARBON_CREDIT_MANAGEMENT:CARBON_CREDIT_MANAGEMENT_S2:USER"
    ],
