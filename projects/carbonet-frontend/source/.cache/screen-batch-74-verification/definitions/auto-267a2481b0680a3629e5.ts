...
export const screen_auto_267a2481b0680a3629e5 = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "FACILITY_OPERATOR 액터가 권한·업무분리 정책에 따라 사고 탐지·비상 선언 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "비상대응 조직·연락망·대응계획과 훈련 이력이 유효하다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
  ...
  "traceability": {
    "contractId": 335,
    "requirementIds": [
      "FACILITY_EMERGENCY_RESPONSE:FER_DECLARE:ADMIN"
    ],
