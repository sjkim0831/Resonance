...
export const screen_auto_a8a3ce349c5f1c3f1989 = {
  ...
  "blueprintCode": "BP_AUTO_A8A3CE349C5F1C3F1989EEFA",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "REDUCTION_MANAGER 액터가 권한·업무분리 정책에 따라 감축 로드맵 수립 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3102,
    "requirementIds": [
      "REDUCTION_ROADMAP:REDUCTION_ROADMAP_S2:USER"
    ],
