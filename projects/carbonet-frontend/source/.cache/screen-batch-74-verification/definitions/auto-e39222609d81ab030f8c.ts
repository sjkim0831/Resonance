...
export const screen_auto_e39222609d81ab030f8c = {
  "id": "auto-e39222609d81ab030f8c",
  "blueprintCode": "BP_AUTO_E39222609D81AB030F8CDF19",
  "processCode": "REDUCTION_SCENARIO",
  "stepCode": "REDUCTION_SCENARIO_S1",
  "actorCode": "DATA_ANALYST",
  "audience": "ADMIN",
  "pageId": "AUTO_E39222609D81AB030F8C",
  "pageName": "감축 시나리오 비교 - 요청·범위·필수정보 확인 관리자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "감축 시나리오 비교 프로세스의 감축 시나리오 비교 - 요청·범위·필수정보 확인 단계에서 DATA_ANALYST 액터가 REDUCTION_SCENARIO_REQUEST 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "DATA_ANALYST 액터가 권한·업무분리 정책에 따라 감축 시나리오 비교 - 요청·범위·필수정보 확인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3187,
    "requirementIds": [
      "REDUCTION_SCENARIO:REDUCTION_SCENARIO_S1:ADMIN"
    ],
