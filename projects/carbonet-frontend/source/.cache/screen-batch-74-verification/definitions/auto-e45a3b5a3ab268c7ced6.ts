...
export const screen_auto_e45a3b5a3ab268c7ced6 = {
  "id": "auto-e45a3b5a3ab268c7ced6",
  "blueprintCode": "BP_AUTO_E45A3B5A3AB268C7CED66F1A",
  "processCode": "EXTERNAL_SERVICE_STATUS",
  "stepCode": "EXTERNAL_SERVICE_STATUS_S4",
  "actorCode": "APPROVER",
  "audience": "USER",
  "pageId": "AUTO_E45A3B5A3AB268C7CED6",
  "pageName": "외부 서비스 상태 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "외부 서비스 상태 관리 프로세스의 외부 서비스 상태 관리 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 EXTERNAL_SERVICE_STATUS_COMPLETE 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 외부 서비스 상태 관리 - 승인·확정·통지·후속업무 연결 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3084,
    "requirementIds": [
      "EXTERNAL_SERVICE_STATUS:EXTERNAL_SERVICE_STATUS_S4:USER"
    ],
