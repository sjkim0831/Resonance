...
export const screen_auto_49316a0e38b9266cc83f = {
  ...
  "blueprintCode": "BP_AUTO_49316A0E38B9266CC83F0301",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "TRADE_OPERATOR 액터가 권한·업무분리 정책에 따라 CO2 수요 정보 등록 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3262,
    "requirementIds": [
      "CO2_DEMAND_REGISTRATION:CO2_DEMAND_REGISTRATION_S1:USER"
    ],
