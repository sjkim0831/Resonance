...
export const screen_auto_24805b2ebb91487217fa = {
  ...
  "blueprintCode": "BP_AUTO_24805B2EBB91487217FA57B9",
  ...
  "specification": {
    ...
    "businessPurpose": "CO2 공급 정보 등록 프로세스의 CO2 공급 정보 등록 - 업무 실행·중간 결과 저장 단계에서 TRADE_OPERATOR 액터가 CO2_SUPPLY_REGISTRATION_EXECUTE 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "TRADE_OPERATOR 액터가 권한·업무분리 정책에 따라 CO2 공급 정보 등록 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3256,
    "requirementIds": [
      "CO2_SUPPLY_REGISTRATION:CO2_SUPPLY_REGISTRATION_S2:USER"
    ],
