...
export const screen_auto_d92f7243a564e5653346 = {
  ...
  "blueprintCode": "BP_AUTO_D92F7243A564E5653346E7FF",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SYSTEM_INTEGRATOR 액터가 권한·업무분리 정책에 따라 API 키 수명주기 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3492,
    "requirementIds": [
      "API_KEY_LIFECYCLE:API_KEY_LIFECYCLE_S2:USER"
    ],
