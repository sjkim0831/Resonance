...
export const screen_auto_39eccad94c3a6e791ecf = {
  ...
  "blueprintCode": "BP_AUTO_39ECCAD94C3A6E791ECFC875",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "MEMBER_ADMIN 액터가 권한·업무분리 정책에 따라 휴면·잠금 계정 복구 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3018,
    "requirementIds": [
      "ACCOUNT_LOCK_RECOVERY:ACCOUNT_LOCK_RECOVERY_S1:USER"
    ],
