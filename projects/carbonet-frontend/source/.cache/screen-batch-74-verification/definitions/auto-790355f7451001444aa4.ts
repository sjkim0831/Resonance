...
export const screen_auto_790355f7451001444aa4 = {
  "id": "auto-790355f7451001444aa4",
  "blueprintCode": "BP_AUTO_790355F7451001444AA4B7AD",
  "processCode": "LEGAL_NOTIFICATION_DELIVERY",
  "stepCode": "LND_COMPOSE",
  "actorCode": "PLATFORM_OPERATOR",
  "audience": "USER",
  "pageId": "AUTO_790355F7451001444AA4",
  "pageName": "통지 사건·템플릿·대상 확정 사용자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "PLATFORM_OPERATOR 액터가 권한·업무분리 정책에 따라 통지 사건·템플릿·대상 확정 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "통지 사건·대상자·동의·템플릿·우선 채널·대체 채널 정책이 존재한다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
  ...
  "traceability": {
    "contractId": 496,
    "requirementIds": [
      "LEGAL_NOTIFICATION_DELIVERY:LND_COMPOSE:USER"
    ],
