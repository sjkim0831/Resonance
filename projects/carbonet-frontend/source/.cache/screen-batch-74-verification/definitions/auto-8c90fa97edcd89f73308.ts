...
export const screen_auto_8c90fa97edcd89f73308 = {
  ...
  "blueprintCode": "BP_AUTO_8C90FA97EDCD89F73308A714",
  "processCode": "REDUCTION_PROJECT_REGISTRATION",
  "stepCode": "REDUCTION_PROJECT_REGISTRATION_S3",
  "actorCode": "VERIFIER",
  "audience": "ADMIN",
  ...
  "specification": {
    ...
    "businessPurpose": "감축 과제 등록 프로세스의 감축 과제 등록 - 독립 검토·보완·권한 검증 단계에서 VERIFIER 액터가 REDUCTION_PROJECT_REGISTRATION_REVIEW 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 감축 과제 등록 - 독립 검토·보완·권한 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3167,
    "requirementIds": [
      "REDUCTION_PROJECT_REGISTRATION:REDUCTION_PROJECT_REGISTRATION_S3:ADMIN"
    ],
