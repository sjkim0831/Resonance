...
export const screen_auto_b1ed8b912be8c438ef76 = {
  ...
  "blueprintCode": "BP_AUTO_B1ED8B912BE8C438EF761067",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SYSTEM_INTEGRATOR 액터가 권한·업무분리 정책에 따라 웹훅 관리 - 요청·범위·필수정보 확인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3509,
    "requirementIds": [
      "WEBHOOK_MANAGEMENT:WEBHOOK_MANAGEMENT_S1:ADMIN"
    ],
