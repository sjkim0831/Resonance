...
export const screen_auto_d4ca6aec859f155ccd00 = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "REGULATOR 액터가 권한·업무분리 정책에 따라 규제 대응 현황 관리 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
