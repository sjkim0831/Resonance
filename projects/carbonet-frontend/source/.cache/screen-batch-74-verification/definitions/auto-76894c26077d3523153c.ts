...
export const screen_auto_76894c26077d3523153c = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "DATA_ANALYST 액터가 권한·업무분리 정책에 따라 지표·주기·기준시점 확정 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "지표 정의·집계 기준·데이터 기준시점·수신기관·일정이 승인되어 있다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
  ...
  "traceability": {
    "contractId": 485,
    "requirementIds": [
      "SCHEDULED_STATISTICS_REPORTING:SSR_DEFINE:ADMIN"
    ],
