...
export const screen_auto_6d2e0ea6dfbd77c5c4a5 = {
  ...
  "specification": {
    ...
    "businessPurpose": "API 키 수명주기 관리 프로세스의 API 키 수명주기 관리 - 요청·범위·필수정보 확인 단계에서 SYSTEM_INTEGRATOR 액터가 API_KEY_LIFECYCLE_REQUEST 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "SYSTEM_INTEGRATOR 액터가 권한·업무분리 정책에 따라 API 키 수명주기 관리 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3490,
    "requirementIds": [
      "API_KEY_LIFECYCLE:API_KEY_LIFECYCLE_S1:USER"
    ],
