...
export const screen_auto_2d200151037c9ea0f9d8 = {
  ...
  "blueprintCode": "BP_AUTO_2D200151037C9EA0F9D84ECC",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "AUDITOR 액터가 권한·업무분리 정책에 따라 인증서 이의신청·감사 - 독립 검토·보완·권한 검증 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3470,
    "requirementIds": [
      "CERTIFICATE_OBJECTION:CERTIFICATE_OBJECTION_S3:USER"
    ],
