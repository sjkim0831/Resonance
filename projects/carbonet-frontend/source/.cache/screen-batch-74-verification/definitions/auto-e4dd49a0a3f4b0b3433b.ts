...
export const screen_auto_e4dd49a0a3f4b0b3433b = {
  "id": "auto-e4dd49a0a3f4b0b3433b",
  "blueprintCode": "BP_AUTO_E4DD49A0A3F4B0B3433BB862",
  "processCode": "CO2_QUALITY_ANALYSIS",
  "stepCode": "CQA_PLAN",
  "actorCode": "LAB_ANALYST",
  "audience": "USER",
  "pageId": "AUTO_E4DD49A0A3F4B0B3433B",
  "pageName": "성분예측·시료·시험계획 사용자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "LAB_ANALYST 액터가 권한·업무분리 정책에 따라 성분예측·시료·시험계획 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "추적 가능한 CO2 로트와 시료채취 지점, 품질 기준이 존재한다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
  ...
  "traceability": {
    "contractId": 454,
    "requirementIds": [
      "CO2_QUALITY_ANALYSIS:CQA_PLAN:USER"
    ],
