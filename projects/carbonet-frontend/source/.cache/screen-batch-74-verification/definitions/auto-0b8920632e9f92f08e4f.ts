...
export const screen_auto_0b8920632e9f92f08e4f = {
  ...
  "pageName": "데이터 품질 모니터링 - 독립 검토·보완·권한 검증 관리자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 데이터 품질 모니터링 - 독립 검토·보완·권한 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3219,
    "requirementIds": [
      "DATA_QUALITY_MONITORING:DATA_QUALITY_MONITORING_S3:ADMIN"
    ],
