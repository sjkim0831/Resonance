...
export const screen_auto_4a20b9ff0e7c1e39b937 = {
  ...
  "blueprintCode": "BP_AUTO_4A20B9FF0E7C1E39B9374D1B",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "REDUCTION_MANAGER 액터가 권한·업무분리 정책에 따라 감축 로드맵 수립 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3160,
    "requirementIds": [
      "REDUCTION_ROADMAP:REDUCTION_ROADMAP_S1:USER"
    ],
