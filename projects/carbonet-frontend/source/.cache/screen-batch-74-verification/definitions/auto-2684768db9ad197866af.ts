...
export const screen_auto_2684768db9ad197866af = {
  ...
  "pageName": "품질등급 승인·개선조치 관리자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "측정기기·교정·데이터 품질 프로세스의 품질등급 승인·개선조치 단계에서 APPROVER 액터가 MEASUREMENT_DATA_QUALITY_EXECUTE_4 명령을 안전하게 수행하고 품질등급 승인·개선조치의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 품질등급 승인·개선조치 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "측정 지점·기기·교정주기와 수집 채널이 등록되어 있다.을 충족하고 현재 상태가 STEP_3_COMPLETED이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
      "품질등급 승인·개선조치의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 STEP_4_COMPLETED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "STEP_3_COMPLETED",
      "LOADING",
    ...
    "completionRule": "품질등급 승인·개선조치의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.을 검증하고 결과·버전·감사 증적을 저장한 뒤 STEP_4_COMPLETED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 3779,
      "sharedRuntime": true
    }
  ...
  "traceability": {
    "contractId": 3779,
    "requirementIds": [
      "MEASUREMENT_DATA_QUALITY:MEASUREMENT_DATA_QUALITY_S4:ADMIN"
    ],
