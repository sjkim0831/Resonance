...
export const screen_auto_1586736f2b385de73eb4 = {
  ...
  "blueprintCode": "BP_AUTO_1586736F2B385DE73EB4C50F",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 이상치·경보 관리 - 독립 검토·보완·권한 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3227,
    "requirementIds": [
      "ANOMALY_ALERT_MANAGEMENT:ANOMALY_ALERT_MANAGEMENT_S3:ADMIN"
    ],
