...
export const screen_auto_8da0df6dc424ff2a132a = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SETTLEMENT_OPERATOR 액터가 권한·업무분리 정책에 따라 수수료·가상계좌·청구 생성 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "적격성 검증을 통과한 인증 신청과 유효한 법인 청구정보가 존재한다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
  ...
  "traceability": {
    "contractId": 466,
    "requirementIds": [
      "CERTIFICATE_FEE_TAX_REFUND:CFTR_BILL:USER"
    ],
