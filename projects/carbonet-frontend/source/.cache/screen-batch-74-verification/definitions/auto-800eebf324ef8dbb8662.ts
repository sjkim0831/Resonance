...
export const screen_auto_800eebf324ef8dbb8662 = {
  ...
  "blueprintCode": "BP_AUTO_800EEBF324EF8DBB8662493B",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "REGULATOR 액터가 권한·업무분리 정책에 따라 규제 대응 현황 관리 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3234,
    "requirementIds": [
      "REGULATORY_STATUS_MONITORING:REGULATORY_STATUS_MONITORING_S2:USER"
    ],
