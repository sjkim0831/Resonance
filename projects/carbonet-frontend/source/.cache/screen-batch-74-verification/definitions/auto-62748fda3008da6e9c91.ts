...
export const screen_auto_62748fda3008da6e9c91 = {
  ...
  "blueprintCode": "BP_AUTO_62748FDA3008DA6E9C91AD0E",
  "processCode": "DATA_QUALITY_MONITORING",
  "stepCode": "DATA_QUALITY_MONITORING_S2",
  "actorCode": "VERIFIER",
  "audience": "ADMIN",
  ...
  "specification": {
    ...
    "businessPurpose": "데이터 품질 모니터링 프로세스의 데이터 품질 모니터링 - 업무 실행·중간 결과 저장 단계에서 VERIFIER 액터가 DATA_QUALITY_MONITORING_EXECUTE 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 데이터 품질 모니터링 - 업무 실행·중간 결과 저장 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
    ...
    "kpis": [
      {
        ...
        "unit": "PERCENT",
        "label": "데이터 품질 모니터링 - 업무 실행·중간 결과 저장 완료율"
      },
      {
        "code": "SLA_REMAINING",
        "unit": "MINUTE",
    ...
    "actions": [
      {
        "code": "DATA_QUALITY_MONITORING_EXECUTE",
        "label": "데이터 품질 모니터링 - 업무 실행·중간 결과 저장 실행",
        "transactional": true,
    ...
    "apiContracts": [
      ...
      },
      {
        ...
        "method": "POST",
        "purpose": "데이터 품질 모니터링 - 업무 실행·중간 결과 저장 상태 명령 실행"
      },
      {
        "code": "LOAD_DRAFT",
  ...
  "traceability": {
    "contractId": 3217,
    "requirementIds": [
      "DATA_QUALITY_MONITORING:DATA_QUALITY_MONITORING_S2:ADMIN"
    ],
