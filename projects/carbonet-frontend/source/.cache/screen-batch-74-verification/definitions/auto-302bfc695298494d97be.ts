...
export const screen_auto_302bfc695298494d97be = {
  ...
  "specification": {
    ...
    "entryConditions": [
      "운영 가능한 설비와 유효한 계측기가 등록되어 있다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
      "승인 운전창과 알람 기준이 확정됨을 검증하고 결과·버전·감사 증적을 저장한 뒤 PLANNED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "LOADING",
      "EMPTY",
    ...
    "completionRule": "승인 운전창과 알람 기준이 확정됨을 검증하고 결과·버전·감사 증적을 저장한 뒤 PLANNED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 310,
      "sharedRuntime": true
    }
