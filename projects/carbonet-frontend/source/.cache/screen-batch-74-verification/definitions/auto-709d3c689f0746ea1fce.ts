...
export const screen_auto_709d3c689f0746ea1fce = {
  ...
  "blueprintCode": "BP_AUTO_709D3C689F0746EA1FCEAD77",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SETTLEMENT_OPERATOR 액터가 권한·업무분리 정책에 따라 거래 정산 - 요청·범위·필수정보 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3298,
    "requirementIds": [
      "TRADE_SETTLEMENT:TRADE_SETTLEMENT_S1:USER"
    ],
