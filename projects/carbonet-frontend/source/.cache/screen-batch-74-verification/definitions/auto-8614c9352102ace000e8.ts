...
export const screen_auto_8614c9352102ace000e8 = {
  ...
  "blueprintCode": "BP_AUTO_8614C9352102ACE000E838ED",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 거래 정산 - 승인·확정·통지·후속업무 연결 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3303,
    "requirementIds": [
      "TRADE_SETTLEMENT:TRADE_SETTLEMENT_S4:ADMIN"
    ],
