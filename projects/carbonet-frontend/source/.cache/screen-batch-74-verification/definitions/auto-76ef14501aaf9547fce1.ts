...
export const screen_auto_76ef14501aaf9547fce1 = {
  "id": "auto-76ef14501aaf9547fce1",
  "blueprintCode": "BP_AUTO_76EF14501AAF9547FCE17A46",
  "processCode": "CALCULATION_ENGINE_PARITY",
  "stepCode": "CEP_BASELINE",
  "actorCode": "VERIFIER",
  "audience": "ADMIN",
  "pageId": "AUTO_76EF14501AAF9547FCE1",
  "pageName": "VBA 기준 사례·버전 잠금 관리자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 VBA 기준 사례·버전 잠금 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "승인된 기준 사례·수식·LCI DB·배출계수·단위 버전과 허용오차가 존재한다.을 충족하고 현재 상태가 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우 진입한다."
    ],
    "exitConditions": [
  ...
  "traceability": {
    "contractId": 491,
    "requirementIds": [
      "CALCULATION_ENGINE_PARITY:CEP_BASELINE:ADMIN"
    ],
