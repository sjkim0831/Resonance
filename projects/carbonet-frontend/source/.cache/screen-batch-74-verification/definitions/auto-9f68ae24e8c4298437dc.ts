...
export const screen_auto_9f68ae24e8c4298437dc = {
  ...
  "blueprintCode": "BP_AUTO_9F68AE24E8C4298437DC8030",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 공지사항 게시 - 승인·확정·통지·후속업무 연결 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3390,
    "requirementIds": [
      "NOTICE_PUBLICATION:NOTICE_PUBLICATION_S4:USER"
    ],
