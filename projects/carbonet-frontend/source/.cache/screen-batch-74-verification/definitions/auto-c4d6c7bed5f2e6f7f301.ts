...
export const screen_auto_c4d6c7bed5f2e6f7f301 = {
  ...
  "blueprintCode": "BP_AUTO_C4D6C7BED5F2E6F7F3011B0E",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SETTLEMENT_OPERATOR 액터가 권한·업무분리 정책에 따라 거래 정산 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3300,
    "requirementIds": [
      "TRADE_SETTLEMENT:TRADE_SETTLEMENT_S2:USER"
    ],
