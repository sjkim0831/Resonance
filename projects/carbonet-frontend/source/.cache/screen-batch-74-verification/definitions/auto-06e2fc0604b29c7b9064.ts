...
export const screen_auto_06e2fc0604b29c7b9064 = {
  ...
  "blueprintCode": "BP_AUTO_06E2FC0604B29C7B90644D63",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "COMPANY_MANAGER 액터가 권한·업무분리 정책에 따라 보고서 제출·접수 - 업무 실행·중간 결과 저장 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3444,
    "requirementIds": [
      "REPORT_SUBMISSION:REPORT_SUBMISSION_S2:USER"
    ],
