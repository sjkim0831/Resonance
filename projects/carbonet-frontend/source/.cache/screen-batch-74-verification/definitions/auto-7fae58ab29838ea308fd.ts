...
export const screen_auto_7fae58ab29838ea308fd = {
  "id": "auto-7fae58ab29838ea308fd",
  "blueprintCode": "BP_AUTO_7FAE58AB29838EA308FD712E",
  "processCode": "CO2_DEMAND_REGISTRATION",
  "stepCode": "CO2_DEMAND_REGISTRATION_S3",
  "actorCode": "VERIFIER",
  "audience": "ADMIN",
  "pageId": "AUTO_7FAE58AB29838EA308FD",
  "pageName": "CO2 수요 정보 등록 - 독립 검토·보완·권한 검증 관리자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "CO2 수요 정보 등록 프로세스의 CO2 수요 정보 등록 - 독립 검토·보완·권한 검증 단계에서 VERIFIER 액터가 CO2_DEMAND_REGISTRATION_REVIEW 명령을 안전하게 수행하고 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.를 완료한다.",
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 CO2 수요 정보 등록 - 독립 검토·보완·권한 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3269,
    "requirementIds": [
      "CO2_DEMAND_REGISTRATION:CO2_DEMAND_REGISTRATION_S3:ADMIN"
    ],
