...
export const screen_auto_1560b5e4c0d040642d53 = {
  ...
  "specification": {
    ...
    "businessPurpose": "내 정보·알림·보안 설정 프로세스의 내 정보·알림·보안 설정 - 요청·범위·필수정보 확인 단계에서 MEMBER_USER 액터가 PROFILE_MANAGEMENT_REQUEST 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
