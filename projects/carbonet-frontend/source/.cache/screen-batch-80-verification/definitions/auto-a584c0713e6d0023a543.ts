...
export const screen_auto_a584c0713e6d0023a543 = {
  ...
  "blueprintCode": "BP_AUTO_A584C0713E6D0023A543D50C",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SITE_DATA_OWNER 액터가 권한·업무분리 정책에 따라 경보 수신·상황 등급화 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3764,
    "requirementIds": [
      "LEAKAGE_INCIDENT_RESPONSE:LEAKAGE_INCIDENT_RESPONSE_S1:USER"
    ],
