...
export const screen_auto_b5811d8975fe6e4a74e3 = {
  ...
  "specification": {
    ...
    "businessPurpose": "공급·수요 매칭 프로세스의 공급·수요 매칭 - 업무 실행·중간 결과 저장 단계에서 TRADE_OPERATOR 액터가 SUPPLY_DEMAND_MATCHING_EXECUTE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
