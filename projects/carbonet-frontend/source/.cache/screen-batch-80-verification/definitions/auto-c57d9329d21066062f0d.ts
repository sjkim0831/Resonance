...
export const screen_auto_c57d9329d21066062f0d = {
  ...
  "blueprintCode": "BP_AUTO_C57D9329D21066062F0D7C63",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 마이그레이션 결정·감사기록 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3080,
    "requirementIds": [
      "BACKGROUND_DB_VERSION_IMPACT:BACKGROUND_DB_VERSION_IMPACT_S4:USER"
    ],
