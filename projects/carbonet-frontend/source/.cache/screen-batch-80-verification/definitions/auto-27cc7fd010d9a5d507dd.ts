...
export const screen_auto_27cc7fd010d9a5d507dd = {
  ...
  "specification": {
    ...
    "businessPurpose": "로그인·세션·로그아웃 프로세스의 로그인·세션·로그아웃 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 LOGIN_AUTHENTICATION_COMPLETE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
