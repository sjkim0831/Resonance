...
export const screen_auto_4552395f8d80d69853b7 = {
  ...
  "specification": {
    ...
    "businessPurpose": "교육 수료·수료증 발급 프로세스의 교육 수료·수료증 발급 - 요청·범위·필수정보 확인 단계에서 CERTIFICATE_OFFICER 액터가 TRAINING_CERTIFICATE_REQUEST 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
