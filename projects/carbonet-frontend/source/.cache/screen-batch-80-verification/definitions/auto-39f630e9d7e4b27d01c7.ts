...
export const screen_auto_39f630e9d7e4b27d01c7 = {
  ...
  "specification": {
    ...
    "businessPurpose": "배치·스케줄 운영 프로세스의 배치·스케줄 운영 - 요청·범위·필수정보 확인 단계에서 PLATFORM_OPERATOR 액터가 BATCH_SCHEDULE_OPERATION_REQUEST 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
