...
export const screen_auto_ab6dc4c6dcbcc0866168 = {
  ...
  "specification": {
    ...
    "businessPurpose": "다중인증 등록·복구 프로세스의 다중인증 등록·복구 - 요청·범위·필수정보 확인 단계에서 MEMBER_USER 액터가 MFA_MANAGEMENT_REQUEST 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
