...
export const screen_auto_de5fd1e69997b506fffa = {
  ...
  "specification": {
    ...
    "businessPurpose": "분석 데이터 내보내기 프로세스의 분석 데이터 내보내기 - 요청·범위·필수정보 확인 단계에서 DATA_ANALYST 액터가 ANALYSIS_EXPORT_REQUEST 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
