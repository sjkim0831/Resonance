...
export const screen_auto_30298adcae34b192eea8 = {
  ...
  "specification": {
    ...
    "businessPurpose": "감축 시나리오 비교 프로세스의 감축 시나리오 비교 - 독립 검토·보완·권한 검증 단계에서 VERIFIER 액터가 REDUCTION_SCENARIO_REVIEW 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
