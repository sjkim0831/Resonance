...
export const screen_auto_c7e682aec851b9d45504 = {
  ...
  "blueprintCode": "BP_AUTO_C7E682AEC851B9D4550446F1",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "LCA_PRACTITIONER 액터가 권한·업무분리 정책에 따라 다중 산출물·관계자료 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3748,
    "requirementIds": [
      "LCA_ALLOCATION_SENSITIVITY:LCA_ALLOCATION_SENSITIVITY_S1:USER"
    ],
