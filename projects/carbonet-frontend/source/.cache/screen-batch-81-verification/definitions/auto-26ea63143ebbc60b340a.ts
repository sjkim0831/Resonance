...
export const screen_auto_26ea63143ebbc60b340a = {
  ...
  "specification": {
    ...
    "businessPurpose": "CO2 공급 정보 등록 프로세스의 CO2 공급 정보 등록 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 CO2_SUPPLY_REGISTRATION_COMPLETE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
