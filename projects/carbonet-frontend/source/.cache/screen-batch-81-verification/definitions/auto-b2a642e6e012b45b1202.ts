...
export const screen_auto_b2a642e6e012b45b1202 = {
  ...
  "blueprintCode": "BP_AUTO_B2A642E6E012B45B1202DCD2",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 EPD·PCF 필수항목 검증 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3785,
    "requirementIds": [
      "PCR_EPD_VERIFICATION:PCR_EPD_VERIFICATION_S3:ADMIN"
    ],
