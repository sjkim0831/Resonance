...
export const screen_auto_bea433e0b4f34c05d44d = {
  ...
  "specification": {
    ...
    "businessPurpose": "한계감축비용·포트폴리오 프로세스의 한계감축비용·포트폴리오 - 요청·범위·필수정보 확인 단계에서 DATA_ANALYST 액터가 MACC_PORTFOLIO_REQUEST 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
