...
export const screen_auto_d572b5668363aa0032e6 = {
  ...
  "specification": {
    ...
    "businessPurpose": "내 정보·알림·보안 설정 프로세스의 내 정보·알림·보안 설정 - 업무 실행·중간 결과 저장 단계에서 MEMBER_USER 액터가 PROFILE_MANAGEMENT_EXECUTE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
