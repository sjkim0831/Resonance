...
export const screen_auto_229916390facf4dd3353 = {
  ...
  "specification": {
    ...
    "businessPurpose": "보안 정책·접근 통제 프로세스의 보안 정책·접근 통제 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 SECURITY_POLICY_OPERATION_COMPLETE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
