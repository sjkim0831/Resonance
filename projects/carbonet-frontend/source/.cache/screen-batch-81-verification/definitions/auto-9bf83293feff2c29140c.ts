...
export const screen_auto_9bf83293feff2c29140c = {
  ...
  "specification": {
    ...
    "businessPurpose": "테마·섹션·컴포넌트·CSS 관리 프로세스의 테마·섹션·컴포넌트·CSS 관리 - 요청·범위·필수정보 확인 단계에서 PLATFORM_OPERATOR 액터가 DESIGN_ASSET_GOVERNANCE_REQUEST 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
