...
export const screen_auto_29dd8cf503ed45688557 = {
  ...
  "blueprintCode": "BP_AUTO_29DD8CF503ED45688557A0DC",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 대안별 재계산·민감도 비교 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3753,
    "requirementIds": [
      "LCA_ALLOCATION_SENSITIVITY:LCA_ALLOCATION_SENSITIVITY_S3:ADMIN"
    ],
