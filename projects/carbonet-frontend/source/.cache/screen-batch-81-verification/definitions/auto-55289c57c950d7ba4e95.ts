...
export const screen_auto_55289c57c950d7ba4e95 = {
  "id": "auto-55289c57c950d7ba4e95",
  "blueprintCode": "BP_ADOPT_55289C57C95037BA8E95",
  ...
  "specification": {
    ...
    "apiContracts": [
      {
        "code": "API_1",
        "label": "GET|POST /home/api/emission-projects/{id}/activity-requests; POST /home/api/emission-projects/{id}/activity-requests/{requestId}/start"
      }
    ],
    "dataContracts": [
      {
  ...
  "traceability": {
    "contractId": 66,
    "requirementIds": [
      "ACTIVITY_DATA:ACTIVITY_DATA_01_PLAN:USER"
    ],
