...
export const screen_auto_257f7a704a62906451c3 = {
  ...
  "blueprintCode": "BP_AUTO_257F7A704A62906451C3FA93",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 결정 통지·시정·종결 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3716,
    "requirementIds": [
      "APPEAL_DISPUTE_AUDIT:APPEAL_DISPUTE_AUDIT_S4:USER"
    ],
