...
export const screen_auto_b0040eb24d45bc9daf8e = {
  ...
  "blueprintCode": "BP_AUTO_B0040EB24D45BC9DAF8E13C9",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "COMPANY_MANAGER 액터가 권한·업무분리 정책에 따라 전환 요청·미결업무 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3788,
    "requirementIds": [
      "PROJECT_LIFECYCLE_CONTROL:PROJECT_LIFECYCLE_CONTROL_S1:USER"
    ],
