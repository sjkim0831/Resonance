...
export const screen_auto_fa3054fe9766756e0031 = {
  ...
  "blueprintCode": "BP_AUTO_FA3054FE9766756E0031DDB3",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 버전 변경 영향 재계산 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3722,
    "requirementIds": [
      "BACKGROUND_DB_VERSION_IMPACT:BACKGROUND_DB_VERSION_IMPACT_S3:USER"
    ],
