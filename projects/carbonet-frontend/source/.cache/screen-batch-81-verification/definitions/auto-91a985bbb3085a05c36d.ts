...
export const screen_auto_91a985bbb3085a05c36d = {
  ...
  "blueprintCode": "BP_AUTO_91A985BBB3085A05C36D0D06",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "LCA_PRACTITIONER 액터가 권한·업무분리 정책에 따라 할당 회피·규칙 선택 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3750,
    "requirementIds": [
      "LCA_ALLOCATION_SENSITIVITY:LCA_ALLOCATION_SENSITIVITY_S2:USER"
    ],
