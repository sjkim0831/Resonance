...
export const screen_auto_48f0038d84703e9f3390 = {
  ...
  "blueprintCode": "BP_AUTO_48F0038D84703E9F33908E85",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "COMPANY_MANAGER 액터가 권한·업무분리 정책에 따라 검증 범위·후보 선정 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 2793,
    "requirementIds": [
      "EXTERNAL_VERIFICATION_ENGAGEMENT:EXTERNAL_VERIFICATION_ENGAGEMENT_S1:USER"
    ],
