...
export const screen_auto_fb69d4a0dc22d7cdcba4 = {
  ...
  "specification": {
    ...
    "businessPurpose": "문의 접수·답변 프로세스의 문의 접수·답변 - 독립 검토·보완·권한 검증 단계에서 VERIFIER 액터가 CUSTOMER_INQUIRY_REVIEW 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
