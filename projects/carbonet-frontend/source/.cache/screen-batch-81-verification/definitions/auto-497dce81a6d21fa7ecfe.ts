...
export const screen_auto_497dce81a6d21fa7ecfe = {
  ...
  "blueprintCode": "BP_AUTO_497DCE81A6D21FA7ECFE397A",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "LCA_PRACTITIONER 액터가 권한·업무분리 정책에 따라 PCR 적합성·유효기간 판정 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3782,
    "requirementIds": [
      "PCR_EPD_VERIFICATION:PCR_EPD_VERIFICATION_S2:USER"
    ],
