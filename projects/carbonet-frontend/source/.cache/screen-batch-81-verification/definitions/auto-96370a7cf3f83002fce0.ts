...
export const screen_auto_96370a7cf3f83002fce0 = {
  ...
  "blueprintCode": "BP_AUTO_96370A7CF3F83002FCE04879",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SITE_DATA_OWNER 액터가 권한·업무분리 정책에 따라 비상정지·인명환경 보호 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3766,
    "requirementIds": [
      "LEAKAGE_INCIDENT_RESPONSE:LEAKAGE_INCIDENT_RESPONSE_S2:USER"
    ],
