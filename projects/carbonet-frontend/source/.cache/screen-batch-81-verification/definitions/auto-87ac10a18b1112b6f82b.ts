...
export const screen_auto_87ac10a18b1112b6f82b = {
  ...
  "blueprintCode": "BP_AUTO_87AC10A18B1112B6F82B07FC",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "AUDITOR 액터가 권한·업무분리 정책에 따라 권한분리 승인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3792,
    "requirementIds": [
      "PROJECT_LIFECYCLE_CONTROL:PROJECT_LIFECYCLE_CONTROL_S3:USER"
    ],
