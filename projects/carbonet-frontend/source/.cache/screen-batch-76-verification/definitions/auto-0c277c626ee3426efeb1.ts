...
export const screen_auto_0c277c626ee3426efeb1 = {
  ...
  "blueprintCode": "BP_AUTO_0C277C626EE3426EFEB1108E",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "SITE_DATA_OWNER 액터가 권한·업무분리 정책에 따라 측정 지점·기기 등록 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3773,
    "requirementIds": [
      "MEASUREMENT_DATA_QUALITY:MEASUREMENT_DATA_QUALITY_S1:ADMIN"
    ],
