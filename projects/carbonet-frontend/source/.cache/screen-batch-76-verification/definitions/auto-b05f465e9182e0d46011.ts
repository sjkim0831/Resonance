...
export const screen_auto_b05f465e9182e0d46011 = {
  ...
  "blueprintCode": "BP_AUTO_B05F465E9182E0D460119F73",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 의견서 승인·발급 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3078,
    "requirementIds": [
      "EXTERNAL_VERIFICATION_ENGAGEMENT:EXTERNAL_VERIFICATION_ENGAGEMENT_S4:USER"
    ],
