...
export const screen_auto_317630a2a138972e9bdf = {
  ...
  "specification": {
    ...
    "businessPurpose": "탄소크레딧 발급·보유·소각 프로세스의 탄소크레딧 발급·보유·소각 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 CARBON_CREDIT_MANAGEMENT_COMPLETE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
