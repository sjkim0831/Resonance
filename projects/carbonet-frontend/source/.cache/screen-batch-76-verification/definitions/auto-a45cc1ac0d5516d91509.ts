...
export const screen_auto_a45cc1ac0d5516d91509 = {
  ...
  "blueprintCode": "BP_AUTO_A45CC1AC0D5516D915099ECB",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 독립 검증·공개본 승인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3787,
    "requirementIds": [
      "PCR_EPD_VERIFICATION:PCR_EPD_VERIFICATION_S4:ADMIN"
    ],
