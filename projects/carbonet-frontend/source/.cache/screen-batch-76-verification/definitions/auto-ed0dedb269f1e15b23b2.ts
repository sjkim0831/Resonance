...
export const screen_auto_ed0dedb269f1e15b23b2 = {
  ...
  "specification": {
    ...
    "businessPurpose": "인증서 진위 확인 프로세스의 인증서 진위 확인 - 독립 검토·보완·권한 검증 단계에서 AUDITOR 액터가 CERTIFICATE_VERIFICATION_REVIEW 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
