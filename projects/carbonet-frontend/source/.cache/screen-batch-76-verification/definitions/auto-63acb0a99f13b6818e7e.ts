...
export const screen_auto_63acb0a99f13b6818e7e = {
  ...
  "specification": {
    ...
    "businessPurpose": "교육 수료·수료증 발급 프로세스의 교육 수료·수료증 발급 - 업무 실행·중간 결과 저장 단계에서 CERTIFICATE_OFFICER 액터가 TRAINING_CERTIFICATE_EXECUTE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
