...
export const screen_auto_6a5059798d7444acd7a3 = {
  ...
  "specification": {
    ...
    "businessPurpose": "Git·증분 빌드·무중단 배포 프로세스의 Git·증분 빌드·무중단 배포 - 업무 실행·중간 결과 저장 단계에서 PLATFORM_OPERATOR 액터가 GIT_BUILD_DEPLOYMENT_EXECUTE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
