...
export const screen_auto_67379dee753524c9066f = {
  ...
  "blueprintCode": "BP_AUTO_67379DEE753524C9066F4586",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "COMPANY_MANAGER 액터가 권한·업무분리 정책에 따라 독립성·역량 심사 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3746,
    "requirementIds": [
      "EXTERNAL_VERIFICATION_ENGAGEMENT:EXTERNAL_VERIFICATION_ENGAGEMENT_S2:USER"
    ],
