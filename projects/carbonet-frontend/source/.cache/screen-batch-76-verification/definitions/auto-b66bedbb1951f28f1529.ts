...
export const screen_auto_b66bedbb1951f28f1529 = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "APPROVER 액터가 권한·업무분리 정책에 따라 인증서 발급·다운로드·감사 업무를 수행한다."
    ],
    "entryConditions": [
    ...
    "apiContracts": [
      ...
      {
        "code": "API_3",
        "label": "GET /home/api/report-access-history"
      }
    ],
    "dataContracts": [
      {
  ...
  "traceability": {
    "contractId": 132,
    "requirementIds": [
      "REPORT_CERTIFICATION:REPORT_CERTIFICATION_04_APPROVE:USER"
    ],
