...
export const screen_auto_ac116fbbad30ab5b56a9 = {
  ...
  "specification": {
    ...
    "businessPurpose": "보고서 제출·접수 프로세스의 보고서 제출·접수 - 업무 실행·중간 결과 저장 단계에서 COMPANY_MANAGER 액터가 REPORT_SUBMISSION_EXECUTE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
