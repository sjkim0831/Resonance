...
export const screen_auto_7e7b8fed32b17ce97fb2 = {
  ...
  "blueprintCode": "BP_AUTO_7E7B8FED32B17CE97FB29989",
  "processCode": "LCA_ALLOCATION_SENSITIVITY",
  "stepCode": "LCA_ALLOCATION_SENSITIVITY_S1",
  ...
  "specification": {
    ...
    "businessPurpose": "할당·민감도 분석 프로세스의 다중 산출물·관계자료 확인 단계에서 LCA_PRACTITIONER 액터가 LCA_ALLOCATION_SENSITIVITY_EXECUTE_1 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 다중 산출물·관계자료 확인의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.",
    "actorResponsibilities": [
      "LCA_PRACTITIONER 액터가 권한·업무분리 정책에 따라 다중 산출물·관계자료 확인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "다음 프로세스 시작 조건을 충족한다: 공정 산출물, 질량·경제가치·물리관계 자료가 준비되어 있다.. 현재 상태는 READY이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우에만 진입한다."
    ],
    "exitConditions": [
      "다음 완료 기준을 검증한다: 다중 산출물·관계자료 확인의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.. 결과·버전·감사 증적을 저장한 뒤 STEP_1_COMPLETED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "READY",
      "LOADING",
    ...
    "actions": [
      {
        "code": "LCA_ALLOCATION_SENSITIVITY_EXECUTE_1",
        "label": "다중 산출물·관계자료 확인 실행",
        "transactional": true,
    ...
    "apiContracts": [
      ...
      },
      {
        ...
        "method": "POST",
        "purpose": "다중 산출물·관계자료 확인 상태 명령 실행"
      },
      {
        "code": "LOAD_DRAFT",
    ...
    "completionRule": "다음 완료 기준을 검증한다: 다중 산출물·관계자료 확인의 필수 입력, 권한, 증적, 상태 전이가 모두 검증되어야 한다.. 결과·버전·감사 증적을 저장한 뒤 STEP_1_COMPLETED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 3749,
      "sharedRuntime": true
    }
  ...
  "traceability": {
    "contractId": 3749,
    "requirementIds": [
      "LCA_ALLOCATION_SENSITIVITY:LCA_ALLOCATION_SENSITIVITY_S1:ADMIN"
    ],
