...
export const screen_auto_402f387196925fc65c0e = {
  ...
  "specification": {
    ...
    "businessPurpose": "중복 사용·이중계상 방지 프로세스의 중복 사용·이중계상 방지 - 독립 검토·보완·권한 검증 단계에서 AUDITOR 액터가 DOUBLE_USE_PREVENTION_REVIEW 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
