...
export const screen_auto_0f2f84975d0e1f841ce6 = {
  ...
  "specification": {
    ...
    "businessPurpose": "기업 등록·승인 프로세스의 기업 등록·승인 - 업무 실행·중간 결과 저장 단계에서 COMPANY_ADMIN 액터가 COMPANY_REGISTRATION_APPROVAL_EXECUTE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
