...
export const screen_auto_2f9f3b109ca1e5c7dbe0 = {
  ...
  "specification": {
    ...
    "businessPurpose": "알림센터 운영 프로세스의 알림센터 운영 - 독립 검토·보완·권한 검증 단계에서 VERIFIER 액터가 NOTIFICATION_CENTER_OPERATION_REVIEW 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
