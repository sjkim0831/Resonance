...
export const screen_auto_7bf1b5d3a8c060527c49 = {
  ...
  "specification": {
    ...
    "businessPurpose": "감축 성과 보고 프로세스의 감축 성과 보고 - 요청·범위·필수정보 확인 단계에서 REDUCTION_MANAGER 액터가 REDUCTION_REPORTING_REQUEST 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
