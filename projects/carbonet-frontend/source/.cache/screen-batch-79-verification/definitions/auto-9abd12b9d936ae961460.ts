...
export const screen_auto_9abd12b9d936ae961460 = {
  ...
  "blueprintCode": "BP_AUTO_9ABD12B9D936AE9614602D8A",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 물질수지·순감축량 계산 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3729,
    "requirementIds": [
      "CCUS_LIFECYCLE_MRV:CCUS_LIFECYCLE_MRV_S3:ADMIN"
    ],
