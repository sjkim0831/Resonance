...
export const screen_auto_0dc106e66e7b5697224a = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "VERIFIER 액터가 권한·업무분리 정책에 따라 비판적 검토·패널 의견 조치 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
