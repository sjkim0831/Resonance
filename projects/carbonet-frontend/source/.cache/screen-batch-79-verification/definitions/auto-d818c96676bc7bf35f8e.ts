...
export const screen_auto_d818c96676bc7bf35f8e = {
  "id": "auto-d818c96676bc7bf35f8e",
  "blueprintCode": "BP_AUTO_D818C96676BC7BF35F8E420D",
  "processCode": "MEMBER_REGISTRATION",
  "stepCode": "MEMBER_REGISTRATION_S3",
  "actorCode": "PUBLIC_APPLICANT",
  "audience": "ADMIN",
  "pageId": "AUTO_D818C96676BC7BF35F8E",
  "pageName": "본인 확인 관리자 업무 화면",
  ...
  "specification": {
    ...
    "businessPurpose": "회원가입 신청 프로세스의 본인 확인 단계에서 PUBLIC_APPLICANT 액터가 VERIFY_IDENTITY 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 선택한 인증수단으로 본인 확인을 통과하고 재사용 방지 증적이 남는다.",
    "actorResponsibilities": [
      "PUBLIC_APPLICANT 액터가 권한·업무분리 정책에 따라 본인 확인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "다음 프로세스 시작 조건을 충족한다: 비로그인 사용자가 홈 또는 로그인 화면에서 회원가입을 선택한다. 현재 상태는 CONSENTS_ACCEPTED이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우에만 진입한다."
    ],
    "exitConditions": [
      "다음 완료 기준을 검증한다: 선택한 인증수단으로 본인 확인을 통과하고 재사용 방지 증적이 남는다. 결과·버전·감사 증적을 저장한 뒤 IDENTITY_VERIFIED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "CONSENTS_ACCEPTED",
      "LOADING",
    ...
    "completionRule": "다음 완료 기준을 검증한다: 선택한 인증수단으로 본인 확인을 통과하고 재사용 방지 증적이 남는다. 결과·버전·감사 증적을 저장한 뒤 IDENTITY_VERIFIED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 2967,
      "sharedRuntime": true
    }
  ...
  "traceability": {
    "contractId": 2967,
    "requirementIds": [
      "MEMBER_REGISTRATION:MEMBER_REGISTRATION_S3:ADMIN"
    ],
