...
export const screen_auto_e6fe996428ccacb7aa16 = {
  ...
  "blueprintCode": "BP_AUTO_E6FE996428CCACB7AA167FB0",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "PUBLIC_APPLICANT 액터가 권한·업무분리 정책에 따라 회원·소속 정보 입력 및 제출 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 2969,
    "requirementIds": [
      "MEMBER_REGISTRATION:MEMBER_REGISTRATION_S4:ADMIN"
    ],
