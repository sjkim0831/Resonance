...
export const screen_auto_3093ae17f78995d4ee53 = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "COMPANY_MANAGER 액터가 권한·업무분리 정책에 따라 보고서 생성·제출·진위 확인 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 12,
    "requirementIds": [
      "EMISSION_PROJECT:EMISSION_PROJECT_REPORT:ADMIN"
    ],
