...
export const screen_auto_ecff7b4b635eb013d3af = {
  ...
  "specification": {
    ...
    "businessPurpose": "활동자료 수집·보완 프로세스의 자료 입력·업무 수행 단계에서 SITE_DATA_OWNER 액터가 WORK 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력과 증빙이 제출됨",
    "actorResponsibilities": [
      "SITE_DATA_OWNER 액터가 권한·업무분리 정책에 따라 자료 입력·업무 수행 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
      "다음 프로세스 시작 조건을 충족한다: 자료 제출 요청이 발행됨. 현재 상태는 PLANNED이며 서버가 테넌트·프로젝트·액터 권한을 확인한 경우에만 진입한다."
    ],
    "exitConditions": [
      "다음 완료 기준을 검증한다: 필수 입력과 증빙이 제출됨. 결과·버전·감사 증적을 저장한 뒤 SUBMITTED 상태로 원자적으로 전이한다."
    ],
    "states": [
      "PLANNED",
      "LOADING",
    ...
    "completionRule": "다음 완료 기준을 검증한다: 필수 입력과 증빙이 제출됨. 결과·버전·감사 증적을 저장한 뒤 SUBMITTED 상태로 원자적으로 전이한다.",
    "extensions": {
      "contractId": 2834,
      "sharedRuntime": true
    }
  ...
  "traceability": {
    "contractId": 2834,
    "requirementIds": [
      "ACTIVITY_DATA:ACTIVITY_DATA_02_WORK:ADMIN"
    ],
