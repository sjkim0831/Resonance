...
export const screen_auto_c81dcc7f3372c647b82e = {
  ...
  "blueprintCode": "BP_AUTO_C81DCC7F3372C647B82E5A31",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "LCA_PRACTITIONER 액터가 권한·업무분리 정책에 따라 데이터 품질·방법론 동등성 검토 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3111,
    "requirementIds": [
      "COMPARATIVE_ASSERTION_REVIEW:COMPARATIVE_ASSERTION_REVIEW_S2:ADMIN"
    ],
