...
export const screen_auto_b553958615ae909c3698 = {
  ...
  "specification": {
    ...
    "businessPurpose": "교육 신청·승인 프로세스의 교육 신청·승인 - 승인·확정·통지·후속업무 연결 단계에서 APPROVER 액터가 EDUCATION_APPLICATION_COMPLETE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
