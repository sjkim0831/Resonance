...
export const screen_auto_f582bfccf89d58a1bafa = {
  "id": "auto-f582bfccf89d58a1bafa",
  "blueprintCode": "BP_ORGANIZATIONAL_BOUNDARY_ORGANIZATIONAL_BOUNDARY_S1_ADMIN",
  ...
  "pageName": "법인·사업장·소유구조 수집 관리자 업무 화면",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "COMPANY_MANAGER 액터가 권한·업무분리 정책에 따라 법인·사업장·소유구조 수집 관리자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 510,
    "requirementIds": [
      "ORGANIZATIONAL_BOUNDARY:ORGANIZATIONAL_BOUNDARY_S1:ADMIN"
    ],
