...
export const screen_auto_a6827dd3990772bc50e1 = {
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "COMPANY_MANAGER 액터가 권한·업무분리 정책에 따라 보고서 생성·제출·진위 확인 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
    ...
    "apiContracts": [
      {
        "code": "API_1",
        "label": "GET /home/api/emission-projects/{id}/reports"
      },
      {
        "code": "API_2",
        "label": "POST /home/api/emission-projects/{id}/reports"
      },
      {
        "code": "API_3",
        "label": "POST /home/api/emission-projects/{id}/reports/{reportId}/finalize"
      },
      {
        "code": "API_4",
        "label": "POST /home/api/emission-projects/{id}/reports/{reportId}/issue"
      },
      {
        "code": "API_5",
        "label": "POST /home/api/emission-projects/{id}/reports/{reportId}/download"
      }
    ],
    "dataContracts": [
      {
  ...
  "traceability": {
    "contractId": 11,
    "requirementIds": [
      "EMISSION_PROJECT:EMISSION_PROJECT_REPORT:USER"
    ],
