...
export const screen_auto_150d6cf12f2e7012d432 = {
  ...
  "blueprintCode": "BP_AUTO_150D6CF12F2E7012D4324BEC",
  ...
  "specification": {
    ...
    "actorResponsibilities": [
      "CALCULATOR 액터가 권한·업무분리 정책에 따라 버전 복제·재산정 사용자 업무 화면 업무를 수행한다."
    ],
    "entryConditions": [
  ...
  "traceability": {
    "contractId": 3742,
    "requirementIds": [
      "DISCLOSURE_CORRECTION:DISCLOSURE_CORRECTION_S2:USER"
    ],
