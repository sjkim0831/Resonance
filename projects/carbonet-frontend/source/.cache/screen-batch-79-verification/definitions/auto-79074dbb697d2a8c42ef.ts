...
export const screen_auto_79074dbb697d2a8c42ef = {
  ...
  "specification": {
    ...
    "businessPurpose": "조직·부서 관리 프로세스의 조직·부서 관리 - 업무 실행·중간 결과 저장 단계에서 COMPANY_ADMIN 액터가 ORGANIZATION_DEPARTMENT_EXECUTE 명령을 안전하게 수행하여 다음 완료 기준을 달성한다: 필수 입력, 액터 권한, 테넌트·프로젝트 격리, 증적, 멱등성과 상태 전이가 모두 검증되어야 한다.",
