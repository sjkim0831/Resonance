...
public class AdminSystemCodeController {
    ...
    @RequestMapping(value = {
            ...
            "/automation-studio",
            "/development-pattern-management",
            "/css-management",
            "/ai-developer-team"
    ...
    private static Map<String, String> buildPlatformStudioRouteMap() {
        ...
        routeMap.put("/development-pattern-management", "development-pattern-management");
        routeMap.put("/css-management", "css-management");
        routeMap.put("/ai-developer-team", "ai-developer-team");
