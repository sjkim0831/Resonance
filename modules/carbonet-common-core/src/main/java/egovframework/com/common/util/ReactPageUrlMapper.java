...
public final class ReactPageUrlMapper {
    ...
    static {
        ...
        registerAdmin(adminPathToRoute, adminRouteToPath, "emission-ecoinvent-admin", "/admin/emission/ecoinvent", "/admin/emission/ecoinvent");
        ...
        registerAdmin(adminPathToRoute, adminRouteToPath, "development-pattern-management", "/admin/system/development-pattern-management", "/admin/system/development-pattern-management");
        registerAdmin(adminPathToRoute, adminRouteToPath, "theme-management", "/admin/system/theme-management", "/admin/system/theme-management");
        registerAdmin(adminPathToRoute, adminRouteToPath, "css-management", "/admin/system/css-management", "/admin/system/css-management");
        registerAdmin(adminPathToRoute, adminRouteToPath, "ai-developer-team", "/admin/system/ai-developer-team", "/admin/system/ai-developer-team");
