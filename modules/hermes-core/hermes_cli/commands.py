...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("deploy80", "Trigger Carbonet :80 build/redeploy through Ops Web",
               "Tools & Skills", cli_only=True,
               aliases=("redeploy80",),
               args_hint="[status]"),
    CommandDef("carbonet", "Create Carbonet DB-backed AI task plan and 40B handoff packet",
               "Tools & Skills", cli_only=True,
               args_hint="[--format json] [--handoff] [--apply-db] <request>"),
