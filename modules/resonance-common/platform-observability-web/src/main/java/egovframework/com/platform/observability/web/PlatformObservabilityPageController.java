...
public class PlatformObservabilityPageController {
    ...
    @RequestMapping(value = "/system/programs", method = {RequestMethod.GET, RequestMethod.POST})
    public String installedProgramsPage(HttpServletRequest request, Locale locale) {
        return forwardAdminRoute(request, locale, "installed-programs");
    }

    @RequestMapping(value = "/system/resources", method = {RequestMethod.GET, RequestMethod.POST})
    public String systemResourcesPage(HttpServletRequest request, Locale locale) {
        return forwardAdminRoute(request, locale, "system-resources");
    }

    @RequestMapping(value = "/system/logs", method = {RequestMethod.GET, RequestMethod.POST})
    public String operationsLogManagementPage(HttpServletRequest request, Locale locale) {
        return forwardAdminRoute(request, locale, "operations-log-management");
    }

    @RequestMapping(value = "/system/ai-hangar", method = {RequestMethod.GET, RequestMethod.POST})
    public String aiHangarPage(HttpServletRequest request, Locale locale) {
        return forwardAdminRoute(request, locale, "ai-hangar");
    }

    @RequestMapping(value = "/system/theme-management", method = {RequestMethod.GET, RequestMethod.POST})
    public String themeManagementPage(HttpServletRequest request, Locale locale) {
        return forwardAdminRoute(request, locale, "theme-management");
    }
