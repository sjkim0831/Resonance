...
public class ActorProcessGovernanceService {
    ...
    public Map<String,Object> dashboard() {
        ...
        out.put("executableScreens",jdbc.queryForList("select global_sequence as \"globalSequence\",page_design_id as \"pageDesignId\",page_code as \"pageCode\",page_title as \"pageTitle\",process_code as \"processCode\",process_name as \"processName\",step_order as \"stepOrder\",step_code as \"stepCode\",step_name as \"stepName\",audience,actor_code as \"actorCode\",route_key as \"routeKey\",executable_status as \"executableStatus\",blocker_codes as \"blockerCodes\",next_action as \"nextAction\",previous_page_design_id as \"previousPageDesignId\",next_page_design_id as \"nextPageDesignId\" from framework_vertical_screen_design_map order by global_sequence limit 1500"));
        out.put("executableScreenRepairQueue",jdbc.queryForList("select page_design_id as \"pageDesignId\",page_code as \"pageCode\",page_title as \"pageTitle\",process_code as \"processCode\",step_code as \"stepCode\",audience,actor_code as \"actorCode\",route_key as \"routeKey\",executable_status as \"executableStatus\",blocker_codes as \"blockerCodes\",next_action as \"nextAction\",repair_priority as \"repairPriority\" from framework_screen_design_repair_queue_v2 order by repair_priority,page_design_id limit 1500"));
