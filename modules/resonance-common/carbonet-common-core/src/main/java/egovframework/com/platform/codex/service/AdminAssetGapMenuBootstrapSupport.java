...
public class AdminAssetGapMenuBootstrapSupport {
    ...
    private static final String MENU_CODE = "A0060127";
    private static final String MENU_NAME_KO = "자산 미흡 큐";
    private static final String MENU_NAME_EN = "Asset Gap Queue";
    private static final String MENU_URL = "/admin/system/asset-gap";
    private static final String MENU_ICON = "playlist_remove";
    ...
    public void ensureAssetGapMenu() {
        ...
        return PlatformMenuProvisionSupport.adminMenuRequest(
                ...
                new CodexProvisionRequest.FeatureRequest[]{
                        PlatformMenuProvisionSupport.featureRequest(
                                ...
                                MENU_CODE + "_VIEW",
                                MENU_NAME_KO + " 조회",
                                "View Asset Gap Queue",
                                "System asset gap queue page access")
                },
