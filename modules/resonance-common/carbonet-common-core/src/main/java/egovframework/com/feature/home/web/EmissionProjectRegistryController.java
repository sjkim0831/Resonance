...
public class EmissionProjectRegistryController {
    ...
    public ResponseEntity<?> saveOrganizationalBoundary(@PathVariable String id,@RequestBody Map<String,Object> body,HttpServletRequest request){var c=currentUserContextService.resolve(request);try{return ResponseEntity.ok(service.saveOrganizationalBoundary(id,tenant(c),c.getUserId(),c.isWebmaster(),body));}catch(SecurityException e){return ResponseEntity.status(403).body(Map.of("message",e.getMessage()));}catch(IllegalStateException e){return ResponseEntity.status(409).body(Map.of("message",e.getMessage()));}catch(Exception e){return ResponseEntity.badRequest().body(Map.of("message",e.getMessage()));}}
    ...
    public ResponseEntity<?> consolidateBoundary(@PathVariable String id,@RequestBody Map<String,Object> body,HttpServletRequest request){var c=currentUserContextService.resolve(request);try{return ResponseEntity.ok(service.consolidateOrganizationalBoundary(id,tenant(c),c.getUserId(),c.isWebmaster(),body));}catch(SecurityException e){return ResponseEntity.status(403).body(Map.of("message",e.getMessage()));}catch(IllegalStateException e){return ResponseEntity.status(409).body(Map.of("message",e.getMessage()));}catch(Exception e){return ResponseEntity.badRequest().body(Map.of("message",e.getMessage()));}}
    ...
    public ResponseEntity<?> decideBoundary(@PathVariable String id,@RequestBody Map<String,Object> body,HttpServletRequest request){var c=currentUserContextService.resolve(request);try{return ResponseEntity.ok(service.decideOrganizationalBoundary(id,tenant(c),c.getUserId(),c.isWebmaster(),body));}catch(SecurityException e){return ResponseEntity.status(403).body(Map.of("message",e.getMessage()));}catch(IllegalStateException e){return ResponseEntity.status(409).body(Map.of("message",e.getMessage()));}catch(Exception e){return ResponseEntity.badRequest().body(Map.of("message",e.getMessage()));}}
