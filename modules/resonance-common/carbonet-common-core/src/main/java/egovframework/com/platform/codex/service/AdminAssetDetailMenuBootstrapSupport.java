...
public class AdminAssetDetailMenuBootstrapSupport {
    ...
    private static final String MENU_CODE = "A0060124";
    ...
    public void ensureAssetDetailMenu() {
        ...
        return PlatformMenuProvisionSupport.adminMenuRequest(
                ...
                new CodexProvisionRequest.FeatureRequest[]{
                        PlatformMenuProvisionSupport.featureRequest(
                                ...
                                MENU_NAME_KO + " 조회",
                                "View Asset Detail",
                                "System asset detail page access")
                },
