...
public class LayoutManagementController {
    ...
    public ResponseEntity<LayoutManagementService.LayoutTemplatesPayload> getLayoutTemplates() {
    ...
    @GetMapping("/themes")
    public ResponseEntity<LayoutManagementService.LayoutThemesPayload> getLayoutThemes() {
