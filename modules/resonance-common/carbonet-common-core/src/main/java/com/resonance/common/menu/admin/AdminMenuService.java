...
public class AdminMenuService {
    ...
    private Map<String, Object> menuToRow(ExtendedMenuInfo menu) {
        ...
        row.put("dependentScreenCode", menu.getDependentScreenCode() != null ? menu.getDependentScreenCode() : "");
        return row;
    }
    ...
    public boolean updateDependentScreen(String menuCode, String dependentScreenCode) {
        ExtendedMenuInfo menu = menuStore.get(menuCode);
        if (menu != null) {
            menu.setDependentScreenCode(dependentScreenCode != null && !dependentScreenCode.isEmpty() ? dependentScreenCode : null);
            return true;
        }
        return false;
    }
    ...
    public static class CommonCodeInfo {
        ...
        public CommonCodeInfo() {}

        public CommonCodeInfo(String code, String codeNm, String codeDc, String codeNmEn, String codeGroup) {
            this.code = code;
            this.codeNm = codeNm;
            this.codeDc = codeDc;
