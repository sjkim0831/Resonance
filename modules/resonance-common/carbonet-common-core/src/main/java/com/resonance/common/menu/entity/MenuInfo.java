...
public class MenuInfo {
    ...
    public MenuInfo(String menuId, String upperMenuId, String menuNm, String menuNmEn,
                    String menuPath, String menuUrl, String iconPath,
                    Integer sortOrder, String menuGroupId) {
        this.menuId = menuId;
        this.upperMenuId = upperMenuId;
        this.menuNm = menuNm;
        this.menuDc = menuNmEn;
