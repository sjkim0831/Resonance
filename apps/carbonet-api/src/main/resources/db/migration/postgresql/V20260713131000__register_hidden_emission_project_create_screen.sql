...
VALUES ('HMENU1', 'H102010201', '새 프로젝트 등록', '/emission/project/create', 'Y', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'PROJECT_SCREEN_REGISTRY')
ON CONFLICT (code_id, code) DO UPDATE SET code_nm=EXCLUDED.code_nm, code_dc=EXCLUDED.code_dc, use_at='Y', last_updt_pnttm=CURRENT_TIMESTAMP, last_updusr_id='PROJECT_SCREEN_REGISTRY';
