...
WITH reduction_menu(menu_code, menu_nm, menu_nm_en, menu_url, menu_icon) AS (
    VALUES
        ...
        ('A10501',   '목표·과제',          'Targets and Initiatives',      '/admin/emission/definition-studio', 'folder'),
        ('A1050101', '감축 목표 관리',     'Reduction Target Management', '/admin/emission/definition-studio', 'track_changes'),
        ('A1050102', '감축 과제 관리',     'Reduction Task Management',   '/admin/emission/management',        'task_alt'),
        ('A1050103', '과제 검토·승인',     'Task Review and Approval',     '/admin/emission/approval-workflow', 'approval'),
        ('A1050104', '감축 실적 관리',     'Reduction Performance',       '/admin/emission/result_list',       'fact_check'),
        ('A1050105', '시나리오 관리',      'Scenario Management',         '/admin/emission/calculation-rule',  'account_tree'),
        ('A1050106', '감축계수·산정 기준', 'Reduction Factors and Rules', '/admin/emission/factor-management', 'calculate'),
...
SET code_nm = source.menu_nm,
    ...
    use_at = 'Y',
    last_updt_pnttm = CURRENT_TIMESTAMP,
    last_updusr_id = 'REDUCTION_MENU_RESTORE'
FROM reduction_menu source
