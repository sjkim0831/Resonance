...
public class CarbonetApiApplication {
    ...
    static {
        ...
        try {
            ...
            System.out.println("[CarbonetApiApplication] Static Init: Forced SLF4J Logging for MyBatis");
        } catch (Throwable t) {
            System.err.println("[CarbonetApiApplication] Static Init: Failed to force SLF4J: " + t.getMessage());
        }
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            org.apache.ibatis.logging.LogFactory.useSlf4jLogging();
            System.out.println("[CarbonetApiApplication] Main Entry: Forced SLF4J Logging for MyBatis");
        } catch (Throwable t) {
            System.err.println("[CarbonetApiApplication] Main Entry: Failed to force SLF4J: " + t.getMessage());
        }
        System.setProperty("file.encoding", "UTF-8");
        System.setProperty("spring.application.name", "project-runtime");
        SpringApplication.run(CarbonetApiApplication.class, args);
    }
}
