...
export const ACTOR_PROCESS_WORKSPACES: ActorProcessWorkspace[] = [
  {
    ...
    tabs: [
      ...
      tab('process-map', '전체 프로세스 설계도', '프로세스와 단계 관계를 순서도로 확인합니다.'),
      ...
      tab('account-readiness', '액터 계정 검증', '계정·권한·업무 연결의 드리프트를 검사합니다.'),
  ...
  },
  {
    ...
    label: '설계',
    description:
      '프로세스·화면·필드·메뉴·공통 기능 계약을 프로젝트별 설계 정본으로 관리합니다.',
    tabs: [
  ...
  },
  {
    ...
    label: '검증',
    description:
      '설계 정확성·고객 여정·디자인·정상·예외·권한·격리·복구를 검증합니다.',
    tabs: [
      tab('design-assurance', '설계 정확성', '액터·상태·데이터·API·화면 계약 일치를 검사합니다.'),
      tab('customer-journey', '고객 여정 자동검사', '사용자 업무가 시작부터 완료까지 도달하는지 검사합니다.'),
      tab('design', '디자인 사전검사', '공통 디자인 자산 재사용과 접근성을 검사합니다.'),
  ...
  },
  {
    ...
    label: '개발·배포',
    description:
      '설계에서 생성된 작업·의존성·산출물·품질 게이트와 배포 상태를 추적합니다.',
    tabs: [
