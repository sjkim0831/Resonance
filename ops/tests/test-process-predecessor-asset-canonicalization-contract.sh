...
printf '%s\n' 'PROCESS_PREDECESSOR_ASSET_CANONICALIZATION_PASS assetDuplicates=0 prerequisiteGuard=1 predecessorBinding=1 orphanMutation=guarded workflowInvalid=0 reportAliases=2 reportRoutes=covered legacyFieldCodes=compatible'
