...
if(!browser.includes('validationCommit: ""')||!browser.includes("evidence.validationCommit = evidence.sourceCommit"))throw new Error("validation harness commit identity missing");
