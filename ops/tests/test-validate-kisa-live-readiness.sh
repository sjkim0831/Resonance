...
bash -n "$TARGET"
for token in sdkReady jarMounted configuredKeys missingKeys configuredCount requiredCount supplyChainTrusted orchestrationImplemented acceptancePassed overallChecks liveReady \
