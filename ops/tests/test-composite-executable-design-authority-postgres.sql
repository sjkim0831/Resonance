...
(901,'NOP','EXECUTE','/nop','USER','ACTOR','Execute both governed commands',
 ...
 '[{"method":"POST","path":"/api/nop/{executionId}/save","commandCode":"SAVE","requestFields":["name"],"responseFields":["id"],"permissionCodes":["PERM_SAVE"],"responseProjection":[{"fieldCode":"id","source":"RUNTIME_RESULT","sourcePath":"eventId"}],"statusResponses":[{"statusCase":"SUCCESS","httpStatus":200,"bodyFields":["success","idempotent","eventId","toState","id"]},{"statusCase":"VALIDATION_ERROR","httpStatus":400,"bodyFields":["success","code","message"]},{"statusCase":"FORBIDDEN","httpStatus":403,"bodyFields":["success","code","message"]},{"statusCase":"CONFLICT","httpStatus":409,"bodyFields":["success","code","message"]},{"statusCase":"RECOVERY","httpStatus":200,"bodyFields":["success","idempotent","eventId","toState","recovered","id"]}]},{"method":"POST","path":"/api/nop/{executionId}/submit","commandCode":"SUBMIT","requestFields":["amount"],"responseFields":["status"],"permissionCodes":["PERM_SUBMIT"],"responseProjection":[{"fieldCode":"status","source":"RUNTIME_RESULT","sourcePath":"toState"}],"statusResponses":[{"statusCase":"SUCCESS","httpStatus":200,"bodyFields":["success","idempotent","eventId","toState","status"]},{"statusCase":"VALIDATION_ERROR","httpStatus":400,"bodyFields":["success","code","message"]},{"statusCase":"FORBIDDEN","httpStatus":403,"bodyFields":["success","code","message"]},{"statusCase":"CONFLICT","httpStatus":409,"bodyFields":["success","code","message"]},{"statusCase":"RECOVERY","httpStatus":200,"bodyFields":["success","idempotent","eventId","toState","recovered","status"]}]}]',
...
INSERT INTO framework_test_composite_canonical VALUES($json$
{
  ...
  "lanes":{
    ...
    "API":[
      {"commandCode":"SAVE","method":"POST","path":"/api/nop/{executionId}/save","permissionCodes":["PERM_SAVE"],"requestFields":["name"],"responseFields":["id"],"responseProjection":[{"fieldCode":"id","source":"RUNTIME_RESULT","sourcePath":"eventId"}],"statusResponses":[{"statusCase":"SUCCESS","httpStatus":200,"bodyFields":["success","idempotent","eventId","toState","id"]},{"statusCase":"VALIDATION_ERROR","httpStatus":400,"bodyFields":["success","code","message"]},{"statusCase":"FORBIDDEN","httpStatus":403,"bodyFields":["success","code","message"]},{"statusCase":"CONFLICT","httpStatus":409,"bodyFields":["success","code","message"]},{"statusCase":"RECOVERY","httpStatus":200,"bodyFields":["success","idempotent","eventId","toState","recovered","id"]}]},
      {"commandCode":"SUBMIT","method":"POST","path":"/api/nop/{executionId}/submit","permissionCodes":["PERM_SUBMIT"],"requestFields":["amount"],"responseFields":["status"],"responseProjection":[{"fieldCode":"status","source":"RUNTIME_RESULT","sourcePath":"toState"}],"statusResponses":[{"statusCase":"SUCCESS","httpStatus":200,"bodyFields":["success","idempotent","eventId","toState","status"]},{"statusCase":"VALIDATION_ERROR","httpStatus":400,"bodyFields":["success","code","message"]},{"statusCase":"FORBIDDEN","httpStatus":403,"bodyFields":["success","code","message"]},{"statusCase":"CONFLICT","httpStatus":409,"bodyFields":["success","code","message"]},{"statusCase":"RECOVERY","httpStatus":200,"bodyFields":["success","idempotent","eventId","toState","recovered","status"]}]}],
    "DATABASE":[]
  }
}
$json$::jsonb);
