...
order_migration="$root/apps/carbonet-api/src/main/resources/db/migration/postgresql/V20260804200000__correct_emission_business_process_order.sql"
...
grep -Fq 'EMISSION_PROJECT_PORTFOLIO>WORK_ASSIGNMENT>EMISSION_PROJECT' "$order_migration"
