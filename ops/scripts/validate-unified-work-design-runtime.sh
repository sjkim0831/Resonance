...
IFS='|' read -r process_count assurance_count active_work_type_count work_type_count project_binding_count embedded_assurance_count invalid_generated_count <<<"$(
...
echo "[unified-work-design] PASS processes=$process_count work-types=$work_type_count project-bindings=$project_binding_count invalid-generated=0"
