...
const ADMIN_SYSTEM_ROUTE_DEFINITIONS = [
  ...
  { id: "hub", label: "Hub", group: "admin", koPath: "/admin/system/hub", enPath: "/en/admin/system/hub" },
  { id: "dashboard-customize", label: "대시보드 커스터마이즈", group: "admin", koPath: "/admin/system/dashboard-customize", enPath: "/en/admin/system/dashboard-customize" },
  { id: "platform-studio", label: "플랫폼 스튜디오", group: "admin", koPath: "/admin/system/platform-studio", enPath: "/en/admin/system/platform-studio" },
  { id: "screen-element-management", label: "화면 요소 관리", group: "admin", koPath: "/admin/system/screen-element-management", enPath: "/en/admin/system/screen-element-management" },
  ...
  { id: "asset-inventory", label: "자산 인벤토리", group: "admin", koPath: "/admin/system/asset-inventory", enPath: "/en/admin/system/asset-inventory" },
  { id: "asset-detail", label: "자산 상세", group: "admin", koPath: "/admin/system/asset-detail", enPath: "/en/admin/system/asset-detail" },
  { id: "asset-impact", label: "자산 영향도", group: "admin", koPath: "/admin/system/asset-impact", enPath: "/en/admin/system/asset-impact" },
  { id: "asset-lifecycle", label: "자산 생명주기", group: "admin", koPath: "/admin/system/asset-lifecycle", enPath: "/en/admin/system/asset-lifecycle" },
